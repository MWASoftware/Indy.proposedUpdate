...
var
  ...
  PEM_read_bio_ex: function (bp: PBIO; name: PPAnsiChar; header: PPAnsiChar; data: PPByte; len: POpenSSL_C_LONG; flags: TOpenSSL_C_UINT): TOpenSSL_C_INT; cdecl = Load_PEM_read_bio_ex; {introduced 1.1.0 }
  PEM_bytes_read_bio_secmem: function (pdata: PPByte; plen: POpenSSL_C_LONG; pnm: PPAnsiChar; const name: PAnsiChar; bp: PBIO; cb: pem_password_cb; u: Pointer): TOpenSSL_C_INT; cdecl = Load_PEM_bytes_read_bio_secmem; {introduced 1.1.0 }
  ...
  PEM_write_bio_PrivateKey_traditional: function (bp: PBIO; x: PEVP_PKEY; const enc: PEVP_CIPHER; kstr: PByte; klen: TOpenSSL_C_INT; cb: pem_password_cb; u: Pointer): TOpenSSL_C_INT; cdecl = Load_PEM_write_bio_PrivateKey_traditional; {introduced 1.1.0 }
...
{$ENDIF}
const
  PEM_read_bio_ex_introduced = ((((((byte(1) shl 8) or byte(1)) shl 8) or byte(0)) shl 8) or byte(0)) shl 4;
  PEM_bytes_read_bio_secmem_introduced = ((((((byte(1) shl 8) or byte(1)) shl 8) or byte(0)) shl 8) or byte(0)) shl 4;
  PEM_write_bio_PrivateKey_traditional_introduced = ((((((byte(1) shl 8) or byte(1)) shl 8) or byte(0)) shl 8) or byte(0)) shl 4;
