...
var
  ...
  ASN1_TYPE_pack_sequence: function (const it: PASN1_ITEM; s: Pointer; t: PPASN1_TYPE): PASN1_TYPE; cdecl = @Load_ASN1_TYPE_pack_sequence; {introduced 1.1.0 }
  ASN1_TYPE_unpack_sequence: function (const it: PASN1_ITEM; const t: PASN1_TYPE): Pointer; cdecl = @Load_ASN1_TYPE_unpack_sequence; {introduced 1.1.0 }
  ...
  ASN1_STRING_get0_data: function (const x: PASN1_STRING): PByte; cdecl = @Load_ASN1_STRING_get0_data; {introduced 1.1.0 }
  ...
  ASN1_TIME_set_string_X509: function (s: PASN1_TIME; const str: PAnsiChar): TOpenSSL_C_INT; cdecl = @Load_ASN1_TIME_set_string_X509; {introduced 1.1.0 }
  ASN1_TIME_to_tm: function (const s: PASN1_TIME; tm: POpenSSL_C_TM): TOpenSSL_C_INT; cdecl = @Load_ASN1_TIME_to_tm; {introduced 1.1.0 }
  ASN1_TIME_normalize: function (s: PASN1_TIME): TOpenSSL_C_INT; cdecl = @Load_ASN1_TIME_normalize; {introduced 1.1.0 }
  ASN1_TIME_cmp_time_t: function (const s: PASN1_TIME; t: TOpenSSL_C_TIMET): TOpenSSL_C_INT; cdecl = @Load_ASN1_TIME_cmp_time_t; {introduced 1.1.0 }
  ASN1_TIME_compare: function (const a: PASN1_TIME; const b: PASN1_TIME): TOpenSSL_C_INT; cdecl = @Load_ASN1_TIME_compare; {introduced 1.1.0 }
  ...
  ASN1_INTEGER_get_int64: function (pr: POpenSSL_C_Int64; const a: PASN1_INTEGER): TOpenSSL_C_INT; cdecl = @Load_ASN1_INTEGER_get_int64; {introduced 1.1.0 }
  ASN1_INTEGER_set_int64: function (a: PASN1_INTEGER; r: TOpenSSL_C_Int64): TOpenSSL_C_INT; cdecl = @Load_ASN1_INTEGER_set_int64; {introduced 1.1.0 }
  ASN1_INTEGER_get_uint64: function (pr: POpenSSL_C_UInt64; const a: PASN1_INTEGER): TOpenSSL_C_INT; cdecl = @Load_ASN1_INTEGER_get_uint64; {introduced 1.1.0 }
  ASN1_INTEGER_set_uint64: function (a: PASN1_INTEGER; r: TOpenSSL_C_UInt64): TOpenSSL_C_INT; cdecl = @Load_ASN1_INTEGER_set_uint64; {introduced 1.1.0 }
  ...
  ASN1_ENUMERATED_get_int64: function (pr: POpenSSL_C_Int64; const a: PASN1_ENUMERATED): TOpenSSL_C_INT; cdecl = @Load_ASN1_ENUMERATED_get_int64; {introduced 1.1.0 }
  ASN1_ENUMERATED_set_int64: function (a: PASN1_ENUMERATED; r: TOpenSSL_C_Int64): TOpenSSL_C_INT; cdecl = @Load_ASN1_ENUMERATED_set_int64; {introduced 1.1.0 }
  ...
  ASN1_buf_print: function (bp: PBIO; const buf: PByte; buflen: TOpenSSL_C_SIZET; off: TOpenSSL_C_INT): TOpenSSL_C_INT; cdecl = @Load_ASN1_buf_print; {introduced 1.1.0 }
  ...
  ASN1_add_stable_module: procedure ; cdecl = @Load_ASN1_add_stable_module; {introduced 1.1.0 }
  ...
  ASN1_str2mask: function (const str: PByte; pmask: POpenSSL_C_ULONG): TOpenSSL_C_INT; cdecl = @Load_ASN1_str2mask; {introduced 1.1.0 }
  ...
  ASN1_SCTX_free: procedure (p: PASN1_SCTX); cdecl = @Load_ASN1_SCTX_free; {introduced 1.1.0 }
  ASN1_SCTX_get_item: function (p: PASN1_SCTX): PASN1_ITEM; cdecl = @Load_ASN1_SCTX_get_item; {introduced 1.1.0 }
  ASN1_SCTX_get_template: function (p: PASN1_SCTX): PASN1_TEMPLATE; cdecl = @Load_ASN1_SCTX_get_template; {introduced 1.1.0 }
  ASN1_SCTX_get_flags: function (p: PASN1_SCTX): TOpenSSL_C_ULONG; cdecl = @Load_ASN1_SCTX_get_flags; {introduced 1.1.0 }
  ASN1_SCTX_set_app_data: procedure (p: PASN1_SCTX; data: Pointer); cdecl = @Load_ASN1_SCTX_set_app_data; {introduced 1.1.0 }
  ASN1_SCTX_get_app_data: function (p: PASN1_SCTX): Pointer; cdecl = @Load_ASN1_SCTX_get_app_data; {introduced 1.1.0 }
  ...
  ASN1_ITEM_lookup: function (const name: PAnsiChar): PASN1_ITEM; cdecl = @Load_ASN1_ITEM_lookup; {introduced 1.1.0 }
  ASN1_ITEM_get: function (i: TOpenSSL_C_SIZET): PASN1_ITEM; cdecl = @Load_ASN1_ITEM_get; {introduced 1.1.0 }
{$ENDIF}
const
