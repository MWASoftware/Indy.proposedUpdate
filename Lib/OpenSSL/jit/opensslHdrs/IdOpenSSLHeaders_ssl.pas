...
function SSL_CTX_set_mode(ctx: PSSL_CTX; op: TOpenSSL_C_LONG): TOpenSSL_C_LONG; cdecl;
function SSL_CTX_clear_mode(ctx: PSSL_CTX; op: TOpenSSL_C_LONG): TOpenSSL_C_LONG; cdecl;
function SSL_CTX_sess_set_cache_size(ctx: PSSL_CTX; t: TOpenSSL_C_LONG): TOpenSSL_C_LONG; cdecl;
function SSL_CTX_sess_get_cache_size(ctx: PSSL_CTX): TOpenSSL_C_LONG; cdecl;
function SSL_CTX_set_session_cache_mode(ctx: PSSL_CTX; m: TOpenSSL_C_LONG): TOpenSSL_C_LONG; cdecl;
function SSL_CTX_get_session_cache_mode(ctx: PSSL_CTX): TOpenSSL_C_LONG; cdecl;
function SSL_clear_num_renegotiations(ssl: PSSL): TOpenSSL_C_LONG; cdecl;
function SSL_total_renegotiations(ssl: PSSL): TOpenSSL_C_LONG; cdecl;
function SSL_CTX_set_tmp_dh(ctx: PSSL_CTX; dh: PDH): TOpenSSL_C_LONG; cdecl;
function SSL_CTX_set_tmp_ecdh(ctx: PSSL_CTX; ecdh: PByte): TOpenSSL_C_LONG; cdecl;
function SSL_CTX_set_dh_auto(ctx: PSSL_CTX; onoff: TOpenSSL_C_LONG): TOpenSSL_C_LONG; cdecl;
function SSL_set_dh_auto(s: PSSL; onoff: TOpenSSL_C_LONG): TOpenSSL_C_LONG; cdecl;
function SSL_set_tmp_dh(ssl: PSSL; dh: PDH): TOpenSSL_C_LONG; cdecl;
function SSL_set_tmp_ecdh(ssl: PSSL; ecdh: PByte): TOpenSSL_C_LONG; cdecl;
function SSL_CTX_add_extra_chain_cert(ctx: PSSL_CTX; x509: PByte): TOpenSSL_C_LONG; cdecl;
function SSL_CTX_get_extra_chain_certs(ctx: PSSL_CTX; px509: Pointer): TOpenSSL_C_LONG; cdecl;
function SSL_CTX_get_extra_chain_certs_only(ctx: PSSL_CTX; px509: Pointer): TOpenSSL_C_LONG; cdecl;
function SSL_CTX_clear_extra_chain_certs(ctx: PSSL_CTX): TOpenSSL_C_LONG; cdecl;
function SSL_CTX_set0_chain(ctx: PSSL_CTX; sk: PByte): TOpenSSL_C_LONG; cdecl;
function SSL_CTX_set1_chain(ctx: PSSL_CTX; sk: PByte): TOpenSSL_C_LONG; cdecl;
function SSL_CTX_add0_chain_cert(ctx: PSSL_CTX; x509: PX509): TOpenSSL_C_LONG; cdecl;
function SSL_CTX_add1_chain_cert(ctx: PSSL_CTX; x509: PX509): TOpenSSL_C_LONG; cdecl;
function SSL_CTX_get0_chain_certs(ctx: PSSL_CTX; px509: Pointer): TOpenSSL_C_LONG; cdecl;
function SSL_CTX_clear_chain_certs(ctx: PSSL_CTX): TOpenSSL_C_LONG; cdecl;
function SSL_CTX_build_cert_chain(ctx: PSSL_CTX; flags: TOpenSSL_C_LONG): TOpenSSL_C_LONG; cdecl;
function SSL_CTX_select_current_cert(ctx: PSSL_CTX; x509: PByte): TOpenSSL_C_LONG; cdecl;
function SSL_CTX_set_current_cert(ctx: PSSL_CTX; op: TOpenSSL_C_LONG): TOpenSSL_C_LONG; cdecl;
function SSL_CTX_set0_verify_cert_store(ctx: PSSL_CTX; st: Pointer): TOpenSSL_C_LONG; cdecl;
function SSL_CTX_set1_verify_cert_store(ctx: PSSL_CTX; st: Pointer): TOpenSSL_C_LONG; cdecl;
function SSL_CTX_set0_chain_cert_store(ctx: PSSL_CTX; st: Pointer): TOpenSSL_C_LONG; cdecl;
function SSL_CTX_set1_chain_cert_store(ctx: PSSL_CTX; st: Pointer): TOpenSSL_C_LONG; cdecl;
function SSL_set0_chain(s: PSSL; sk: PByte): TOpenSSL_C_LONG; cdecl;
function SSL_set1_chain(s: PSSL; sk: PByte): TOpenSSL_C_LONG; cdecl;
function SSL_add0_chain_cert(s: PSSL; x509: PByte): TOpenSSL_C_LONG; cdecl;
function SSL_add1_chain_cert(s: PSSL; x509: PByte): TOpenSSL_C_LONG; cdecl;
function SSL_get0_chain_certs(s: PSSL; px509: Pointer): TOpenSSL_C_LONG; cdecl;
function SSL_clear_chain_certs(s: PSSL): TOpenSSL_C_LONG; cdecl;
function SSL_build_cert_chain(s: PSSL; flags: TOpenSSL_C_LONG): TOpenSSL_C_LONG; cdecl;
function SSL_select_current_cert(s: PSSL; x509: PByte): TOpenSSL_C_LONG; cdecl;
function SSL_set_current_cert(s: PSSL; op: TOpenSSL_C_LONG): TOpenSSL_C_LONG; cdecl;
function SSL_set0_verify_cert_store(s: PSSL; st: PByte): TOpenSSL_C_LONG; cdecl;
function SSL_set1_verify_cert_store(s: PSSL; st: PByte): TOpenSSL_C_LONG; cdecl;
function SSL_set0_chain_cert_store(s: PSSL; st: PByte): TOpenSSL_C_LONG; cdecl;
function SSL_set1_chain_cert_store(s: PSSL; st: PByte): TOpenSSL_C_LONG; cdecl;
function SSL_get1_groups(s: PSSL; glist: POpenSSL_C_INT): TOpenSSL_C_LONG; cdecl;
function SSL_CTX_set1_groups(ctx: PSSL_CTX; glist: PByte; glistlen: TOpenSSL_C_LONG): TOpenSSL_C_LONG; cdecl;
function SSL_CTX_set1_groups_list(ctx: PSSL_CTX; s: PByte): TOpenSSL_C_LONG; cdecl;
function SSL_set1_groups(s: PSSL; glist: PByte; glistlen: TOpenSSL_C_LONG): TOpenSSL_C_LONG; cdecl;
function SSL_set1_groups_list(s: PSSL; str: PByte): TOpenSSL_C_LONG; cdecl;
function SSL_get_shared_group(s: PSSL; n: TOpenSSL_C_LONG): TOpenSSL_C_LONG; cdecl;
function SSL_CTX_set1_sigalgs(ctx: PSSL_CTX; slist: POpenSSL_C_INT; slistlen: TOpenSSL_C_LONG): TOpenSSL_C_LONG; cdecl;
function SSL_CTX_set1_sigalgs_list(ctx: PSSL_CTX; s: PByte): TOpenSSL_C_LONG; cdecl;
function SSL_set1_sigalgs(s: PSSL; slist: POpenSSL_C_INT; slistlen: TOpenSSL_C_LONG): TOpenSSL_C_LONG; cdecl;
function SSL_set1_sigalgs_list(s: PSSL; str: PByte): TOpenSSL_C_LONG; cdecl;
function SSL_CTX_set1_client_sigalgs(ctx: PSSL_CTX; slist: POpenSSL_C_INT; slistlen: TOpenSSL_C_LONG): TOpenSSL_C_LONG; cdecl;
function SSL_CTX_set1_client_sigalgs_list(ctx: PSSL_CTX; s: PByte): TOpenSSL_C_LONG; cdecl;
function SSL_set1_client_sigalgs(s: PSSL; slist: POpenSSL_C_INT; slistlen: TOpenSSL_C_LONG): TOpenSSL_C_LONG; cdecl;
function SSL_set1_client_sigalgs_list(s: PSSL; str: PByte): TOpenSSL_C_LONG; cdecl;
function SSL_get0_certificate_types(s: PSSL; clist: PByte): TOpenSSL_C_LONG; cdecl;
function SSL_CTX_set1_client_certificate_types(ctx: PSSL_CTX; clist: PByte; clistlen: TOpenSSL_C_LONG): TOpenSSL_C_LONG; cdecl;
function SSL_set1_client_certificate_types(s: PSSL; clist: PByte; clistlen: TOpenSSL_C_LONG): TOpenSSL_C_LONG; cdecl;
function SSL_get_signature_nid(s: PSSL; pn: Pointer): TOpenSSL_C_LONG; cdecl;
function SSL_get_peer_signature_nid(s: PSSL; pn: Pointer): TOpenSSL_C_LONG; cdecl;
function SSL_get_peer_tmp_key(s: PSSL; pk: Pointer): TOpenSSL_C_LONG; cdecl;
function SSL_get_tmp_key(s: PSSL; pk: Pointer): TOpenSSL_C_LONG; cdecl;
function SSL_get0_raw_cipherlist(s: PSSL; plst: Pointer): TOpenSSL_C_LONG; cdecl;
function SSL_get0_ec_point_formats(s: PSSL; plst: Pointer): TOpenSSL_C_LONG; cdecl;
function SSL_get_app_data(const ssl: PSSL): Pointer; cdecl;
function SSL_set_app_data(ssl: PSSL; data: Pointer): TOpenSSL_C_INT; cdecl;
function SSLeay_add_ssl_algorithms: TOpenSSL_C_INT; cdecl;
procedure SSL_load_error_strings; cdecl;
function SSL_get_peer_certificate(const s: PSSL): PX509; cdecl;
function SSL_library_init: TOpenSSL_C_INT; cdecl;
...
var
  SSL_CTX_get_options: function (const ctx: PSSL_CTX): TOpenSSL_C_ULONG; cdecl = Load_SSL_CTX_get_options; {introduced 1.1.0 }
  SSL_get_options: function (const s: PSSL): TOpenSSL_C_ULONG; cdecl = Load_SSL_get_options; {introduced 1.1.0 }
  SSL_CTX_clear_options: function (ctx: PSSL_CTX; op: TOpenSSL_C_ULONG): TOpenSSL_C_ULONG; cdecl = Load_SSL_CTX_clear_options; {introduced 1.1.0 }
  SSL_clear_options: function (s: PSSL; op: TOpenSSL_C_ULONG): TOpenSSL_C_ULONG; cdecl = Load_SSL_clear_options; {introduced 1.1.0 }
  SSL_CTX_set_options: function (ctx: PSSL_CTX; op: TOpenSSL_C_ULONG): TOpenSSL_C_ULONG; cdecl = Load_SSL_CTX_set_options; {introduced 1.1.0 }
  SSL_set_options: function (s: PSSL; op: TOpenSSL_C_ULONG): TOpenSSL_C_ULONG; cdecl = Load_SSL_set_options; {introduced 1.1.0 }
  ...
  SSL_CTX_set_stateless_cookie_generate_cb: procedure (ctx: PSSL_CTX; gen_stateless_cookie_cb: SSL_CTX_set_stateless_cookie_generate_cb_gen_stateless_cookie_cb); cdecl = Load_SSL_CTX_set_stateless_cookie_generate_cb; {introduced 1.1.0 }
  SSL_CTX_set_stateless_cookie_verify_cb: procedure (ctx: PSSL_CTX; verify_stateless_cookie_cb: SSL_CTX_set_stateless_cookie_verify_cb_verify_stateless_cookie_cb); cdecl = Load_SSL_CTX_set_stateless_cookie_verify_cb; {introduced 1.1.0 }
  ...
  SSL_set_psk_find_session_callback: procedure (s: PSSL; cb: SSL_psk_find_session_cb_func); cdecl = Load_SSL_set_psk_find_session_callback; {introduced 1.1.0 }
  SSL_CTX_set_psk_find_session_callback: procedure (ctx: PSSL_CTX; cb: SSL_psk_find_session_cb_func); cdecl = Load_SSL_CTX_set_psk_find_session_callback; {introduced 1.1.0 }
  SSL_set_psk_use_session_callback: procedure (s: PSSL; cb: SSL_psk_use_session_cb_func); cdecl = Load_SSL_set_psk_use_session_callback; {introduced 1.1.0 }
  SSL_CTX_set_psk_use_session_callback: procedure (ctx: PSSL_CTX; cb: SSL_psk_use_session_cb_func); cdecl = Load_SSL_CTX_set_psk_use_session_callback; {introduced 1.1.0 }
  SSL_CTX_set_keylog_callback: procedure (ctx: PSSL_CTX; cb: SSL_CTX_keylog_cb_func); cdecl = Load_SSL_CTX_set_keylog_callback; {introduced 1.1.0 }
  SSL_CTX_get_keylog_callback: function (const ctx: PSSL_CTX): SSL_CTX_keylog_cb_func; cdecl = Load_SSL_CTX_get_keylog_callback; {introduced 1.1.0 }
  SSL_CTX_set_max_early_data: function (ctx: PSSL_CTX; max_early_data: TOpenSSL_C_UINT32): TOpenSSL_C_INT; cdecl = Load_SSL_CTX_set_max_early_data; {introduced 1.1.0 }
  SSL_CTX_get_max_early_data: function (const ctx: PSSL_CTX): TOpenSSL_C_UINT32; cdecl = Load_SSL_CTX_get_max_early_data; {introduced 1.1.0 }
  SSL_set_max_early_data: function (s: PSSL; max_early_data: TOpenSSL_C_UINT32): TOpenSSL_C_INT; cdecl = Load_SSL_set_max_early_data; {introduced 1.1.0 }
  SSL_get_max_early_data: function (const s: PSSL): TOpenSSL_C_UINT32; cdecl = Load_SSL_get_max_early_data; {introduced 1.1.0 }
  SSL_CTX_set_recv_max_early_data: function (ctx: PSSL_CTX; recv_max_early_data: TOpenSSL_C_UINT32): TOpenSSL_C_INT; cdecl = Load_SSL_CTX_set_recv_max_early_data; {introduced 1.1.0 }
  SSL_CTX_get_recv_max_early_data: function (const ctx: PSSL_CTX): TOpenSSL_C_UINT32; cdecl = Load_SSL_CTX_get_recv_max_early_data; {introduced 1.1.0 }
  SSL_set_recv_max_early_data: function (s: PSSL; recv_max_early_data: TOpenSSL_C_UINT32): TOpenSSL_C_INT; cdecl = Load_SSL_set_recv_max_early_data; {introduced 1.1.0 }
  SSL_get_recv_max_early_data: function (const s: PSSL): TOpenSSL_C_UINT32; cdecl = Load_SSL_get_recv_max_early_data; {introduced 1.1.0 }
  SSL_in_init: function (const s: PSSL): TOpenSSL_C_INT; cdecl = Load_SSL_in_init; {introduced 1.1.0 }
  SSL_in_before: function (const s: PSSL): TOpenSSL_C_INT; cdecl = Load_SSL_in_before; {introduced 1.1.0 }
  SSL_is_init_finished: function (const s: PSSL): TOpenSSL_C_INT; cdecl = Load_SSL_is_init_finished; {introduced 1.1.0 }
  ...
  SSL_CTX_up_ref: function (ctx: PSSL_CTX): TOpenSSL_C_INT; cdecl = Load_SSL_CTX_up_ref; {introduced 1.1.0 }
  ...
  SSL_CTX_set1_cert_store: procedure (v1: PSSL_CTX; v2: PX509_STORE); cdecl = Load_SSL_CTX_set1_cert_store; {introduced 1.1.0 }
  ...
  SSL_get_pending_cipher: function (const s: PSSL): PSSL_CIPHER; cdecl = Load_SSL_get_pending_cipher; {introduced 1.1.0 }
  ...
  SSL_CIPHER_standard_name: function (const c: PSSL_CIPHER): PAnsiChar; cdecl = Load_SSL_CIPHER_standard_name; {introduced 1.1.0 }
  OPENSSL_cipher_name: function (const rfc_name: PAnsiChar): PAnsiChar; cdecl = Load_OPENSSL_cipher_name; {introduced 1.1.0 }
  SSL_CIPHER_get_id: function (const c: PSSL_CIPHER): TOpenSSL_C_UINT32; cdecl = Load_SSL_CIPHER_get_id;
  SSL_CIPHER_get_protocol_id: function (const c: PSSL_CIPHER): TOpenSSL_C_UINT16; cdecl = Load_SSL_CIPHER_get_protocol_id; {introduced 1.1.0 }
  SSL_CIPHER_get_kx_nid: function (const c: PSSL_CIPHER): TOpenSSL_C_INT; cdecl = Load_SSL_CIPHER_get_kx_nid; {introduced 1.1.0 }
  SSL_CIPHER_get_auth_nid: function (const c: PSSL_CIPHER): TOpenSSL_C_INT; cdecl = Load_SSL_CIPHER_get_auth_nid; {introduced 1.1.0 }
  SSL_CIPHER_get_handshake_digest: function (const c: PSSL_CIPHER): PEVP_MD; cdecl = Load_SSL_CIPHER_get_handshake_digest; {introduced 1.1.0 }
  SSL_CIPHER_is_aead: function (const c: PSSL_CIPHER): TOpenSSL_C_INT; cdecl = Load_SSL_CIPHER_is_aead; {introduced 1.1.0 }
  ...
  SSL_has_pending: function (const s: PSSL): TOpenSSL_C_INT; cdecl = Load_SSL_has_pending; {introduced 1.1.0 }
  ...
  SSL_set0_rbio: procedure (s: PSSL; rbio: PBIO); cdecl = Load_SSL_set0_rbio; {introduced 1.1.0 }
  SSL_set0_wbio: procedure (s: PSSL; wbio: PBIO); cdecl = Load_SSL_set0_wbio; {introduced 1.1.0 }
  ...
  SSL_CTX_set_ciphersuites: function (ctx: PSSL_CTX; const str: PAnsiChar): TOpenSSL_C_INT; cdecl = Load_SSL_CTX_set_ciphersuites; {introduced 1.1.0 }
  SSL_set_ciphersuites: function (s: PSSL; const str: PAnsiChar): TOpenSSL_C_INT; cdecl = Load_SSL_set_ciphersuites; {introduced 1.1.0 }
  ...
  SSL_CTX_use_serverinfo_ex: function (ctx: PSSL_CTX; version: TOpenSSL_C_UINT; const serverinfo: PByte; serverinfo_length: TOpenSSL_C_SIZET): TOpenSSL_C_INT; cdecl = Load_SSL_CTX_use_serverinfo_ex; {introduced 1.1.0 }
  ...
  SSL_use_certificate_chain_file: function (ssl: PSSL; const file_: PAnsiChar): TOpenSSL_C_INT; cdecl = Load_SSL_use_certificate_chain_file; {introduced 1.1.0 }
  ...
  SSL_SESSION_get_protocol_version: function (const s: PSSL_SESSION): TOpenSSL_C_INT; cdecl = Load_SSL_SESSION_get_protocol_version; {introduced 1.1.0 }
  SSL_SESSION_set_protocol_version: function (s: PSSL_SESSION; version: TOpenSSL_C_INT): TOpenSSL_C_INT; cdecl = Load_SSL_SESSION_set_protocol_version; {introduced 1.1.0 }
  SSL_SESSION_get0_hostname: function (const s: PSSL_SESSION): PAnsiChar; cdecl = Load_SSL_SESSION_get0_hostname; {introduced 1.1.0 }
  SSL_SESSION_set1_hostname: function (s: PSSL_SESSION; const hostname: PAnsiChar): TOpenSSL_C_INT; cdecl = Load_SSL_SESSION_set1_hostname; {introduced 1.1.0 }
  SSL_SESSION_get0_alpn_selected: procedure (const s: PSSL_SESSION; const alpn: PPByte; len: POpenSSL_C_SIZET); cdecl = Load_SSL_SESSION_get0_alpn_selected; {introduced 1.1.0 }
  SSL_SESSION_set1_alpn_selected: function (s: PSSL_SESSION; const alpn: PByte; len: TOpenSSL_C_SIZET): TOpenSSL_C_INT; cdecl = Load_SSL_SESSION_set1_alpn_selected; {introduced 1.1.0 }
  SSL_SESSION_get0_cipher: function (const s: PSSL_SESSION): PSSL_CIPHER; cdecl = Load_SSL_SESSION_get0_cipher; {introduced 1.1.0 }
  SSL_SESSION_set_cipher: function (s: PSSL_SESSION; const cipher: PSSL_CIPHER): TOpenSSL_C_INT; cdecl = Load_SSL_SESSION_set_cipher; {introduced 1.1.0 }
  SSL_SESSION_has_ticket: function (const s: PSSL_SESSION): TOpenSSL_C_INT; cdecl = Load_SSL_SESSION_has_ticket; {introduced 1.1.0 }
  SSL_SESSION_get_ticket_lifetime_hint: function (const s: PSSL_SESSION): TOpenSSL_C_ULONG; cdecl = Load_SSL_SESSION_get_ticket_lifetime_hint; {introduced 1.1.0 }
  SSL_SESSION_get0_ticket: procedure (const s: PSSL_SESSION; const tick: PPByte; len: POpenSSL_C_SIZET); cdecl = Load_SSL_SESSION_get0_ticket; {introduced 1.1.0 }
  SSL_SESSION_get_max_early_data: function (const s: PSSL_SESSION): TOpenSSL_C_UINT32; cdecl = Load_SSL_SESSION_get_max_early_data; {introduced 1.1.0 }
  SSL_SESSION_set_max_early_data: function (s: PSSL_SESSION; max_early_data: TOpenSSL_C_UINT32): TOpenSSL_C_INT; cdecl = Load_SSL_SESSION_set_max_early_data; {introduced 1.1.0 }
  ...
  SSL_SESSION_set1_id: function (s: PSSL_SESSION; const sid: PByte; sid_len: TOpenSSL_C_UINT): TOpenSSL_C_INT; cdecl = Load_SSL_SESSION_set1_id; {introduced 1.1.0 }
  SSL_SESSION_is_resumable: function (const s: PSSL_SESSION): TOpenSSL_C_INT; cdecl = Load_SSL_SESSION_is_resumable; {introduced 1.1.0 }
  SSL_SESSION_new: function : PSSL_SESSION; cdecl = Load_SSL_SESSION_new;
  SSL_SESSION_dup: function (src: PSSL_SESSION): PSSL_SESSION; cdecl = Load_SSL_SESSION_dup; {introduced 1.1.0 }
  SSL_SESSION_get_id: function (const s: PSSL_SESSION; len: POpenSSL_C_UINT): PByte; cdecl = Load_SSL_SESSION_get_id;
  SSL_SESSION_get0_id_context: function (const s: PSSL_SESSION; len: POpenSSL_C_UINT): PByte; cdecl = Load_SSL_SESSION_get0_id_context; {introduced 1.1.0 }
  ...
  SSL_SESSION_print_keylog: function (bp: PBIO; const x: PSSL_SESSION): TOpenSSL_C_INT; cdecl = Load_SSL_SESSION_print_keylog; {introduced 1.1.0 }
  SSL_SESSION_up_ref: function (ses: PSSL_SESSION): TOpenSSL_C_INT; cdecl = Load_SSL_SESSION_up_ref; {introduced 1.1.0 }
  ...
  SSL_CTX_set_default_passwd_cb: procedure (ctx: PSSL_CTX; cb: pem_password_cb); cdecl = Load_SSL_CTX_set_default_passwd_cb; {introduced 1.1.0 }
  SSL_CTX_set_default_passwd_cb_userdata: procedure (ctx: PSSL_CTX; u: Pointer); cdecl = Load_SSL_CTX_set_default_passwd_cb_userdata; {introduced 1.1.0 }
  SSL_CTX_get_default_passwd_cb: function (ctx: PSSL_CTX): pem_password_cb; cdecl = Load_SSL_CTX_get_default_passwd_cb; {introduced 1.1.0 }
  SSL_CTX_get_default_passwd_cb_userdata: function (ctx: PSSL_CTX): Pointer; cdecl = Load_SSL_CTX_get_default_passwd_cb_userdata; {introduced 1.1.0 }
  SSL_set_default_passwd_cb: procedure (s: PSSL; cb: pem_password_cb); cdecl = Load_SSL_set_default_passwd_cb; {introduced 1.1.0 }
  SSL_set_default_passwd_cb_userdata: procedure (s: PSSL; u: Pointer); cdecl = Load_SSL_set_default_passwd_cb_userdata; {introduced 1.1.0 }
  SSL_get_default_passwd_cb: function (s: PSSL): pem_password_cb; cdecl = Load_SSL_get_default_passwd_cb; {introduced 1.1.0 }
  SSL_get_default_passwd_cb_userdata: function (s: PSSL): Pointer; cdecl = Load_SSL_get_default_passwd_cb_userdata; {introduced 1.1.0 }
  ...
  SSL_up_ref: function (s: PSSL): TOpenSSL_C_INT; cdecl = Load_SSL_up_ref; {introduced 1.1.0 }
  SSL_is_dtls: function (const s: PSSL): TOpenSSL_C_INT; cdecl = Load_SSL_is_dtls; {introduced 1.1.0 }
  ...
  SSL_set1_host: function (s: PSSL; const hostname: PAnsiChar): TOpenSSL_C_INT; cdecl = Load_SSL_set1_host; {introduced 1.1.0 }
  SSL_add1_host: function (s: PSSL; const hostname: PAnsiChar): TOpenSSL_C_INT; cdecl = Load_SSL_add1_host; {introduced 1.1.0 }
  SSL_get0_peername: function (s: PSSL): PAnsiChar; cdecl = Load_SSL_get0_peername; {introduced 1.1.0 }
  SSL_set_hostflags: procedure (s: PSSL; flags: TOpenSSL_C_UINT); cdecl = Load_SSL_set_hostflags; {introduced 1.1.0 }
  SSL_CTX_dane_enable: function (ctx: PSSL_CTX): TOpenSSL_C_INT; cdecl = Load_SSL_CTX_dane_enable; {introduced 1.1.0 }
  SSL_CTX_dane_mtype_set: function (ctx: PSSL_CTX; const md: PEVP_MD; mtype: TOpenSSL_C_UINT8; ord: TOpenSSL_C_UINT8): TOpenSSL_C_INT; cdecl = Load_SSL_CTX_dane_mtype_set; {introduced 1.1.0 }
  SSL_dane_enable: function (s: PSSL; const basedomain: PAnsiChar): TOpenSSL_C_INT; cdecl = Load_SSL_dane_enable; {introduced 1.1.0 }
  SSL_dane_tlsa_add: function (s: PSSL; usage: TOpenSSL_C_UINT8; selector: TOpenSSL_C_UINT8; mtype: TOpenSSL_C_UINT8; const data: PByte; dlen: TOpenSSL_C_SIZET): TOpenSSL_C_INT; cdecl = Load_SSL_dane_tlsa_add; {introduced 1.1.0 }
  SSL_get0_dane_authority: function (s: PSSL; mcert: PPX509; mspki: PPEVP_PKEY): TOpenSSL_C_INT; cdecl = Load_SSL_get0_dane_authority; {introduced 1.1.0 }
  SSL_get0_dane_tlsa: function (s: PSSL; usage: POpenSSL_C_UINT8; selector: POpenSSL_C_UINT8; mtype: POpenSSL_C_UINT8; const data: PPByte; dlen: POpenSSL_C_SIZET): TOpenSSL_C_INT; cdecl = Load_SSL_get0_dane_tlsa; {introduced 1.1.0 }
  SSL_get0_dane: function (ssl: PSSL): PSSL_DANE; cdecl = Load_SSL_get0_dane; {introduced 1.1.0 }
  SSL_CTX_dane_set_flags: function (ctx: PSSL_CTX; flags: TOpenSSL_C_ULONG): TOpenSSL_C_ULONG; cdecl = Load_SSL_CTX_dane_set_flags; {introduced 1.1.0 }
  SSL_CTX_dane_clear_flags: function (ctx: PSSL_CTX; flags: TOpenSSL_C_ULONG): TOpenSSL_C_ULONG; cdecl = Load_SSL_CTX_dane_clear_flags; {introduced 1.1.0 }
  SSL_dane_set_flags: function (ssl: PSSL; flags: TOpenSSL_C_ULONG): TOpenSSL_C_ULONG; cdecl = Load_SSL_dane_set_flags; {introduced 1.1.0 }
  SSL_dane_clear_flags: function (ssl: PSSL; flags: TOpenSSL_C_ULONG): TOpenSSL_C_ULONG; cdecl = Load_SSL_dane_clear_flags; {introduced 1.1.0 }
  ...
  SSL_CTX_set_client_hello_cb: procedure (c: PSSL_CTX; cb: SSL_client_hello_cb_fn; arg: Pointer); cdecl = Load_SSL_CTX_set_client_hello_cb; {introduced 1.1.0 }
  SSL_client_hello_isv2: function (s: PSSL): TOpenSSL_C_INT; cdecl = Load_SSL_client_hello_isv2; {introduced 1.1.0 }
  SSL_client_hello_get0_legacy_version: function (s: PSSL): TOpenSSL_C_UINT; cdecl = Load_SSL_client_hello_get0_legacy_version; {introduced 1.1.0 }
  SSL_client_hello_get0_random: function (s: PSSL; const out_: PPByte): TOpenSSL_C_SIZET; cdecl = Load_SSL_client_hello_get0_random; {introduced 1.1.0 }
  SSL_client_hello_get0_session_id: function (s: PSSL; const out_: PPByte): TOpenSSL_C_SIZET; cdecl = Load_SSL_client_hello_get0_session_id; {introduced 1.1.0 }
  SSL_client_hello_get0_ciphers: function (s: PSSL; const out_: PPByte): TOpenSSL_C_SIZET; cdecl = Load_SSL_client_hello_get0_ciphers; {introduced 1.1.0 }
  SSL_client_hello_get0_compression_methods: function (s: PSSL; const out_: PPByte): TOpenSSL_C_SIZET; cdecl = Load_SSL_client_hello_get0_compression_methods; {introduced 1.1.0 }
  SSL_client_hello_get1_extensions_present: function (s: PSSL; out_: PPOpenSSL_C_INT; outlen: POpenSSL_C_SIZET): TOpenSSL_C_INT; cdecl = Load_SSL_client_hello_get1_extensions_present; {introduced 1.1.0 }
  SSL_client_hello_get0_ext: function (s: PSSL; type_: TOpenSSL_C_UINT; const out_: PPByte; outlen: POpenSSL_C_SIZET): TOpenSSL_C_INT; cdecl = Load_SSL_client_hello_get0_ext; {introduced 1.1.0 }
  SSL_certs_clear: procedure (s: PSSL); cdecl = Load_SSL_certs_clear;
  SSL_free: procedure (ssl: PSSL); cdecl = Load_SSL_free;
  SSL_waiting_for_async: function (s: PSSL): TOpenSSL_C_INT; cdecl = Load_SSL_waiting_for_async; {introduced 1.1.0 }
  SSL_get_all_async_fds: function (s: PSSL; fds: POSSL_ASYNC_FD; numfds: POpenSSL_C_SIZET): TOpenSSL_C_INT; cdecl = Load_SSL_get_all_async_fds; {introduced 1.1.0 }
  SSL_get_changed_async_fds: function (s: PSSL; addfd: POSSL_ASYNC_FD; numaddfds: POpenSSL_C_SIZET; delfd: POSSL_ASYNC_FD; numdelfds: POpenSSL_C_SIZET): TOpenSSL_C_INT; cdecl = Load_SSL_get_changed_async_fds; {introduced 1.1.0 }
  SSL_accept: function (ssl: PSSL): TOpenSSL_C_INT; cdecl = Load_SSL_accept;
  SSL_stateless: function (s: PSSL): TOpenSSL_C_INT; cdecl = Load_SSL_stateless; {introduced 1.1.0 }
  ...
  SSL_read_ex: function (ssl: PSSL; buf: Pointer; num: TOpenSSL_C_SIZET; readbytes: POpenSSL_C_SIZET): TOpenSSL_C_INT; cdecl = Load_SSL_read_ex; {introduced 1.1.0 }
  SSL_read_early_data: function (s: PSSL; buf: Pointer; num: TOpenSSL_C_SIZET; readbytes: POpenSSL_C_SIZET): TOpenSSL_C_INT; cdecl = Load_SSL_read_early_data; {introduced 1.1.0 }
  SSL_peek: function (ssl: PSSL; buf: Pointer; num: TOpenSSL_C_INT): TOpenSSL_C_INT; cdecl = Load_SSL_peek;
  SSL_peek_ex: function (ssl: PSSL; buf: Pointer; num: TOpenSSL_C_SIZET; readbytes: POpenSSL_C_SIZET): TOpenSSL_C_INT; cdecl = Load_SSL_peek_ex; {introduced 1.1.0 }
  SSL_write: function (ssl: PSSL; const buf: Pointer; num: TOpenSSL_C_INT): TOpenSSL_C_INT; cdecl = Load_SSL_write;
  SSL_write_ex: function (s: PSSL; const buf: Pointer; num: TOpenSSL_C_SIZET; written: POpenSSL_C_SIZET): TOpenSSL_C_INT; cdecl = Load_SSL_write_ex; {introduced 1.1.0 }
  SSL_write_early_data: function (s: PSSL; const buf: Pointer; num: TOpenSSL_C_SIZET; written: POpenSSL_C_SIZET): TOpenSSL_C_INT; cdecl = Load_SSL_write_early_data; {introduced 1.1.0 }
  ...
  SSL_get_early_data_status: function (const s: PSSL): TOpenSSL_C_INT; cdecl = Load_SSL_get_early_data_status; {introduced 1.1.0 }
  ...
  TLS_method: function : PSSL_METHOD; cdecl = Load_TLS_method; {introduced 1.1.0 }
  TLS_server_method: function : PSSL_METHOD; cdecl = Load_TLS_server_method; {introduced 1.1.0 }
  TLS_client_method: function : PSSL_METHOD; cdecl = Load_TLS_client_method; {introduced 1.1.0 }
  SSL_key_update: function (s: PSSL; updatetype: TOpenSSL_C_INT): TOpenSSL_C_INT; cdecl = Load_SSL_key_update; {introduced 1.1.0 }
  SSL_get_key_update_type: function (const s: PSSL): TOpenSSL_C_INT; cdecl = Load_SSL_get_key_update_type; {introduced 1.1.0 }
  ...
  SSL_CTX_set_post_handshake_auth: procedure (ctx: PSSL_CTX; val: TOpenSSL_C_INT); cdecl = Load_SSL_CTX_set_post_handshake_auth; {introduced 1.1.0 }
  SSL_set_post_handshake_auth: procedure (s: PSSL; val: TOpenSSL_C_INT); cdecl = Load_SSL_set_post_handshake_auth; {introduced 1.1.0 }
  SSL_renegotiate_pending: function (const s: PSSL): TOpenSSL_C_INT; cdecl = Load_SSL_renegotiate_pending;
  SSL_verify_client_post_handshake: function (s: PSSL): TOpenSSL_C_INT; cdecl = Load_SSL_verify_client_post_handshake; {introduced 1.1.0 }
  ...
  SSL_client_version: function (const s: PSSL): TOpenSSL_C_INT; cdecl = Load_SSL_client_version; {introduced 1.1.0 }
  SSL_CTX_set_default_verify_paths: function (ctx: PSSL_CTX): TOpenSSL_C_INT; cdecl = Load_SSL_CTX_set_default_verify_paths;
  SSL_CTX_set_default_verify_dir: function (ctx: PSSL_CTX): TOpenSSL_C_INT; cdecl = Load_SSL_CTX_set_default_verify_dir; {introduced 1.1.0 }
  SSL_CTX_set_default_verify_file: function (ctx: PSSL_CTX): TOpenSSL_C_INT; cdecl = Load_SSL_CTX_set_default_verify_file; {introduced 1.1.0 }
  ...
  SSL_get_state: function (const ssl: PSSL): OSSL_HANDSHAKE_STATE; cdecl = Load_SSL_get_state; {introduced 1.1.0 }
  ...
  SSL_get_client_random: function (const ssl: PSSL; out_: PByte; outlen: TOpenSSL_C_SIZET): TOpenSSL_C_SIZET; cdecl = Load_SSL_get_client_random; {introduced 1.1.0 }
  SSL_get_server_random: function (const ssl: PSSL; out_: PByte; outlen: TOpenSSL_C_SIZET): TOpenSSL_C_SIZET; cdecl = Load_SSL_get_server_random; {introduced 1.1.0 }
  SSL_SESSION_get_master_key: function (const sess: PSSL_SESSION; out_: PByte; outlen: TOpenSSL_C_SIZET): TOpenSSL_C_SIZET; cdecl = Load_SSL_SESSION_get_master_key; {introduced 1.1.0 }
  SSL_SESSION_set1_master_key: function (sess: PSSL_SESSION; const in_: PByte; len: TOpenSSL_C_SIZET): TOpenSSL_C_INT; cdecl = Load_SSL_SESSION_set1_master_key; {introduced 1.1.0 }
  SSL_SESSION_get_max_fragment_length: function (const sess: PSSL_SESSION): TOpenSSL_C_UINT8; cdecl = Load_SSL_SESSION_get_max_fragment_length; {introduced 1.1.0 }
  ...
  SSL_CTX_set_default_read_buffer_len: procedure (ctx: PSSL_CTX; len: TOpenSSL_C_SIZET); cdecl = Load_SSL_CTX_set_default_read_buffer_len; {introduced 1.1.0 }
  SSL_set_default_read_buffer_len: procedure (s: PSSL; len: TOpenSSL_C_SIZET); cdecl = Load_SSL_set_default_read_buffer_len; {introduced 1.1.0 }
  ...
  SSL_CIPHER_get_cipher_nid: function (const c: PSSL_CIPHEr): TOpenSSL_C_INT; cdecl = Load_SSL_CIPHER_get_cipher_nid; {introduced 1.1.0 }
  SSL_CIPHER_get_digest_nid: function (const c: PSSL_CIPHEr): TOpenSSL_C_INT; cdecl = Load_SSL_CIPHER_get_digest_nid; {introduced 1.1.0 }
  ...
  SSL_CTX_set_not_resumable_session_callback: procedure (ctx: PSSL_CTX; cb: SSL_CTX_set_not_resumable_session_callback_cb); cdecl = Load_SSL_CTX_set_not_resumable_session_callback; {introduced 1.1.0 }
  SSL_set_not_resumable_session_callback: procedure (ssl: PSSL; cb: SSL_set_not_resumable_session_callback_cb); cdecl = Load_SSL_set_not_resumable_session_callback; {introduced 1.1.0 }
  SSL_CTX_set_record_padding_callback: procedure (ctx: PSSL_CTX; cb: SSL_CTX_set_record_padding_callback_cb); cdecl = Load_SSL_CTX_set_record_padding_callback; {introduced 1.1.0 }
  SSL_CTX_set_record_padding_callback_arg: procedure (ctx: PSSL_CTX; arg: Pointer); cdecl = Load_SSL_CTX_set_record_padding_callback_arg; {introduced 1.1.0 }
  SSL_CTX_get_record_padding_callback_arg: function (const ctx: PSSL_CTX): Pointer; cdecl = Load_SSL_CTX_get_record_padding_callback_arg; {introduced 1.1.0 }
  SSL_CTX_set_block_padding: function (ctx: PSSL_CTX; block_size: TOpenSSL_C_SIZET): TOpenSSL_C_INT; cdecl = Load_SSL_CTX_set_block_padding; {introduced 1.1.0 }
  SSL_set_record_padding_callback: procedure (ssl: PSSL; cb: SSL_set_record_padding_callback_cb); cdecl = Load_SSL_set_record_padding_callback; {introduced 1.1.0 }
  SSL_set_record_padding_callback_arg: procedure (ssl: PSSL; arg: Pointer); cdecl = Load_SSL_set_record_padding_callback_arg; {introduced 1.1.0 }
  SSL_get_record_padding_callback_arg: function (const ssl: PSSL): Pointer; cdecl = Load_SSL_get_record_padding_callback_arg; {introduced 1.1.0 }
  SSL_set_block_padding: function (ssl: PSSL; block_size: TOpenSSL_C_SIZET): TOpenSSL_C_INT; cdecl = Load_SSL_set_block_padding; {introduced 1.1.0 }
  SSL_set_num_tickets: function (s: PSSL; num_tickets: TOpenSSL_C_SIZET): TOpenSSL_C_INT; cdecl = Load_SSL_set_num_tickets; {introduced 1.1.0 }
  SSL_get_num_tickets: function (const s: PSSL): TOpenSSL_C_SIZET; cdecl = Load_SSL_get_num_tickets; {introduced 1.1.0 }
  SSL_CTX_set_num_tickets: function (ctx: PSSL_CTX; num_tickets: TOpenSSL_C_SIZET): TOpenSSL_C_INT; cdecl = Load_SSL_CTX_set_num_tickets; {introduced 1.1.0 }
  SSL_CTX_get_num_tickets: function (const ctx: PSSL_CTX): TOpenSSL_C_SIZET; cdecl = Load_SSL_CTX_get_num_tickets; {introduced 1.1.0 }
  SSL_session_reused: function (const s: PSSL): TOpenSSL_C_INT; cdecl = Load_SSL_session_reused; {introduced 1.1.0 }
  ...
  SSL_add_ssl_module: procedure ; cdecl = Load_SSL_add_ssl_module; {introduced 1.1.0 }
  SSL_config: function (s: PSSL; const name: PAnsiChar): TOpenSSL_C_INT; cdecl = Load_SSL_config; {introduced 1.1.0 }
  SSL_CTX_config: function (ctx: PSSL_CTX; const name: PAnsiChar): TOpenSSL_C_INT; cdecl = Load_SSL_CTX_config; {introduced 1.1.0 }
  DTLSv1_listen: function (s: PSSL; client: PBIO_ADDr): TOpenSSL_C_INT; cdecl = Load_DTLSv1_listen; {introduced 1.1.0 }
  SSL_enable_ct: function (s: PSSL; validation_mode: TOpenSSL_C_INT): TOpenSSL_C_INT; cdecl = Load_SSL_enable_ct; {introduced 1.1.0 }
  SSL_CTX_enable_ct: function (ctx: PSSL_CTX; validation_mode: TOpenSSL_C_INT): TOpenSSL_C_INT; cdecl = Load_SSL_CTX_enable_ct; {introduced 1.1.0 }
  SSL_ct_is_enabled: function (const s: PSSL): TOpenSSL_C_INT; cdecl = Load_SSL_ct_is_enabled; {introduced 1.1.0 }
  SSL_CTX_ct_is_enabled: function (const ctx: PSSL_CTX): TOpenSSL_C_INT; cdecl = Load_SSL_CTX_ct_is_enabled; {introduced 1.1.0 }
  SSL_CTX_set_default_ctlog_list_file: function (ctx: PSSL_CTX): TOpenSSL_C_INT; cdecl = Load_SSL_CTX_set_default_ctlog_list_file; {introduced 1.1.0 }
  SSL_CTX_set_ctlog_list_file: function (ctx: PSSL_CTX; const path: PAnsiChar): TOpenSSL_C_INT; cdecl = Load_SSL_CTX_set_ctlog_list_file; {introduced 1.1.0 }
  SSL_CTX_set0_ctlog_store: procedure (ctx: PSSL_CTX; logs: PCTLOG_STORE); cdecl = Load_SSL_CTX_set0_ctlog_store; {introduced 1.1.0 }
  SSL_set_security_level: procedure (s: PSSL; level: TOpenSSL_C_INT); cdecl = Load_SSL_set_security_level; {introduced 1.1.0 }
  SSL_set_security_callback: procedure (s: PSSL; cb: SSL_security_callback); cdecl = Load_SSL_set_security_callback; {introduced 1.1.0 }
  SSL_get_security_callback: function (const s: PSSL): SSL_security_callback; cdecl = Load_SSL_get_security_callback; {introduced 1.1.0 }
  SSL_set0_security_ex_data: procedure (s: PSSL; ex: Pointer); cdecl = Load_SSL_set0_security_ex_data; {introduced 1.1.0 }
  SSL_get0_security_ex_data: function (const s: PSSL): Pointer; cdecl = Load_SSL_get0_security_ex_data; {introduced 1.1.0 }
  SSL_CTX_set_security_level: procedure (ctx: PSSL_CTX; level: TOpenSSL_C_INT); cdecl = Load_SSL_CTX_set_security_level; {introduced 1.1.0 }
  SSL_CTX_get_security_level: function (const ctx: PSSL_CTX): TOpenSSL_C_INT; cdecl = Load_SSL_CTX_get_security_level; {introduced 1.1.0 }
  SSL_CTX_get0_security_ex_data: function (const ctx: PSSL_CTX): Pointer; cdecl = Load_SSL_CTX_get0_security_ex_data; {introduced 1.1.0 }
  SSL_CTX_set0_security_ex_data: procedure (ctx: PSSL_CTX; ex: Pointer); cdecl = Load_SSL_CTX_set0_security_ex_data; {introduced 1.1.0 }
  OPENSSL_init_ssl: function (opts: TOpenSSL_C_UINT64; const settings: POPENSSL_INIT_SETTINGS): TOpenSSL_C_INT; cdecl = Load_OPENSSL_init_ssl; {introduced 1.1.0 }
  SSL_free_buffers: function (ssl: PSSL): TOpenSSL_C_INT; cdecl = Load_SSL_free_buffers; {introduced 1.1.0 }
  SSL_alloc_buffers: function (ssl: PSSL): TOpenSSL_C_INT; cdecl = Load_SSL_alloc_buffers; {introduced 1.1.0 }
  SSL_CTX_set_session_ticket_cb: function (ctx: PSSL_CTX; gen_cb: SSL_CTX_generate_session_ticket_fn; dec_cb: SSL_CTX_decrypt_session_ticket_fn; arg: Pointer): TOpenSSL_C_INT; cdecl = Load_SSL_CTX_set_session_ticket_cb; {introduced 1.1.0 }
  SSL_SESSION_set1_ticket_appdata: function (ss: PSSL_SESSION; const data: Pointer; len: TOpenSSL_C_SIZET): TOpenSSL_C_INT; cdecl = Load_SSL_SESSION_set1_ticket_appdata; {introduced 1.1.0 }
  SSL_SESSION_get0_ticket_appdata: function (ss: PSSL_SESSION; data: PPointer; len: POpenSSL_C_SIZET): TOpenSSL_C_INT; cdecl = Load_SSL_SESSION_get0_ticket_appdata; {introduced 1.1.0 }
  DTLS_set_timer_cb: procedure (s: PSSL; cb: DTLS_timer_cb); cdecl = Load_DTLS_set_timer_cb; {introduced 1.1.0 }
  SSL_CTX_set_allow_early_data_cb: procedure (ctx: PSSL_CTX; cb: SSL_allow_early_data_cb_fN; arg: Pointer); cdecl = Load_SSL_CTX_set_allow_early_data_cb; {introduced 1.1.0 }
  SSL_set_allow_early_data_cb: procedure (s: PSSL; cb: SSL_allow_early_data_cb_fN; arg: Pointer); cdecl = Load_SSL_set_allow_early_data_cb; {introduced 1.1.0 }
...
{$ENDIF}
const
  SSL_CTX_set_mode_removed = ((((((byte(1) shl 8) or byte(0)) shl 8) or byte(0)) shl 8) or byte(0)) shl 4;
  SSL_CTX_clear_mode_removed = ((((((byte(1) shl 8) or byte(0)) shl 8) or byte(0)) shl 8) or byte(0)) shl 4;
  SSL_CTX_sess_set_cache_size_removed = ((((((byte(1) shl 8) or byte(0)) shl 8) or byte(0)) shl 8) or byte(0)) shl 4;
  SSL_CTX_sess_get_cache_size_removed = ((((((byte(1) shl 8) or byte(0)) shl 8) or byte(0)) shl 8) or byte(0)) shl 4;
  SSL_CTX_set_session_cache_mode_removed = ((((((byte(1) shl 8) or byte(0)) shl 8) or byte(0)) shl 8) or byte(0)) shl 4;
  SSL_CTX_get_session_cache_mode_removed = ((((((byte(1) shl 8) or byte(0)) shl 8) or byte(0)) shl 8) or byte(0)) shl 4;
  SSL_clear_num_renegotiations_removed = ((((((byte(1) shl 8) or byte(0)) shl 8) or byte(0)) shl 8) or byte(0)) shl 4;
  SSL_total_renegotiations_removed = ((((((byte(1) shl 8) or byte(0)) shl 8) or byte(0)) shl 8) or byte(0)) shl 4;
  SSL_CTX_set_tmp_dh_removed = ((((((byte(1) shl 8) or byte(0)) shl 8) or byte(0)) shl 8) or byte(0)) shl 4;
  SSL_CTX_set_tmp_ecdh_removed = ((((((byte(1) shl 8) or byte(0)) shl 8) or byte(0)) shl 8) or byte(0)) shl 4;
  SSL_CTX_set_dh_auto_removed = ((((((byte(1) shl 8) or byte(0)) shl 8) or byte(0)) shl 8) or byte(0)) shl 4;
  SSL_set_dh_auto_removed = ((((((byte(1) shl 8) or byte(0)) shl 8) or byte(0)) shl 8) or byte(0)) shl 4;
  SSL_set_tmp_dh_removed = ((((((byte(1) shl 8) or byte(0)) shl 8) or byte(0)) shl 8) or byte(0)) shl 4;
  SSL_set_tmp_ecdh_removed = ((((((byte(1) shl 8) or byte(0)) shl 8) or byte(0)) shl 8) or byte(0)) shl 4;
  SSL_CTX_add_extra_chain_cert_removed = ((((((byte(1) shl 8) or byte(0)) shl 8) or byte(0)) shl 8) or byte(0)) shl 4;
  SSL_CTX_get_extra_chain_certs_removed = ((((((byte(1) shl 8) or byte(0)) shl 8) or byte(0)) shl 8) or byte(0)) shl 4;
  SSL_CTX_get_extra_chain_certs_only_removed = ((((((byte(1) shl 8) or byte(0)) shl 8) or byte(0)) shl 8) or byte(0)) shl 4;
  SSL_CTX_clear_extra_chain_certs_removed = ((((((byte(1) shl 8) or byte(0)) shl 8) or byte(0)) shl 8) or byte(0)) shl 4;
  SSL_CTX_set0_chain_removed = ((((((byte(1) shl 8) or byte(0)) shl 8) or byte(0)) shl 8) or byte(0)) shl 4;
  SSL_CTX_set1_chain_removed = ((((((byte(1) shl 8) or byte(0)) shl 8) or byte(0)) shl 8) or byte(0)) shl 4;
  SSL_CTX_add0_chain_cert_removed = ((((((byte(1) shl 8) or byte(0)) shl 8) or byte(0)) shl 8) or byte(0)) shl 4;
  SSL_CTX_add1_chain_cert_removed = ((((((byte(1) shl 8) or byte(0)) shl 8) or byte(0)) shl 8) or byte(0)) shl 4;
  SSL_CTX_get0_chain_certs_removed = ((((((byte(1) shl 8) or byte(0)) shl 8) or byte(0)) shl 8) or byte(0)) shl 4;
  SSL_CTX_clear_chain_certs_removed = ((((((byte(1) shl 8) or byte(0)) shl 8) or byte(0)) shl 8) or byte(0)) shl 4;
  SSL_CTX_build_cert_chain_removed = ((((((byte(1) shl 8) or byte(0)) shl 8) or byte(0)) shl 8) or byte(0)) shl 4;
  SSL_CTX_select_current_cert_removed = ((((((byte(1) shl 8) or byte(0)) shl 8) or byte(0)) shl 8) or byte(0)) shl 4;
  SSL_CTX_set_current_cert_removed = ((((((byte(1) shl 8) or byte(0)) shl 8) or byte(0)) shl 8) or byte(0)) shl 4;
  SSL_CTX_set0_verify_cert_store_removed = ((((((byte(1) shl 8) or byte(0)) shl 8) or byte(0)) shl 8) or byte(0)) shl 4;
  SSL_CTX_set1_verify_cert_store_removed = ((((((byte(1) shl 8) or byte(0)) shl 8) or byte(0)) shl 8) or byte(0)) shl 4;
  SSL_CTX_set0_chain_cert_store_removed = ((((((byte(1) shl 8) or byte(0)) shl 8) or byte(0)) shl 8) or byte(0)) shl 4;
  SSL_CTX_set1_chain_cert_store_removed = ((((((byte(1) shl 8) or byte(0)) shl 8) or byte(0)) shl 8) or byte(0)) shl 4;
  SSL_set0_chain_removed = ((((((byte(1) shl 8) or byte(0)) shl 8) or byte(0)) shl 8) or byte(0)) shl 4;
  SSL_set1_chain_removed = ((((((byte(1) shl 8) or byte(0)) shl 8) or byte(0)) shl 8) or byte(0)) shl 4;
  SSL_add0_chain_cert_removed = ((((((byte(1) shl 8) or byte(0)) shl 8) or byte(0)) shl 8) or byte(0)) shl 4;
  SSL_add1_chain_cert_removed = ((((((byte(1) shl 8) or byte(0)) shl 8) or byte(0)) shl 8) or byte(0)) shl 4;
  SSL_get0_chain_certs_removed = ((((((byte(1) shl 8) or byte(0)) shl 8) or byte(0)) shl 8) or byte(0)) shl 4;
  SSL_clear_chain_certs_removed = ((((((byte(1) shl 8) or byte(0)) shl 8) or byte(0)) shl 8) or byte(0)) shl 4;
  SSL_build_cert_chain_removed = ((((((byte(1) shl 8) or byte(0)) shl 8) or byte(0)) shl 8) or byte(0)) shl 4;
  SSL_select_current_cert_removed = ((((((byte(1) shl 8) or byte(0)) shl 8) or byte(0)) shl 8) or byte(0)) shl 4;
  SSL_set_current_cert_removed = ((((((byte(1) shl 8) or byte(0)) shl 8) or byte(0)) shl 8) or byte(0)) shl 4;
  SSL_set0_verify_cert_store_removed = ((((((byte(1) shl 8) or byte(0)) shl 8) or byte(0)) shl 8) or byte(0)) shl 4;
  SSL_set1_verify_cert_store_removed = ((((((byte(1) shl 8) or byte(0)) shl 8) or byte(0)) shl 8) or byte(0)) shl 4;
  SSL_set0_chain_cert_store_removed = ((((((byte(1) shl 8) or byte(0)) shl 8) or byte(0)) shl 8) or byte(0)) shl 4;
  SSL_set1_chain_cert_store_removed = ((((((byte(1) shl 8) or byte(0)) shl 8) or byte(0)) shl 8) or byte(0)) shl 4;
  SSL_get1_groups_removed = ((((((byte(1) shl 8) or byte(0)) shl 8) or byte(0)) shl 8) or byte(0)) shl 4;
  SSL_CTX_set1_groups_removed = ((((((byte(1) shl 8) or byte(0)) shl 8) or byte(0)) shl 8) or byte(0)) shl 4;
  SSL_CTX_set1_groups_list_removed = ((((((byte(1) shl 8) or byte(0)) shl 8) or byte(0)) shl 8) or byte(0)) shl 4;
  SSL_set1_groups_removed = ((((((byte(1) shl 8) or byte(0)) shl 8) or byte(0)) shl 8) or byte(0)) shl 4;
  SSL_set1_groups_list_removed = ((((((byte(1) shl 8) or byte(0)) shl 8) or byte(0)) shl 8) or byte(0)) shl 4;
  SSL_get_shared_group_removed = ((((((byte(1) shl 8) or byte(0)) shl 8) or byte(0)) shl 8) or byte(0)) shl 4;
  SSL_CTX_set1_sigalgs_removed = ((((((byte(1) shl 8) or byte(0)) shl 8) or byte(0)) shl 8) or byte(0)) shl 4;
  SSL_CTX_set1_sigalgs_list_removed = ((((((byte(1) shl 8) or byte(0)) shl 8) or byte(0)) shl 8) or byte(0)) shl 4;
  SSL_set1_sigalgs_removed = ((((((byte(1) shl 8) or byte(0)) shl 8) or byte(0)) shl 8) or byte(0)) shl 4;
  SSL_set1_sigalgs_list_removed = ((((((byte(1) shl 8) or byte(0)) shl 8) or byte(0)) shl 8) or byte(0)) shl 4;
  SSL_CTX_set1_client_sigalgs_removed = ((((((byte(1) shl 8) or byte(0)) shl 8) or byte(0)) shl 8) or byte(0)) shl 4;
  SSL_CTX_set1_client_sigalgs_list_removed = ((((((byte(1) shl 8) or byte(0)) shl 8) or byte(0)) shl 8) or byte(0)) shl 4;
  SSL_set1_client_sigalgs_removed = ((((((byte(1) shl 8) or byte(0)) shl 8) or byte(0)) shl 8) or byte(0)) shl 4;
  SSL_set1_client_sigalgs_list_removed = ((((((byte(1) shl 8) or byte(0)) shl 8) or byte(0)) shl 8) or byte(0)) shl 4;
  SSL_get0_certificate_types_removed = ((((((byte(1) shl 8) or byte(0)) shl 8) or byte(0)) shl 8) or byte(0)) shl 4;
  SSL_CTX_set1_client_certificate_types_removed = ((((((byte(1) shl 8) or byte(0)) shl 8) or byte(0)) shl 8) or byte(0)) shl 4;
  SSL_set1_client_certificate_types_removed = ((((((byte(1) shl 8) or byte(0)) shl 8) or byte(0)) shl 8) or byte(0)) shl 4;
  SSL_get_signature_nid_removed = ((((((byte(1) shl 8) or byte(0)) shl 8) or byte(0)) shl 8) or byte(0)) shl 4;
  SSL_get_peer_signature_nid_removed = ((((((byte(1) shl 8) or byte(0)) shl 8) or byte(0)) shl 8) or byte(0)) shl 4;
  SSL_get_peer_tmp_key_removed = ((((((byte(1) shl 8) or byte(0)) shl 8) or byte(0)) shl 8) or byte(0)) shl 4;
  SSL_get_tmp_key_removed = ((((((byte(1) shl 8) or byte(0)) shl 8) or byte(0)) shl 8) or byte(0)) shl 4;
  SSL_get0_raw_cipherlist_removed = ((((((byte(1) shl 8) or byte(0)) shl 8) or byte(0)) shl 8) or byte(0)) shl 4;
  SSL_get0_ec_point_formats_removed = ((((((byte(1) shl 8) or byte(0)) shl 8) or byte(0)) shl 8) or byte(0)) shl 4;
  SSL_CTX_get_options_introduced = ((((((byte(1) shl 8) or byte(1)) shl 8) or byte(0)) shl 8) or byte(0)) shl 4;
  SSL_get_options_introduced = ((((((byte(1) shl 8) or byte(1)) shl 8) or byte(0)) shl 8) or byte(0)) shl 4;
  SSL_CTX_clear_options_introduced = ((((((byte(1) shl 8) or byte(1)) shl 8) or byte(0)) shl 8) or byte(0)) shl 4;
  SSL_clear_options_introduced = ((((((byte(1) shl 8) or byte(1)) shl 8) or byte(0)) shl 8) or byte(0)) shl 4;
  SSL_CTX_set_options_introduced = ((((((byte(1) shl 8) or byte(1)) shl 8) or byte(0)) shl 8) or byte(0)) shl 4;
  SSL_set_options_introduced = ((((((byte(1) shl 8) or byte(1)) shl 8) or byte(0)) shl 8) or byte(0)) shl 4;
  SSL_CTX_set_stateless_cookie_generate_cb_introduced = ((((((byte(1) shl 8) or byte(1)) shl 8) or byte(0)) shl 8) or byte(0)) shl 4;
  SSL_CTX_set_stateless_cookie_verify_cb_introduced = ((((((byte(1) shl 8) or byte(1)) shl 8) or byte(0)) shl 8) or byte(0)) shl 4;
  SSL_set_psk_find_session_callback_introduced = ((((((byte(1) shl 8) or byte(1)) shl 8) or byte(0)) shl 8) or byte(0)) shl 4;
  SSL_CTX_set_psk_find_session_callback_introduced = ((((((byte(1) shl 8) or byte(1)) shl 8) or byte(0)) shl 8) or byte(0)) shl 4;
  SSL_set_psk_use_session_callback_introduced = ((((((byte(1) shl 8) or byte(1)) shl 8) or byte(0)) shl 8) or byte(0)) shl 4;
  SSL_CTX_set_psk_use_session_callback_introduced = ((((((byte(1) shl 8) or byte(1)) shl 8) or byte(0)) shl 8) or byte(0)) shl 4;
  SSL_CTX_set_keylog_callback_introduced = ((((((byte(1) shl 8) or byte(1)) shl 8) or byte(0)) shl 8) or byte(0)) shl 4;
  SSL_CTX_get_keylog_callback_introduced = ((((((byte(1) shl 8) or byte(1)) shl 8) or byte(0)) shl 8) or byte(0)) shl 4;
  SSL_CTX_set_max_early_data_introduced = ((((((byte(1) shl 8) or byte(1)) shl 8) or byte(0)) shl 8) or byte(0)) shl 4;
  SSL_CTX_get_max_early_data_introduced = ((((((byte(1) shl 8) or byte(1)) shl 8) or byte(0)) shl 8) or byte(0)) shl 4;
  SSL_set_max_early_data_introduced = ((((((byte(1) shl 8) or byte(1)) shl 8) or byte(0)) shl 8) or byte(0)) shl 4;
  SSL_get_max_early_data_introduced = ((((((byte(1) shl 8) or byte(1)) shl 8) or byte(0)) shl 8) or byte(0)) shl 4;
  SSL_CTX_set_recv_max_early_data_introduced = ((((((byte(1) shl 8) or byte(1)) shl 8) or byte(0)) shl 8) or byte(0)) shl 4;
  SSL_CTX_get_recv_max_early_data_introduced = ((((((byte(1) shl 8) or byte(1)) shl 8) or byte(0)) shl 8) or byte(0)) shl 4;
  SSL_set_recv_max_early_data_introduced = ((((((byte(1) shl 8) or byte(1)) shl 8) or byte(0)) shl 8) or byte(0)) shl 4;
  SSL_get_recv_max_early_data_introduced = ((((((byte(1) shl 8) or byte(1)) shl 8) or byte(0)) shl 8) or byte(0)) shl 4;
  SSL_get_app_data_removed = ((((((byte(1) shl 8) or byte(0)) shl 8) or byte(0)) shl 8) or byte(0)) shl 4;
  SSL_set_app_data_removed = ((((((byte(1) shl 8) or byte(0)) shl 8) or byte(0)) shl 8) or byte(0)) shl 4;
  SSL_in_init_introduced = ((((((byte(1) shl 8) or byte(1)) shl 8) or byte(0)) shl 8) or byte(0)) shl 4;
  SSL_in_before_introduced = ((((((byte(1) shl 8) or byte(1)) shl 8) or byte(0)) shl 8) or byte(0)) shl 4;
  SSL_is_init_finished_introduced = ((((((byte(1) shl 8) or byte(1)) shl 8) or byte(0)) shl 8) or byte(0)) shl 4;
  SSLeay_add_ssl_algorithms_removed = ((((((byte(1) shl 8) or byte(0)) shl 8) or byte(0)) shl 8) or byte(0)) shl 4;
  SSL_CTX_up_ref_introduced = ((((((byte(1) shl 8) or byte(1)) shl 8) or byte(0)) shl 8) or byte(0)) shl 4;
  SSL_CTX_set1_cert_store_introduced = ((((((byte(1) shl 8) or byte(1)) shl 8) or byte(0)) shl 8) or byte(0)) shl 4;
  SSL_get_pending_cipher_introduced = ((((((byte(1) shl 8) or byte(1)) shl 8) or byte(0)) shl 8) or byte(0)) shl 4;
  SSL_CIPHER_standard_name_introduced = ((((((byte(1) shl 8) or byte(1)) shl 8) or byte(0)) shl 8) or byte(0)) shl 4;
  OPENSSL_cipher_name_introduced = ((((((byte(1) shl 8) or byte(1)) shl 8) or byte(0)) shl 8) or byte(0)) shl 4;
  SSL_CIPHER_get_protocol_id_introduced = ((((((byte(1) shl 8) or byte(1)) shl 8) or byte(0)) shl 8) or byte(0)) shl 4;
  SSL_CIPHER_get_kx_nid_introduced = ((((((byte(1) shl 8) or byte(1)) shl 8) or byte(0)) shl 8) or byte(0)) shl 4;
  SSL_CIPHER_get_auth_nid_introduced = ((((((byte(1) shl 8) or byte(1)) shl 8) or byte(0)) shl 8) or byte(0)) shl 4;
  SSL_CIPHER_get_handshake_digest_introduced = ((((((byte(1) shl 8) or byte(1)) shl 8) or byte(0)) shl 8) or byte(0)) shl 4;
  SSL_CIPHER_is_aead_introduced = ((((((byte(1) shl 8) or byte(1)) shl 8) or byte(0)) shl 8) or byte(0)) shl 4;
  SSL_has_pending_introduced = ((((((byte(1) shl 8) or byte(1)) shl 8) or byte(0)) shl 8) or byte(0)) shl 4;
  SSL_set0_rbio_introduced = ((((((byte(1) shl 8) or byte(1)) shl 8) or byte(0)) shl 8) or byte(0)) shl 4;
  SSL_set0_wbio_introduced = ((((((byte(1) shl 8) or byte(1)) shl 8) or byte(0)) shl 8) or byte(0)) shl 4;
  SSL_CTX_set_ciphersuites_introduced = ((((((byte(1) shl 8) or byte(1)) shl 8) or byte(0)) shl 8) or byte(0)) shl 4;
  SSL_set_ciphersuites_introduced = ((((((byte(1) shl 8) or byte(1)) shl 8) or byte(0)) shl 8) or byte(0)) shl 4;
  SSL_CTX_use_serverinfo_ex_introduced = ((((((byte(1) shl 8) or byte(1)) shl 8) or byte(0)) shl 8) or byte(0)) shl 4;
  SSL_use_certificate_chain_file_introduced = ((((((byte(1) shl 8) or byte(1)) shl 8) or byte(0)) shl 8) or byte(0)) shl 4;
  SSL_load_error_strings_removed = ((((((byte(1) shl 8) or byte(1)) shl 8) or byte(0)) shl 8) or byte(0)) shl 4;
  SSL_SESSION_get_protocol_version_introduced = ((((((byte(1) shl 8) or byte(1)) shl 8) or byte(0)) shl 8) or byte(0)) shl 4;
  SSL_SESSION_set_protocol_version_introduced = ((((((byte(1) shl 8) or byte(1)) shl 8) or byte(0)) shl 8) or byte(0)) shl 4;
  SSL_SESSION_get0_hostname_introduced = ((((((byte(1) shl 8) or byte(1)) shl 8) or byte(0)) shl 8) or byte(0)) shl 4;
  SSL_SESSION_set1_hostname_introduced = ((((((byte(1) shl 8) or byte(1)) shl 8) or byte(0)) shl 8) or byte(0)) shl 4;
  SSL_SESSION_get0_alpn_selected_introduced = ((((((byte(1) shl 8) or byte(1)) shl 8) or byte(0)) shl 8) or byte(0)) shl 4;
  SSL_SESSION_set1_alpn_selected_introduced = ((((((byte(1) shl 8) or byte(1)) shl 8) or byte(0)) shl 8) or byte(0)) shl 4;
  SSL_SESSION_get0_cipher_introduced = ((((((byte(1) shl 8) or byte(1)) shl 8) or byte(0)) shl 8) or byte(0)) shl 4;
  SSL_SESSION_set_cipher_introduced = ((((((byte(1) shl 8) or byte(1)) shl 8) or byte(0)) shl 8) or byte(0)) shl 4;
  SSL_SESSION_has_ticket_introduced = ((((((byte(1) shl 8) or byte(1)) shl 8) or byte(0)) shl 8) or byte(0)) shl 4;
  SSL_SESSION_get_ticket_lifetime_hint_introduced = ((((((byte(1) shl 8) or byte(1)) shl 8) or byte(0)) shl 8) or byte(0)) shl 4;
  SSL_SESSION_get0_ticket_introduced = ((((((byte(1) shl 8) or byte(1)) shl 8) or byte(0)) shl 8) or byte(0)) shl 4;
  SSL_SESSION_get_max_early_data_introduced = ((((((byte(1) shl 8) or byte(1)) shl 8) or byte(0)) shl 8) or byte(0)) shl 4;
  SSL_SESSION_set_max_early_data_introduced = ((((((byte(1) shl 8) or byte(1)) shl 8) or byte(0)) shl 8) or byte(0)) shl 4;
  SSL_SESSION_set1_id_introduced = ((((((byte(1) shl 8) or byte(1)) shl 8) or byte(0)) shl 8) or byte(0)) shl 4;
  SSL_SESSION_is_resumable_introduced = ((((((byte(1) shl 8) or byte(1)) shl 8) or byte(0)) shl 8) or byte(0)) shl 4;
  SSL_SESSION_dup_introduced = ((((((byte(1) shl 8) or byte(1)) shl 8) or byte(0)) shl 8) or byte(0)) shl 4;
  SSL_SESSION_get0_id_context_introduced = ((((((byte(1) shl 8) or byte(1)) shl 8) or byte(0)) shl 8) or byte(0)) shl 4;
  SSL_SESSION_print_keylog_introduced = ((((((byte(1) shl 8) or byte(1)) shl 8) or byte(0)) shl 8) or byte(0)) shl 4;
  SSL_SESSION_up_ref_introduced = ((((((byte(1) shl 8) or byte(1)) shl 8) or byte(0)) shl 8) or byte(0)) shl 4;
  SSL_get_peer_certificate_removed = ((((((byte(3) shl 8) or byte(0)) shl 8) or byte(0)) shl 8) or byte(0)) shl 4;
  SSL_CTX_set_default_passwd_cb_introduced = ((((((byte(1) shl 8) or byte(1)) shl 8) or byte(0)) shl 8) or byte(0)) shl 4;
  SSL_CTX_set_default_passwd_cb_userdata_introduced = ((((((byte(1) shl 8) or byte(1)) shl 8) or byte(0)) shl 8) or byte(0)) shl 4;
  SSL_CTX_get_default_passwd_cb_introduced = ((((((byte(1) shl 8) or byte(1)) shl 8) or byte(0)) shl 8) or byte(0)) shl 4;
  SSL_CTX_get_default_passwd_cb_userdata_introduced = ((((((byte(1) shl 8) or byte(1)) shl 8) or byte(0)) shl 8) or byte(0)) shl 4;
  SSL_set_default_passwd_cb_introduced = ((((((byte(1) shl 8) or byte(1)) shl 8) or byte(0)) shl 8) or byte(0)) shl 4;
  SSL_set_default_passwd_cb_userdata_introduced = ((((((byte(1) shl 8) or byte(1)) shl 8) or byte(0)) shl 8) or byte(0)) shl 4;
  SSL_get_default_passwd_cb_introduced = ((((((byte(1) shl 8) or byte(1)) shl 8) or byte(0)) shl 8) or byte(0)) shl 4;
  SSL_get_default_passwd_cb_userdata_introduced = ((((((byte(1) shl 8) or byte(1)) shl 8) or byte(0)) shl 8) or byte(0)) shl 4;
  SSL_up_ref_introduced = ((((((byte(1) shl 8) or byte(1)) shl 8) or byte(0)) shl 8) or byte(0)) shl 4;
  SSL_is_dtls_introduced = ((((((byte(1) shl 8) or byte(1)) shl 8) or byte(0)) shl 8) or byte(0)) shl 4;
  SSL_set1_host_introduced = ((((((byte(1) shl 8) or byte(1)) shl 8) or byte(0)) shl 8) or byte(0)) shl 4;
  SSL_add1_host_introduced = ((((((byte(1) shl 8) or byte(1)) shl 8) or byte(0)) shl 8) or byte(0)) shl 4;
  SSL_get0_peername_introduced = ((((((byte(1) shl 8) or byte(1)) shl 8) or byte(0)) shl 8) or byte(0)) shl 4;
  SSL_set_hostflags_introduced = ((((((byte(1) shl 8) or byte(1)) shl 8) or byte(0)) shl 8) or byte(0)) shl 4;
  SSL_CTX_dane_enable_introduced = ((((((byte(1) shl 8) or byte(1)) shl 8) or byte(0)) shl 8) or byte(0)) shl 4;
  SSL_CTX_dane_mtype_set_introduced = ((((((byte(1) shl 8) or byte(1)) shl 8) or byte(0)) shl 8) or byte(0)) shl 4;
  SSL_dane_enable_introduced = ((((((byte(1) shl 8) or byte(1)) shl 8) or byte(0)) shl 8) or byte(0)) shl 4;
  SSL_dane_tlsa_add_introduced = ((((((byte(1) shl 8) or byte(1)) shl 8) or byte(0)) shl 8) or byte(0)) shl 4;
  SSL_get0_dane_authority_introduced = ((((((byte(1) shl 8) or byte(1)) shl 8) or byte(0)) shl 8) or byte(0)) shl 4;
  SSL_get0_dane_tlsa_introduced = ((((((byte(1) shl 8) or byte(1)) shl 8) or byte(0)) shl 8) or byte(0)) shl 4;
  SSL_get0_dane_introduced = ((((((byte(1) shl 8) or byte(1)) shl 8) or byte(0)) shl 8) or byte(0)) shl 4;
  SSL_CTX_dane_set_flags_introduced = ((((((byte(1) shl 8) or byte(1)) shl 8) or byte(0)) shl 8) or byte(0)) shl 4;
  SSL_CTX_dane_clear_flags_introduced = ((((((byte(1) shl 8) or byte(1)) shl 8) or byte(0)) shl 8) or byte(0)) shl 4;
  SSL_dane_set_flags_introduced = ((((((byte(1) shl 8) or byte(1)) shl 8) or byte(0)) shl 8) or byte(0)) shl 4;
  SSL_dane_clear_flags_introduced = ((((((byte(1) shl 8) or byte(1)) shl 8) or byte(0)) shl 8) or byte(0)) shl 4;
  SSL_CTX_set_client_hello_cb_introduced = ((((((byte(1) shl 8) or byte(1)) shl 8) or byte(0)) shl 8) or byte(0)) shl 4;
  SSL_client_hello_isv2_introduced = ((((((byte(1) shl 8) or byte(1)) shl 8) or byte(0)) shl 8) or byte(0)) shl 4;
  SSL_client_hello_get0_legacy_version_introduced = ((((((byte(1) shl 8) or byte(1)) shl 8) or byte(0)) shl 8) or byte(0)) shl 4;
  SSL_client_hello_get0_random_introduced = ((((((byte(1) shl 8) or byte(1)) shl 8) or byte(0)) shl 8) or byte(0)) shl 4;
  SSL_client_hello_get0_session_id_introduced = ((((((byte(1) shl 8) or byte(1)) shl 8) or byte(0)) shl 8) or byte(0)) shl 4;
  SSL_client_hello_get0_ciphers_introduced = ((((((byte(1) shl 8) or byte(1)) shl 8) or byte(0)) shl 8) or byte(0)) shl 4;
  SSL_client_hello_get0_compression_methods_introduced = ((((((byte(1) shl 8) or byte(1)) shl 8) or byte(0)) shl 8) or byte(0)) shl 4;
  SSL_client_hello_get1_extensions_present_introduced = ((((((byte(1) shl 8) or byte(1)) shl 8) or byte(0)) shl 8) or byte(0)) shl 4;
  SSL_client_hello_get0_ext_introduced = ((((((byte(1) shl 8) or byte(1)) shl 8) or byte(0)) shl 8) or byte(0)) shl 4;
  SSL_waiting_for_async_introduced = ((((((byte(1) shl 8) or byte(1)) shl 8) or byte(0)) shl 8) or byte(0)) shl 4;
  SSL_get_all_async_fds_introduced = ((((((byte(1) shl 8) or byte(1)) shl 8) or byte(0)) shl 8) or byte(0)) shl 4;
  SSL_get_changed_async_fds_introduced = ((((((byte(1) shl 8) or byte(1)) shl 8) or byte(0)) shl 8) or byte(0)) shl 4;
  SSL_stateless_introduced = ((((((byte(1) shl 8) or byte(1)) shl 8) or byte(0)) shl 8) or byte(0)) shl 4;
  SSL_read_ex_introduced = ((((((byte(1) shl 8) or byte(1)) shl 8) or byte(0)) shl 8) or byte(0)) shl 4;
  SSL_read_early_data_introduced = ((((((byte(1) shl 8) or byte(1)) shl 8) or byte(0)) shl 8) or byte(0)) shl 4;
  SSL_peek_ex_introduced = ((((((byte(1) shl 8) or byte(1)) shl 8) or byte(0)) shl 8) or byte(0)) shl 4;
  SSL_write_ex_introduced = ((((((byte(1) shl 8) or byte(1)) shl 8) or byte(0)) shl 8) or byte(0)) shl 4;
  SSL_write_early_data_introduced = ((((((byte(1) shl 8) or byte(1)) shl 8) or byte(0)) shl 8) or byte(0)) shl 4;
  SSL_get_early_data_status_introduced = ((((((byte(1) shl 8) or byte(1)) shl 8) or byte(0)) shl 8) or byte(0)) shl 4;
  TLS_method_introduced = ((((((byte(1) shl 8) or byte(1)) shl 8) or byte(0)) shl 8) or byte(0)) shl 4;
  TLS_server_method_introduced = ((((((byte(1) shl 8) or byte(1)) shl 8) or byte(0)) shl 8) or byte(0)) shl 4;
  TLS_client_method_introduced = ((((((byte(1) shl 8) or byte(1)) shl 8) or byte(0)) shl 8) or byte(0)) shl 4;
  SSL_key_update_introduced = ((((((byte(1) shl 8) or byte(1)) shl 8) or byte(0)) shl 8) or byte(0)) shl 4;
  SSL_get_key_update_type_introduced = ((((((byte(1) shl 8) or byte(1)) shl 8) or byte(0)) shl 8) or byte(0)) shl 4;
  SSL_CTX_set_post_handshake_auth_introduced = ((((((byte(1) shl 8) or byte(1)) shl 8) or byte(0)) shl 8) or byte(0)) shl 4;
  SSL_set_post_handshake_auth_introduced = ((((((byte(1) shl 8) or byte(1)) shl 8) or byte(0)) shl 8) or byte(0)) shl 4;
  SSL_verify_client_post_handshake_introduced = ((((((byte(1) shl 8) or byte(1)) shl 8) or byte(0)) shl 8) or byte(0)) shl 4;
  SSL_library_init_removed = ((((((byte(1) shl 8) or byte(1)) shl 8) or byte(0)) shl 8) or byte(0)) shl 4;
  SSL_client_version_introduced = ((((((byte(1) shl 8) or byte(1)) shl 8) or byte(0)) shl 8) or byte(0)) shl 4;
  SSL_CTX_set_default_verify_dir_introduced = ((((((byte(1) shl 8) or byte(1)) shl 8) or byte(0)) shl 8) or byte(0)) shl 4;
  SSL_CTX_set_default_verify_file_introduced = ((((((byte(1) shl 8) or byte(1)) shl 8) or byte(0)) shl 8) or byte(0)) shl 4;
  SSL_get_state_introduced = ((((((byte(1) shl 8) or byte(1)) shl 8) or byte(0)) shl 8) or byte(0)) shl 4;
  SSL_get_client_random_introduced = ((((((byte(1) shl 8) or byte(1)) shl 8) or byte(0)) shl 8) or byte(0)) shl 4;
  SSL_get_server_random_introduced = ((((((byte(1) shl 8) or byte(1)) shl 8) or byte(0)) shl 8) or byte(0)) shl 4;
  SSL_SESSION_get_master_key_introduced = ((((((byte(1) shl 8) or byte(1)) shl 8) or byte(0)) shl 8) or byte(0)) shl 4;
  SSL_SESSION_set1_master_key_introduced = ((((((byte(1) shl 8) or byte(1)) shl 8) or byte(0)) shl 8) or byte(0)) shl 4;
  SSL_SESSION_get_max_fragment_length_introduced = ((((((byte(1) shl 8) or byte(1)) shl 8) or byte(0)) shl 8) or byte(0)) shl 4;
  SSL_CTX_set_default_read_buffer_len_introduced = ((((((byte(1) shl 8) or byte(1)) shl 8) or byte(0)) shl 8) or byte(0)) shl 4;
  SSL_set_default_read_buffer_len_introduced = ((((((byte(1) shl 8) or byte(1)) shl 8) or byte(0)) shl 8) or byte(0)) shl 4;
  SSL_CIPHER_get_cipher_nid_introduced = ((((((byte(1) shl 8) or byte(1)) shl 8) or byte(0)) shl 8) or byte(0)) shl 4;
  SSL_CIPHER_get_digest_nid_introduced = ((((((byte(1) shl 8) or byte(1)) shl 8) or byte(0)) shl 8) or byte(0)) shl 4;
  SSL_CTX_set_not_resumable_session_callback_introduced = ((((((byte(1) shl 8) or byte(1)) shl 8) or byte(0)) shl 8) or byte(0)) shl 4;
  SSL_set_not_resumable_session_callback_introduced = ((((((byte(1) shl 8) or byte(1)) shl 8) or byte(0)) shl 8) or byte(0)) shl 4;
  SSL_CTX_set_record_padding_callback_introduced = ((((((byte(1) shl 8) or byte(1)) shl 8) or byte(0)) shl 8) or byte(0)) shl 4;
  SSL_CTX_set_record_padding_callback_arg_introduced = ((((((byte(1) shl 8) or byte(1)) shl 8) or byte(0)) shl 8) or byte(0)) shl 4;
  SSL_CTX_get_record_padding_callback_arg_introduced = ((((((byte(1) shl 8) or byte(1)) shl 8) or byte(0)) shl 8) or byte(0)) shl 4;
  SSL_CTX_set_block_padding_introduced = ((((((byte(1) shl 8) or byte(1)) shl 8) or byte(0)) shl 8) or byte(0)) shl 4;
  SSL_set_record_padding_callback_introduced = ((((((byte(1) shl 8) or byte(1)) shl 8) or byte(0)) shl 8) or byte(0)) shl 4;
  SSL_set_record_padding_callback_arg_introduced = ((((((byte(1) shl 8) or byte(1)) shl 8) or byte(0)) shl 8) or byte(0)) shl 4;
  SSL_get_record_padding_callback_arg_introduced = ((((((byte(1) shl 8) or byte(1)) shl 8) or byte(0)) shl 8) or byte(0)) shl 4;
  SSL_set_block_padding_introduced = ((((((byte(1) shl 8) or byte(1)) shl 8) or byte(0)) shl 8) or byte(0)) shl 4;
  SSL_set_num_tickets_introduced = ((((((byte(1) shl 8) or byte(1)) shl 8) or byte(0)) shl 8) or byte(0)) shl 4;
  SSL_get_num_tickets_introduced = ((((((byte(1) shl 8) or byte(1)) shl 8) or byte(0)) shl 8) or byte(0)) shl 4;
  SSL_CTX_set_num_tickets_introduced = ((((((byte(1) shl 8) or byte(1)) shl 8) or byte(0)) shl 8) or byte(0)) shl 4;
  SSL_CTX_get_num_tickets_introduced = ((((((byte(1) shl 8) or byte(1)) shl 8) or byte(0)) shl 8) or byte(0)) shl 4;
  SSL_session_reused_introduced = ((((((byte(1) shl 8) or byte(1)) shl 8) or byte(0)) shl 8) or byte(0)) shl 4;
  SSL_add_ssl_module_introduced = ((((((byte(1) shl 8) or byte(1)) shl 8) or byte(0)) shl 8) or byte(0)) shl 4;
  SSL_config_introduced = ((((((byte(1) shl 8) or byte(1)) shl 8) or byte(0)) shl 8) or byte(0)) shl 4;
  SSL_CTX_config_introduced = ((((((byte(1) shl 8) or byte(1)) shl 8) or byte(0)) shl 8) or byte(0)) shl 4;
  DTLSv1_listen_introduced = ((((((byte(1) shl 8) or byte(1)) shl 8) or byte(0)) shl 8) or byte(0)) shl 4;
  SSL_enable_ct_introduced = ((((((byte(1) shl 8) or byte(1)) shl 8) or byte(0)) shl 8) or byte(0)) shl 4;
  SSL_CTX_enable_ct_introduced = ((((((byte(1) shl 8) or byte(1)) shl 8) or byte(0)) shl 8) or byte(0)) shl 4;
  SSL_ct_is_enabled_introduced = ((((((byte(1) shl 8) or byte(1)) shl 8) or byte(0)) shl 8) or byte(0)) shl 4;
  SSL_CTX_ct_is_enabled_introduced = ((((((byte(1) shl 8) or byte(1)) shl 8) or byte(0)) shl 8) or byte(0)) shl 4;
  SSL_CTX_set_default_ctlog_list_file_introduced = ((((((byte(1) shl 8) or byte(1)) shl 8) or byte(0)) shl 8) or byte(0)) shl 4;
  SSL_CTX_set_ctlog_list_file_introduced = ((((((byte(1) shl 8) or byte(1)) shl 8) or byte(0)) shl 8) or byte(0)) shl 4;
  SSL_CTX_set0_ctlog_store_introduced = ((((((byte(1) shl 8) or byte(1)) shl 8) or byte(0)) shl 8) or byte(0)) shl 4;
  SSL_set_security_level_introduced = ((((((byte(1) shl 8) or byte(1)) shl 8) or byte(0)) shl 8) or byte(0)) shl 4;
  SSL_set_security_callback_introduced = ((((((byte(1) shl 8) or byte(1)) shl 8) or byte(0)) shl 8) or byte(0)) shl 4;
  SSL_get_security_callback_introduced = ((((((byte(1) shl 8) or byte(1)) shl 8) or byte(0)) shl 8) or byte(0)) shl 4;
  SSL_set0_security_ex_data_introduced = ((((((byte(1) shl 8) or byte(1)) shl 8) or byte(0)) shl 8) or byte(0)) shl 4;
  SSL_get0_security_ex_data_introduced = ((((((byte(1) shl 8) or byte(1)) shl 8) or byte(0)) shl 8) or byte(0)) shl 4;
  SSL_CTX_set_security_level_introduced = ((((((byte(1) shl 8) or byte(1)) shl 8) or byte(0)) shl 8) or byte(0)) shl 4;
  SSL_CTX_get_security_level_introduced = ((((((byte(1) shl 8) or byte(1)) shl 8) or byte(0)) shl 8) or byte(0)) shl 4;
  SSL_CTX_get0_security_ex_data_introduced = ((((((byte(1) shl 8) or byte(1)) shl 8) or byte(0)) shl 8) or byte(0)) shl 4;
  SSL_CTX_set0_security_ex_data_introduced = ((((((byte(1) shl 8) or byte(1)) shl 8) or byte(0)) shl 8) or byte(0)) shl 4;
  OPENSSL_init_ssl_introduced = ((((((byte(1) shl 8) or byte(1)) shl 8) or byte(0)) shl 8) or byte(0)) shl 4;
  SSL_free_buffers_introduced = ((((((byte(1) shl 8) or byte(1)) shl 8) or byte(0)) shl 8) or byte(0)) shl 4;
  SSL_alloc_buffers_introduced = ((((((byte(1) shl 8) or byte(1)) shl 8) or byte(0)) shl 8) or byte(0)) shl 4;
  SSL_CTX_set_session_ticket_cb_introduced = ((((((byte(1) shl 8) or byte(1)) shl 8) or byte(0)) shl 8) or byte(0)) shl 4;
  SSL_SESSION_set1_ticket_appdata_introduced = ((((((byte(1) shl 8) or byte(1)) shl 8) or byte(0)) shl 8) or byte(0)) shl 4;
  SSL_SESSION_get0_ticket_appdata_introduced = ((((((byte(1) shl 8) or byte(1)) shl 8) or byte(0)) shl 8) or byte(0)) shl 4;
  DTLS_set_timer_cb_introduced = ((((((byte(1) shl 8) or byte(1)) shl 8) or byte(0)) shl 8) or byte(0)) shl 4;
  SSL_CTX_set_allow_early_data_cb_introduced = ((((((byte(1) shl 8) or byte(1)) shl 8) or byte(0)) shl 8) or byte(0)) shl 4;
  SSL_set_allow_early_data_cb_introduced = ((((((byte(1) shl 8) or byte(1)) shl 8) or byte(0)) shl 8) or byte(0)) shl 4;
  SSLv2_method_removed = ((((((byte(1) shl 8) or byte(1)) shl 8) or byte(0)) shl 8) or byte(0)) shl 4;
  SSLv2_server_method_removed = ((((((byte(1) shl 8) or byte(1)) shl 8) or byte(0)) shl 8) or byte(0)) shl 4;
  SSLv2_client_method_removed = ((((((byte(1) shl 8) or byte(1)) shl 8) or byte(0)) shl 8) or byte(0)) shl 4;
  SSLv3_method_removed = ((((((byte(1) shl 8) or byte(1)) shl 8) or byte(0)) shl 8) or byte(0)) shl 4;
  SSLv3_server_method_removed = ((((((byte(1) shl 8) or byte(1)) shl 8) or byte(0)) shl 8) or byte(0)) shl 4;
  SSLv3_client_method_removed = ((((((byte(1) shl 8) or byte(1)) shl 8) or byte(0)) shl 8) or byte(0)) shl 4;
  SSLv23_method_removed = ((((((byte(1) shl 8) or byte(1)) shl 8) or byte(0)) shl 8) or byte(0)) shl 4;
  SSLv23_server_method_removed = ((((((byte(1) shl 8) or byte(1)) shl 8) or byte(0)) shl 8) or byte(0)) shl 4;
  SSLv23_client_method_removed = ((((((byte(1) shl 8) or byte(1)) shl 8) or byte(0)) shl 8) or byte(0)) shl 4;
  TLSv1_method_removed = ((((((byte(1) shl 8) or byte(1)) shl 8) or byte(0)) shl 8) or byte(0)) shl 4;
  TLSv1_server_method_removed = ((((((byte(1) shl 8) or byte(1)) shl 8) or byte(0)) shl 8) or byte(0)) shl 4;
  TLSv1_client_method_removed = ((((((byte(1) shl 8) or byte(1)) shl 8) or byte(0)) shl 8) or byte(0)) shl 4;
  TLSv1_1_method_removed = ((((((byte(1) shl 8) or byte(1)) shl 8) or byte(0)) shl 8) or byte(0)) shl 4;
  TLSv1_1_server_method_removed = ((((((byte(1) shl 8) or byte(1)) shl 8) or byte(0)) shl 8) or byte(0)) shl 4;
  TLSv1_1_client_method_removed = ((((((byte(1) shl 8) or byte(1)) shl 8) or byte(0)) shl 8) or byte(0)) shl 4;
  TLSv1_2_method_removed = ((((((byte(1) shl 8) or byte(1)) shl 8) or byte(0)) shl 8) or byte(0)) shl 4;
  TLSv1_2_server_method_removed = ((((((byte(1) shl 8) or byte(1)) shl 8) or byte(0)) shl 8) or byte(0)) shl 4;
  TLSv1_2_client_method_removed = ((((((byte(1) shl 8) or byte(1)) shl 8) or byte(0)) shl 8) or byte(0)) shl 4;
  SSL_get0_peer_certificate_introduced = ((((((byte(3) shl 8) or byte(3)) shl 8) or byte(0)) shl 8) or byte(0)) shl 4;
  SSL_get1_peer_certificate_introduced = ((((((byte(3) shl 8) or byte(3)) shl 8) or byte(0)) shl 8) or byte(0)) shl 4;
