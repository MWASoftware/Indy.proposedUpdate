...
var
  ...
  EC_GROUP_get0_order: function (const group: PEC_GROUP): PBIGNUM; cdecl = @Load_EC_GROUP_get0_order; {introduced 1.1.0 }
  EC_GROUP_order_bits: function (const group: PEC_GROUP): TOpenSSL_C_INT; cdecl = @Load_EC_GROUP_order_bits; {introduced 1.1.0 }
  ...
  EC_GROUP_get0_cofactor: function (const group: PEC_GROUP): PBIGNUM; cdecl = @Load_EC_GROUP_get0_cofactor; {introduced 1.1.0 }
  ...
  EC_GROUP_set_curve: function (group: PEC_GROUP; const p: PBIGNUM; const a: PBIGNUM; const b: PBIGNUM; ctx: PBN_CTX): TOpenSSL_C_INT; cdecl = @Load_EC_GROUP_set_curve; {introduced 1.1.0 }
  EC_GROUP_get_curve: function (const group: PEC_GROUP; p: PBIGNUM; a: PBIGNUM; b: PBIGNUM; ctx: PBN_CTX): TOpenSSL_C_INT; cdecl = @Load_EC_GROUP_get_curve; {introduced 1.1.0 }
  ...
  EC_GROUP_new_from_ecparameters: function (const params: PECPARAMETERS): PEC_GROUP; cdecl = @Load_EC_GROUP_new_from_ecparameters; {introduced 1.1.0 }
  EC_GROUP_get_ecparameters: function (const group: PEC_GROUP; params: PECPARAMETERS): PECPARAMETERS; cdecl = @Load_EC_GROUP_get_ecparameters; {introduced 1.1.0 }
  EC_GROUP_new_from_ecpkparameters: function (const params: PECPKPARAMETERS): PEC_GROUP; cdecl = @Load_EC_GROUP_new_from_ecpkparameters; {introduced 1.1.0 }
  EC_GROUP_get_ecpkparameters: function (const group: PEC_GROUP; params: PECPKPARAMETERS): PECPKPARAMETERS; cdecl = @Load_EC_GROUP_get_ecpkparameters; {introduced 1.1.0 }
  ...
  EC_POINT_set_affine_coordinates: function (const group: PEC_GROUP; p: PEC_POINT; const x: PBIGNUM; const y: PBIGNUM; ctx: PBN_CTX): TOpenSSL_C_INT; cdecl = @Load_EC_POINT_set_affine_coordinates; {introduced 1.1.0 }
  EC_POINT_get_affine_coordinates: function (const group: PEC_GROUP; const p: PEC_POINT; x: PBIGNUM; y: PBIGNUM; ctx: PBN_CTX): TOpenSSL_C_INT; cdecl = @Load_EC_POINT_get_affine_coordinates; {introduced 1.1.0 }
  ...
  EC_POINT_set_compressed_coordinates: function (const group: PEC_GROUP; p: PEC_POINT; x: PBIGNUM; y_bit: TOpenSSL_C_INT; ctx: PBN_CTX): TOpenSSL_C_INT; cdecl = @Load_EC_POINT_set_compressed_coordinates; {introduced 1.1.0 }
  ...
  EC_POINT_point2buf: function (const group: PEC_GROUP; const point: PEC_POINT; form: point_conversion_form_t; pbuf: PPByte; ctx: PBN_CTX): TOpenSSL_C_SIZET; cdecl = @Load_EC_POINT_point2buf; {introduced 1.1.0 }
  ...
  EC_KEY_get0_engine: function (const eckey: PEC_KEY): PENGINE; cdecl = @Load_EC_KEY_get0_engine; {introduced 1.1.0 }
  ...
  EC_KEY_set_ex_data: function (key: PEC_KEY; idx: TOpenSSL_C_INT; arg: Pointer): TOpenSSL_C_INT; cdecl = @Load_EC_KEY_set_ex_data; {introduced 1.1.0 }
  EC_KEY_get_ex_data: function (const key: PEC_KEY; idx: TOpenSSL_C_INT): Pointer; cdecl = @Load_EC_KEY_get_ex_data; {introduced 1.1.0 }
  ...
  EC_KEY_can_sign: function (const eckey: PEC_KEY): TOpenSSL_C_INT; cdecl = @Load_EC_KEY_can_sign; {introduced 1.1.0 }
  ...
  EC_KEY_key2buf: function (const key: PEC_KEY; form: point_conversion_form_t; pbuf: PPByte; ctx: PBN_CTX): TOpenSSL_C_SIZET; cdecl = @Load_EC_KEY_key2buf; {introduced 1.1.0 }
  EC_KEY_oct2key: function (key: PEC_KEY; const buf: PByte; len: TOpenSSL_C_SIZET; ctx: PBN_CTX): TOpenSSL_C_INT; cdecl = @Load_EC_KEY_oct2key; {introduced 1.1.0 }
  EC_KEY_oct2priv: function (key: PEC_KEY; const buf: PByte; len: TOpenSSL_C_SIZET): TOpenSSL_C_INT; cdecl = @Load_EC_KEY_oct2priv; {introduced 1.1.0 }
  EC_KEY_priv2oct: function (const key: PEC_KEY; buf: PByte; len: TOpenSSL_C_SIZET): TOpenSSL_C_SIZET; cdecl = @Load_EC_KEY_priv2oct; {introduced 1.1.0 }
  EC_KEY_priv2buf: function (const eckey: PEC_KEY; buf: PPByte): TOpenSSL_C_SIZET; cdecl = @Load_EC_KEY_priv2buf; {introduced 1.1.0 }
  ...
  EC_KEY_OpenSSL: function : PEC_KEY_METHOD; cdecl = @Load_EC_KEY_OpenSSL; {introduced 1.1.0 }
  EC_KEY_get_default_method: function : PEC_KEY_METHOD; cdecl = @Load_EC_KEY_get_default_method; {introduced 1.1.0 }
  EC_KEY_set_default_method: procedure (const meth: PEC_KEY_METHOD); cdecl = @Load_EC_KEY_set_default_method; {introduced 1.1.0 }
  EC_KEY_get_method: function (const key: PEC_KEY): PEC_KEY_METHOD; cdecl = @Load_EC_KEY_get_method; {introduced 1.1.0 }
  EC_KEY_set_method: function (key: PEC_KEY; const meth: PEC_KEY_METHOD): TOpenSSL_C_INT; cdecl = @Load_EC_KEY_set_method; {introduced 1.1.0 }
  EC_KEY_new_method: function (engine: PENGINE): PEC_KEY; cdecl = @Load_EC_KEY_new_method; {introduced 1.1.0 }
  ...
  ECDSA_SIG_get0: procedure (const sig: PECDSA_SIG; const pr: PPBIGNUM; const ps: PPBIGNUM); cdecl = @Load_ECDSA_SIG_get0; {introduced 1.1.0 }
  ECDSA_SIG_get0_r: function (const sig: PECDSA_SIG): PBIGNUM; cdecl = @Load_ECDSA_SIG_get0_r; {introduced 1.1.0 }
  ECDSA_SIG_get0_s: function (const sig: PECDSA_SIG): PBIGNUM; cdecl = @Load_ECDSA_SIG_get0_s; {introduced 1.1.0 }
  ECDSA_SIG_set0: function (sig: PECDSA_SIG; r: PBIGNUM; s: PBIGNUM): TOpenSSL_C_INT; cdecl = @Load_ECDSA_SIG_set0; {introduced 1.1.0 }
  ...
  EC_KEY_METHOD_new: function (const meth: PEC_KEY_METHOD): PEC_KEY_METHOD; cdecl = @Load_EC_KEY_METHOD_new; {introduced 1.1.0 }
  EC_KEY_METHOD_free: procedure (meth: PEC_KEY_METHOD); cdecl = @Load_EC_KEY_METHOD_free; {introduced 1.1.0 }
  EC_KEY_METHOD_set_init: procedure (meth: PEC_KEY_METHOD; init: EC_KEY_METHOD_init_init; finish: EC_KEY_METHOD_init_finish; copy: EC_KEY_METHOD_init_copy; set_group: EC_KEY_METHOD_init_set_group; set_private: EC_KEY_METHOD_init_set_private; set_public: EC_KEY_METHOD_init_set_public); cdecl = @Load_EC_KEY_METHOD_set_init; {introduced 1.1.0 }
  EC_KEY_METHOD_set_keygen: procedure (meth: PEC_KEY_METHOD; keygen: EC_KEY_METHOD_keygen_keygen); cdecl = @Load_EC_KEY_METHOD_set_keygen; {introduced 1.1.0 }
  EC_KEY_METHOD_set_compute_key: procedure (meth: PEC_KEY_METHOD; ckey: EC_KEY_METHOD_compute_key_ckey); cdecl = @Load_EC_KEY_METHOD_set_compute_key; {introduced 1.1.0 }
  EC_KEY_METHOD_set_sign: procedure (meth: PEC_KEY_METHOD; sign: EC_KEY_METHOD_sign_sign; sign_setup: EC_KEY_METHOD_sign_sign_setup; sign_sig: EC_KEY_METHOD_sign_sign_sig); cdecl = @Load_EC_KEY_METHOD_set_sign; {introduced 1.1.0 }
  EC_KEY_METHOD_set_verify: procedure (meth: PEC_KEY_METHOD; verify: EC_KEY_METHOD_verify_verify; verify_sig: EC_KEY_METHOD_verify_verify_sig); cdecl = @Load_EC_KEY_METHOD_set_verify; {introduced 1.1.0 }
  EC_KEY_METHOD_get_init: procedure (const meth: PEC_KEY_METHOD; pinit: PEC_KEY_METHOD_init_init; pfinish: PEC_KEY_METHOD_init_finish; pcopy: PEC_KEY_METHOD_init_copy; pset_group: PEC_KEY_METHOD_init_set_group; pset_private: PEC_KEY_METHOD_init_set_private; pset_public: PEC_KEY_METHOD_init_set_public); cdecl = @Load_EC_KEY_METHOD_get_init; {introduced 1.1.0 }
  EC_KEY_METHOD_get_keygen: procedure (const meth: PEC_KEY_METHOD; pkeygen: PEC_KEY_METHOD_keygen_keygen); cdecl = @Load_EC_KEY_METHOD_get_keygen; {introduced 1.1.0 }
  EC_KEY_METHOD_get_compute_key: procedure (const meth: PEC_KEY_METHOD; pck: PEC_KEY_METHOD_compute_key_ckey); cdecl = @Load_EC_KEY_METHOD_get_compute_key; {introduced 1.1.0 }
  EC_KEY_METHOD_get_sign: procedure (const meth: PEC_KEY_METHOD; psign: PEC_KEY_METHOD_sign_sign; psign_setup: PEC_KEY_METHOD_sign_sign_setup; psign_sig: PEC_KEY_METHOD_sign_sign_sig); cdecl = @Load_EC_KEY_METHOD_get_sign; {introduced 1.1.0 }
  EC_KEY_METHOD_get_verify: procedure (const meth: PEC_KEY_METHOD; pverify: PEC_KEY_METHOD_verify_verify; pverify_sig: PEC_KEY_METHOD_verify_verify_sig); cdecl = @Load_EC_KEY_METHOD_get_verify; {introduced 1.1.0 }
{$ENDIF}
const
  EC_GFp_nistp224_method_introduced = ((((((byte(1) shl 8) or byte(1)) shl 8) or byte(0)) shl 8) or byte(0)) shl 4;
  EC_GFp_nistp224_method_removed = ((((((byte(3) shl 8) or byte(0)) shl 8) or byte(0)) shl 8) or byte(0)) shl 4;
  EC_GFp_nistp256_method_introduced = ((((((byte(1) shl 8) or byte(1)) shl 8) or byte(0)) shl 8) or byte(0)) shl 4;
  EC_GFp_nistp256_method_removed = ((((((byte(3) shl 8) or byte(0)) shl 8) or byte(0)) shl 8) or byte(0)) shl 4;
  EC_GFp_nistp521_method_introduced = ((((((byte(1) shl 8) or byte(1)) shl 8) or byte(0)) shl 8) or byte(0)) shl 4;
  EC_GFp_nistp521_method_removed = ((((((byte(3) shl 8) or byte(0)) shl 8) or byte(0)) shl 8) or byte(0)) shl 4;
  EC_GROUP_get0_order_introduced = ((((((byte(1) shl 8) or byte(1)) shl 8) or byte(0)) shl 8) or byte(0)) shl 4;
  EC_GROUP_order_bits_introduced = ((((((byte(1) shl 8) or byte(1)) shl 8) or byte(0)) shl 8) or byte(0)) shl 4;
  EC_GROUP_get0_cofactor_introduced = ((((((byte(1) shl 8) or byte(1)) shl 8) or byte(0)) shl 8) or byte(0)) shl 4;
  EC_GROUP_set_curve_introduced = ((((((byte(1) shl 8) or byte(1)) shl 8) or byte(0)) shl 8) or byte(0)) shl 4;
  EC_GROUP_get_curve_introduced = ((((((byte(1) shl 8) or byte(1)) shl 8) or byte(0)) shl 8) or byte(0)) shl 4;
  EC_GROUP_new_from_ecparameters_introduced = ((((((byte(1) shl 8) or byte(1)) shl 8) or byte(0)) shl 8) or byte(0)) shl 4;
  EC_GROUP_get_ecparameters_introduced = ((((((byte(1) shl 8) or byte(1)) shl 8) or byte(0)) shl 8) or byte(0)) shl 4;
  EC_GROUP_new_from_ecpkparameters_introduced = ((((((byte(1) shl 8) or byte(1)) shl 8) or byte(0)) shl 8) or byte(0)) shl 4;
  EC_GROUP_get_ecpkparameters_introduced = ((((((byte(1) shl 8) or byte(1)) shl 8) or byte(0)) shl 8) or byte(0)) shl 4;
  EC_POINT_set_affine_coordinates_introduced = ((((((byte(1) shl 8) or byte(1)) shl 8) or byte(0)) shl 8) or byte(0)) shl 4;
  EC_POINT_get_affine_coordinates_introduced = ((((((byte(1) shl 8) or byte(1)) shl 8) or byte(0)) shl 8) or byte(0)) shl 4;
  EC_POINT_set_compressed_coordinates_introduced = ((((((byte(1) shl 8) or byte(1)) shl 8) or byte(0)) shl 8) or byte(0)) shl 4;
  EC_POINT_point2buf_introduced = ((((((byte(1) shl 8) or byte(1)) shl 8) or byte(0)) shl 8) or byte(0)) shl 4;
  EC_KEY_get0_engine_introduced = ((((((byte(1) shl 8) or byte(1)) shl 8) or byte(0)) shl 8) or byte(0)) shl 4;
  EC_KEY_set_ex_data_introduced = ((((((byte(1) shl 8) or byte(1)) shl 8) or byte(0)) shl 8) or byte(0)) shl 4;
  EC_KEY_get_ex_data_introduced = ((((((byte(1) shl 8) or byte(1)) shl 8) or byte(0)) shl 8) or byte(0)) shl 4;
  EC_KEY_can_sign_introduced = ((((((byte(1) shl 8) or byte(1)) shl 8) or byte(0)) shl 8) or byte(0)) shl 4;
  EC_KEY_key2buf_introduced = ((((((byte(1) shl 8) or byte(1)) shl 8) or byte(0)) shl 8) or byte(0)) shl 4;
  EC_KEY_oct2key_introduced = ((((((byte(1) shl 8) or byte(1)) shl 8) or byte(0)) shl 8) or byte(0)) shl 4;
  EC_KEY_oct2priv_introduced = ((((((byte(1) shl 8) or byte(1)) shl 8) or byte(0)) shl 8) or byte(0)) shl 4;
  EC_KEY_priv2oct_introduced = ((((((byte(1) shl 8) or byte(1)) shl 8) or byte(0)) shl 8) or byte(0)) shl 4;
  EC_KEY_priv2buf_introduced = ((((((byte(1) shl 8) or byte(1)) shl 8) or byte(0)) shl 8) or byte(0)) shl 4;
  EC_KEY_OpenSSL_introduced = ((((((byte(1) shl 8) or byte(1)) shl 8) or byte(0)) shl 8) or byte(0)) shl 4;
  EC_KEY_get_default_method_introduced = ((((((byte(1) shl 8) or byte(1)) shl 8) or byte(0)) shl 8) or byte(0)) shl 4;
  EC_KEY_set_default_method_introduced = ((((((byte(1) shl 8) or byte(1)) shl 8) or byte(0)) shl 8) or byte(0)) shl 4;
  EC_KEY_get_method_introduced = ((((((byte(1) shl 8) or byte(1)) shl 8) or byte(0)) shl 8) or byte(0)) shl 4;
  EC_KEY_set_method_introduced = ((((((byte(1) shl 8) or byte(1)) shl 8) or byte(0)) shl 8) or byte(0)) shl 4;
  EC_KEY_new_method_introduced = ((((((byte(1) shl 8) or byte(1)) shl 8) or byte(0)) shl 8) or byte(0)) shl 4;
  ECDSA_SIG_get0_introduced = ((((((byte(1) shl 8) or byte(1)) shl 8) or byte(0)) shl 8) or byte(0)) shl 4;
  ECDSA_SIG_get0_r_introduced = ((((((byte(1) shl 8) or byte(1)) shl 8) or byte(0)) shl 8) or byte(0)) shl 4;
  ECDSA_SIG_get0_s_introduced = ((((((byte(1) shl 8) or byte(1)) shl 8) or byte(0)) shl 8) or byte(0)) shl 4;
  ECDSA_SIG_set0_introduced = ((((((byte(1) shl 8) or byte(1)) shl 8) or byte(0)) shl 8) or byte(0)) shl 4;
  EC_KEY_METHOD_new_introduced = ((((((byte(1) shl 8) or byte(1)) shl 8) or byte(0)) shl 8) or byte(0)) shl 4;
  EC_KEY_METHOD_free_introduced = ((((((byte(1) shl 8) or byte(1)) shl 8) or byte(0)) shl 8) or byte(0)) shl 4;
  EC_KEY_METHOD_set_init_introduced = ((((((byte(1) shl 8) or byte(1)) shl 8) or byte(0)) shl 8) or byte(0)) shl 4;
  EC_KEY_METHOD_set_keygen_introduced = ((((((byte(1) shl 8) or byte(1)) shl 8) or byte(0)) shl 8) or byte(0)) shl 4;
  EC_KEY_METHOD_set_compute_key_introduced = ((((((byte(1) shl 8) or byte(1)) shl 8) or byte(0)) shl 8) or byte(0)) shl 4;
  EC_KEY_METHOD_set_sign_introduced = ((((((byte(1) shl 8) or byte(1)) shl 8) or byte(0)) shl 8) or byte(0)) shl 4;
  EC_KEY_METHOD_set_verify_introduced = ((((((byte(1) shl 8) or byte(1)) shl 8) or byte(0)) shl 8) or byte(0)) shl 4;
  EC_KEY_METHOD_get_init_introduced = ((((((byte(1) shl 8) or byte(1)) shl 8) or byte(0)) shl 8) or byte(0)) shl 4;
  EC_KEY_METHOD_get_keygen_introduced = ((((((byte(1) shl 8) or byte(1)) shl 8) or byte(0)) shl 8) or byte(0)) shl 4;
  EC_KEY_METHOD_get_compute_key_introduced = ((((((byte(1) shl 8) or byte(1)) shl 8) or byte(0)) shl 8) or byte(0)) shl 4;
  EC_KEY_METHOD_get_sign_introduced = ((((((byte(1) shl 8) or byte(1)) shl 8) or byte(0)) shl 8) or byte(0)) shl 4;
  EC_KEY_METHOD_get_verify_introduced = ((((((byte(1) shl 8) or byte(1)) shl 8) or byte(0)) shl 8) or byte(0)) shl 4;
...
var
  EC_GFp_nistp224_method: function : PEC_METHOD; cdecl = @Load_EC_GFp_nistp224_method; {introduced 1.1.0 removed 3.0.0}
  EC_GFp_nistp256_method: function : PEC_METHOD; cdecl = @Load_EC_GFp_nistp256_method; {introduced 1.1.0 removed 3.0.0}
  EC_GFp_nistp521_method: function : PEC_METHOD; cdecl = @Load_EC_GFp_nistp521_method; {introduced 1.1.0 removed 3.0.0}
