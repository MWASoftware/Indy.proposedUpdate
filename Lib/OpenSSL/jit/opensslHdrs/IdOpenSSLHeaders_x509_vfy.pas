...
function X509_STORE_CTX_get_app_data(ctx: PX509_STORE_CTX): Pointer; cdecl;
...
var
  ...
  X509_OBJECT_new: function : PX509_OBJECT; cdecl = @Load_X509_OBJECT_new; {introduced 1.1.0 }
  X509_OBJECT_free: procedure (a: PX509_OBJECT); cdecl = @Load_X509_OBJECT_free; {introduced 1.1.0 }
  X509_OBJECT_get_type: function (const a: PX509_OBJECT): X509_LOOKUP_TYPE; cdecl = @Load_X509_OBJECT_get_type; {introduced 1.1.0 }
  X509_OBJECT_get0_X509: function (const a: PX509_OBJECT): PX509; cdecl = @Load_X509_OBJECT_get0_X509; {introduced 1.1.0 }
  X509_OBJECT_set1_X509: function (a: PX509_OBJECT; obj: PX509): TOpenSSL_C_INT; cdecl = @Load_X509_OBJECT_set1_X509; {introduced 1.1.0 }
  X509_OBJECT_get0_X509_CRL: function (a: PX509_OBJECT): PX509_CRL; cdecl = @Load_X509_OBJECT_get0_X509_CRL; {introduced 1.1.0 }
  X509_OBJECT_set1_X509_CRL: function (a: PX509_OBJECT; obj: PX509_CRL): TOpenSSL_C_INT; cdecl = @Load_X509_OBJECT_set1_X509_CRL; {introduced 1.1.0 }
  ...
  X509_STORE_lock: function (ctx: PX509_STORE): TOpenSSL_C_INT; cdecl = @Load_X509_STORE_lock; {introduced 1.1.0 }
  X509_STORE_unlock: function (ctx: PX509_STORE): TOpenSSL_C_INT; cdecl = @Load_X509_STORE_unlock; {introduced 1.1.0 }
  X509_STORE_up_ref: function (v: PX509_STORE): TOpenSSL_C_INT; cdecl = @Load_X509_STORE_up_ref; {introduced 1.1.0 }
  ...
  X509_STORE_get0_param: function (ctx: PX509_STORE): PX509_VERIFY_PARAM; cdecl = @Load_X509_STORE_get0_param; {introduced 1.1.0 }
  X509_STORE_set_verify: procedure (ctx: PX509_STORE; verify: X509_STORE_CTX_verify_fn); cdecl = @Load_X509_STORE_set_verify; {introduced 1.1.0 }
  X509_STORE_CTX_set_verify: procedure (ctx: PX509_STORE_CTX; verify: X509_STORE_CTX_verify_fn); cdecl = @Load_X509_STORE_CTX_set_verify; {introduced 1.1.0 }
  X509_STORE_get_verify: function (ctx: PX509_STORE): X509_STORE_CTX_verify_fn; cdecl = @Load_X509_STORE_get_verify; {introduced 1.1.0 }
  ...
  X509_STORE_get_verify_cb: function (ctx: PX509_STORE): X509_STORE_CTX_verify_cb; cdecl = @Load_X509_STORE_get_verify_cb; {introduced 1.1.0 }
  X509_STORE_set_get_issuer: procedure (ctx: PX509_STORE; get_issuer: X509_STORE_CTX_get_issuer_fn); cdecl = @Load_X509_STORE_set_get_issuer; {introduced 1.1.0 }
  X509_STORE_get_get_issuer: function (ctx: PX509_STORE): X509_STORE_CTX_get_issuer_fn; cdecl = @Load_X509_STORE_get_get_issuer; {introduced 1.1.0 }
  X509_STORE_set_check_issued: procedure (ctx: PX509_STORE; check_issued: X509_STORE_CTX_check_issued_fn); cdecl = @Load_X509_STORE_set_check_issued; {introduced 1.1.0 }
  X509_STORE_get_check_issued: function (ctx: PX509_STORE): X509_STORE_CTX_check_issued_fn; cdecl = @Load_X509_STORE_get_check_issued; {introduced 1.1.0 }
  X509_STORE_set_check_revocation: procedure (ctx: PX509_STORE; check_revocation: X509_STORE_CTX_check_revocation_fn); cdecl = @Load_X509_STORE_set_check_revocation; {introduced 1.1.0 }
  X509_STORE_get_check_revocation: function (ctx: PX509_STORE): X509_STORE_CTX_check_revocation_fn; cdecl = @Load_X509_STORE_get_check_revocation; {introduced 1.1.0 }
  X509_STORE_set_get_crl: procedure (ctx: PX509_STORE; get_crl: X509_STORE_CTX_get_crl_fn); cdecl = @Load_X509_STORE_set_get_crl; {introduced 1.1.0 }
  X509_STORE_get_get_crl: function (ctx: PX509_STORE): X509_STORE_CTX_get_crl_fn; cdecl = @Load_X509_STORE_get_get_crl; {introduced 1.1.0 }
  X509_STORE_set_check_crl: procedure (ctx: PX509_STORE; check_crl: X509_STORE_CTX_check_crl_fn); cdecl = @Load_X509_STORE_set_check_crl; {introduced 1.1.0 }
  X509_STORE_get_check_crl: function (ctx: PX509_STORE): X509_STORE_CTX_check_crl_fn; cdecl = @Load_X509_STORE_get_check_crl; {introduced 1.1.0 }
  X509_STORE_set_cert_crl: procedure (ctx: PX509_STORE; cert_crl: X509_STORE_CTX_cert_crl_fn); cdecl = @Load_X509_STORE_set_cert_crl; {introduced 1.1.0 }
  X509_STORE_get_cert_crl: function (ctx: PX509_STORE): X509_STORE_CTX_cert_crl_fn; cdecl = @Load_X509_STORE_get_cert_crl; {introduced 1.1.0 }
  X509_STORE_set_check_policy: procedure (ctx: PX509_STORE; check_policy: X509_STORE_CTX_check_policy_fn); cdecl = @Load_X509_STORE_set_check_policy; {introduced 1.1.0 }
  X509_STORE_get_check_policy: function (ctx: PX509_STORE): X509_STORE_CTX_check_policy_fn; cdecl = @Load_X509_STORE_get_check_policy; {introduced 1.1.0 }
  X509_STORE_set_cleanup: procedure (ctx: PX509_STORE; cleanup: X509_STORE_CTX_cleanup_fn); cdecl = @Load_X509_STORE_set_cleanup; {introduced 1.1.0 }
  X509_STORE_get_cleanup: function (ctx: PX509_STORE): X509_STORE_CTX_cleanup_fn; cdecl = @Load_X509_STORE_get_cleanup; {introduced 1.1.0 }
  X509_STORE_set_ex_data: function (ctx: PX509_STORE; idx: TOpenSSL_C_INT; data: Pointer): TOpenSSL_C_INT; cdecl = @Load_X509_STORE_set_ex_data; {introduced 1.1.0 }
  X509_STORE_get_ex_data: function (ctx: PX509_STORE; idx: TOpenSSL_C_INT): Pointer; cdecl = @Load_X509_STORE_get_ex_data; {introduced 1.1.0 }
  ...
  X509_STORE_CTX_get0_cert: function (ctx: PX509_STORE_CTX): PX509; cdecl = @Load_X509_STORE_CTX_get0_cert; {introduced 1.1.0 }
  ...
  X509_STORE_CTX_get_verify_cb: function (ctx: PX509_STORE_CTX): X509_STORE_CTX_verify_cb; cdecl = @Load_X509_STORE_CTX_get_verify_cb; {introduced 1.1.0 }
  X509_STORE_CTX_get_verify: function (ctx: PX509_STORE_CTX): X509_STORE_CTX_verify_fn; cdecl = @Load_X509_STORE_CTX_get_verify; {introduced 1.1.0 }
  X509_STORE_CTX_get_get_issuer: function (ctx: PX509_STORE_CTX): X509_STORE_CTX_get_issuer_fn; cdecl = @Load_X509_STORE_CTX_get_get_issuer; {introduced 1.1.0 }
  X509_STORE_CTX_get_check_issued: function (ctx: PX509_STORE_CTX): X509_STORE_CTX_check_issued_fn; cdecl = @Load_X509_STORE_CTX_get_check_issued; {introduced 1.1.0 }
  X509_STORE_CTX_get_check_revocation: function (ctx: PX509_STORE_CTX): X509_STORE_CTX_check_revocation_fn; cdecl = @Load_X509_STORE_CTX_get_check_revocation; {introduced 1.1.0 }
  X509_STORE_CTX_get_get_crl: function (ctx: PX509_STORE_CTX): X509_STORE_CTX_get_crl_fn; cdecl = @Load_X509_STORE_CTX_get_get_crl; {introduced 1.1.0 }
  X509_STORE_CTX_get_check_crl: function (ctx: PX509_STORE_CTX): X509_STORE_CTX_check_crl_fn; cdecl = @Load_X509_STORE_CTX_get_check_crl; {introduced 1.1.0 }
  X509_STORE_CTX_get_cert_crl: function (ctx: PX509_STORE_CTX): X509_STORE_CTX_cert_crl_fn; cdecl = @Load_X509_STORE_CTX_get_cert_crl; {introduced 1.1.0 }
  X509_STORE_CTX_get_check_policy: function (ctx: PX509_STORE_CTX): X509_STORE_CTX_check_policy_fn; cdecl = @Load_X509_STORE_CTX_get_check_policy; {introduced 1.1.0 }
  X509_STORE_CTX_get_cleanup: function (ctx: PX509_STORE_CTX): X509_STORE_CTX_cleanup_fn; cdecl = @Load_X509_STORE_CTX_get_cleanup; {introduced 1.1.0 }
  ...
  X509_LOOKUP_meth_new: function (const name: PAnsiChar): PX509_LOOKUP_METHOD; cdecl = @Load_X509_LOOKUP_meth_new; {introduced 1.1.0 }
  X509_LOOKUP_meth_free: procedure (method: PX509_LOOKUP_METHOD); cdecl = @Load_X509_LOOKUP_meth_free; {introduced 1.1.0 }
  X509_LOOKUP_meth_set_ctrl: function (method: PX509_LOOKUP_METHOD; ctrl_fn: X509_LOOKUP_ctrl_fn): TOpenSSL_C_INT; cdecl = @Load_X509_LOOKUP_meth_set_ctrl; {introduced 1.1.0 }
  X509_LOOKUP_meth_get_ctrl: function (const method: PX509_LOOKUP_METHOD): X509_LOOKUP_ctrl_fn; cdecl = @Load_X509_LOOKUP_meth_get_ctrl; {introduced 1.1.0 }
  X509_LOOKUP_meth_set_get_by_subject: function (method: PX509_LOOKUP_METHOD; fn: X509_LOOKUP_get_by_subject_fn): TOpenSSL_C_INT; cdecl = @Load_X509_LOOKUP_meth_set_get_by_subject; {introduced 1.1.0 }
  X509_LOOKUP_meth_get_get_by_subject: function (const method: PX509_LOOKUP_METHOD): X509_LOOKUP_get_by_subject_fn; cdecl = @Load_X509_LOOKUP_meth_get_get_by_subject; {introduced 1.1.0 }
  X509_LOOKUP_meth_set_get_by_issuer_serial: function (method: PX509_LOOKUP_METHOD; fn: X509_LOOKUP_get_by_issuer_serial_fn): TOpenSSL_C_INT; cdecl = @Load_X509_LOOKUP_meth_set_get_by_issuer_serial; {introduced 1.1.0 }
  X509_LOOKUP_meth_get_get_by_issuer_serial: function (const method: PX509_LOOKUP_METHOD): X509_LOOKUP_get_by_issuer_serial_fn; cdecl = @Load_X509_LOOKUP_meth_get_get_by_issuer_serial; {introduced 1.1.0 }
  X509_LOOKUP_meth_set_get_by_fingerprint: function (method: PX509_LOOKUP_METHOD; fn: X509_LOOKUP_get_by_fingerprint_fn): TOpenSSL_C_INT; cdecl = @Load_X509_LOOKUP_meth_set_get_by_fingerprint; {introduced 1.1.0 }
  X509_LOOKUP_meth_get_get_by_fingerprint: function (const method: PX509_LOOKUP_METHOD): X509_LOOKUP_get_by_fingerprint_fn; cdecl = @Load_X509_LOOKUP_meth_get_get_by_fingerprint; {introduced 1.1.0 }
  X509_LOOKUP_meth_set_get_by_alias: function (method: PX509_LOOKUP_METHOD; fn: X509_LOOKUP_get_by_alias_fn): TOpenSSL_C_INT; cdecl = @Load_X509_LOOKUP_meth_set_get_by_alias; {introduced 1.1.0 }
  X509_LOOKUP_meth_get_get_by_alias: function (const method: PX509_LOOKUP_METHOD): X509_LOOKUP_get_by_alias_fn; cdecl = @Load_X509_LOOKUP_meth_get_get_by_alias; {introduced 1.1.0 }
  ...
  X509_STORE_CTX_get_by_subject: function (vs: PX509_STORE_CTX; type_: X509_LOOKUP_TYPE; name: PX509_NAME; ret: PX509_OBJECT): TOpenSSL_C_INT; cdecl = @Load_X509_STORE_CTX_get_by_subject; {introduced 1.1.0 }
  X509_STORE_CTX_get_obj_by_subject: function (vs: PX509_STORE_CTX; type_: X509_LOOKUP_TYPE; name: PX509_NAME): PX509_OBJECT; cdecl = @Load_X509_STORE_CTX_get_obj_by_subject; {introduced 1.1.0 }
  ...
  X509_LOOKUP_set_method_data: function (ctx: PX509_LOOKUP; data: Pointer): TOpenSSL_C_INT; cdecl = @Load_X509_LOOKUP_set_method_data; {introduced 1.1.0 }
  X509_LOOKUP_get_method_data: function (const ctx: PX509_LOOKUP): Pointer; cdecl = @Load_X509_LOOKUP_get_method_data; {introduced 1.1.0 }
  X509_LOOKUP_get_store: function (const ctx: PX509_LOOKUP): PX509_STORE; cdecl = @Load_X509_LOOKUP_get_store; {introduced 1.1.0 }
  ...
  X509_STORE_CTX_set_error_depth: procedure (ctx: PX509_STORE_CTX; depth: TOpenSSL_C_INT); cdecl = @Load_X509_STORE_CTX_set_error_depth; {introduced 1.1.0 }
  X509_STORE_CTX_get_current_cert: function (ctx: PX509_STORE_CTX): PX509; cdecl = @Load_X509_STORE_CTX_get_current_cert;
  X509_STORE_CTX_set_current_cert: procedure (ctx: PX509_STORE_CTX; x: PX509); cdecl = @Load_X509_STORE_CTX_set_current_cert; {introduced 1.1.0 }
  ...
  X509_STORE_CTX_get_num_untrusted: function (ctx: PX509_STORE_CTX): TOpenSSL_C_INT; cdecl = @Load_X509_STORE_CTX_get_num_untrusted; {introduced 1.1.0 }
  ...
  X509_STORE_CTX_set0_dane: procedure (ctx: PX509_STORE_CTX; dane: PSSL_DANE); cdecl = @Load_X509_STORE_CTX_set0_dane; {introduced 1.1.0 }
  ...
  X509_VERIFY_PARAM_set_auth_level: procedure (param: PX509_VERIFY_PARAM; auth_level: TOpenSSL_C_INT); cdecl = @Load_X509_VERIFY_PARAM_set_auth_level; {introduced 1.1.0 }
  ...
  X509_VERIFY_PARAM_set_inh_flags: function (param: PX509_VERIFY_PARAM; flags: TOpenSSL_C_UINT32): TOpenSSL_C_INT; cdecl = @Load_X509_VERIFY_PARAM_set_inh_flags; {introduced 1.1.0 }
  X509_VERIFY_PARAM_get_inh_flags: function (const param: PX509_VERIFY_PARAM): TOpenSSL_C_UINT32; cdecl = @Load_X509_VERIFY_PARAM_get_inh_flags; {introduced 1.1.0 }
  ...
  X509_VERIFY_PARAM_get_hostflags: function (const param: PX509_VERIFY_PARAM): TOpenSSL_C_UINT; cdecl = @Load_X509_VERIFY_PARAM_get_hostflags; {introduced 1.1.0 }
  X509_VERIFY_PARAM_get0_peername: function (v1: PX509_VERIFY_PARAM): PAnsiChar; cdecl = @Load_X509_VERIFY_PARAM_get0_peername;
  X509_VERIFY_PARAM_move_peername: procedure (v1: PX509_VERIFY_PARAM; v2: PX509_VERIFY_PARAM); cdecl = @Load_X509_VERIFY_PARAM_move_peername; {introduced 1.1.0 }
  ...
  X509_VERIFY_PARAM_get_auth_level: function (const param: PX509_VERIFY_PARAM): TOpenSSL_C_INT; cdecl = @Load_X509_VERIFY_PARAM_get_auth_level; {introduced 1.1.0 }
...
{$ENDIF}
const
  X509_STORE_CTX_get_app_data_removed = ((((((byte(1) shl 8) or byte(0)) shl 8) or byte(0)) shl 8) or byte(0)) shl 4;
  X509_OBJECT_new_introduced = ((((((byte(1) shl 8) or byte(1)) shl 8) or byte(0)) shl 8) or byte(0)) shl 4;
  X509_OBJECT_free_introduced = ((((((byte(1) shl 8) or byte(1)) shl 8) or byte(0)) shl 8) or byte(0)) shl 4;
  X509_OBJECT_get_type_introduced = ((((((byte(1) shl 8) or byte(1)) shl 8) or byte(0)) shl 8) or byte(0)) shl 4;
  X509_OBJECT_get0_X509_introduced = ((((((byte(1) shl 8) or byte(1)) shl 8) or byte(0)) shl 8) or byte(0)) shl 4;
  X509_OBJECT_set1_X509_introduced = ((((((byte(1) shl 8) or byte(1)) shl 8) or byte(0)) shl 8) or byte(0)) shl 4;
  X509_OBJECT_get0_X509_CRL_introduced = ((((((byte(1) shl 8) or byte(1)) shl 8) or byte(0)) shl 8) or byte(0)) shl 4;
  X509_OBJECT_set1_X509_CRL_introduced = ((((((byte(1) shl 8) or byte(1)) shl 8) or byte(0)) shl 8) or byte(0)) shl 4;
  X509_STORE_lock_introduced = ((((((byte(1) shl 8) or byte(1)) shl 8) or byte(0)) shl 8) or byte(0)) shl 4;
  X509_STORE_unlock_introduced = ((((((byte(1) shl 8) or byte(1)) shl 8) or byte(0)) shl 8) or byte(0)) shl 4;
  X509_STORE_up_ref_introduced = ((((((byte(1) shl 8) or byte(1)) shl 8) or byte(0)) shl 8) or byte(0)) shl 4;
  X509_STORE_get0_param_introduced = ((((((byte(1) shl 8) or byte(1)) shl 8) or byte(0)) shl 8) or byte(0)) shl 4;
  X509_STORE_set_verify_introduced = ((((((byte(1) shl 8) or byte(1)) shl 8) or byte(0)) shl 8) or byte(0)) shl 4;
  X509_STORE_CTX_set_verify_introduced = ((((((byte(1) shl 8) or byte(1)) shl 8) or byte(0)) shl 8) or byte(0)) shl 4;
  X509_STORE_get_verify_introduced = ((((((byte(1) shl 8) or byte(1)) shl 8) or byte(0)) shl 8) or byte(0)) shl 4;
  X509_STORE_get_verify_cb_introduced = ((((((byte(1) shl 8) or byte(1)) shl 8) or byte(0)) shl 8) or byte(0)) shl 4;
  X509_STORE_set_get_issuer_introduced = ((((((byte(1) shl 8) or byte(1)) shl 8) or byte(0)) shl 8) or byte(0)) shl 4;
  X509_STORE_get_get_issuer_introduced = ((((((byte(1) shl 8) or byte(1)) shl 8) or byte(0)) shl 8) or byte(0)) shl 4;
  X509_STORE_set_check_issued_introduced = ((((((byte(1) shl 8) or byte(1)) shl 8) or byte(0)) shl 8) or byte(0)) shl 4;
  X509_STORE_get_check_issued_introduced = ((((((byte(1) shl 8) or byte(1)) shl 8) or byte(0)) shl 8) or byte(0)) shl 4;
  X509_STORE_set_check_revocation_introduced = ((((((byte(1) shl 8) or byte(1)) shl 8) or byte(0)) shl 8) or byte(0)) shl 4;
  X509_STORE_get_check_revocation_introduced = ((((((byte(1) shl 8) or byte(1)) shl 8) or byte(0)) shl 8) or byte(0)) shl 4;
  X509_STORE_set_get_crl_introduced = ((((((byte(1) shl 8) or byte(1)) shl 8) or byte(0)) shl 8) or byte(0)) shl 4;
  X509_STORE_get_get_crl_introduced = ((((((byte(1) shl 8) or byte(1)) shl 8) or byte(0)) shl 8) or byte(0)) shl 4;
  X509_STORE_set_check_crl_introduced = ((((((byte(1) shl 8) or byte(1)) shl 8) or byte(0)) shl 8) or byte(0)) shl 4;
  X509_STORE_get_check_crl_introduced = ((((((byte(1) shl 8) or byte(1)) shl 8) or byte(0)) shl 8) or byte(0)) shl 4;
  X509_STORE_set_cert_crl_introduced = ((((((byte(1) shl 8) or byte(1)) shl 8) or byte(0)) shl 8) or byte(0)) shl 4;
  X509_STORE_get_cert_crl_introduced = ((((((byte(1) shl 8) or byte(1)) shl 8) or byte(0)) shl 8) or byte(0)) shl 4;
  X509_STORE_set_check_policy_introduced = ((((((byte(1) shl 8) or byte(1)) shl 8) or byte(0)) shl 8) or byte(0)) shl 4;
  X509_STORE_get_check_policy_introduced = ((((((byte(1) shl 8) or byte(1)) shl 8) or byte(0)) shl 8) or byte(0)) shl 4;
  X509_STORE_set_cleanup_introduced = ((((((byte(1) shl 8) or byte(1)) shl 8) or byte(0)) shl 8) or byte(0)) shl 4;
  X509_STORE_get_cleanup_introduced = ((((((byte(1) shl 8) or byte(1)) shl 8) or byte(0)) shl 8) or byte(0)) shl 4;
  X509_STORE_set_ex_data_introduced = ((((((byte(1) shl 8) or byte(1)) shl 8) or byte(0)) shl 8) or byte(0)) shl 4;
  X509_STORE_get_ex_data_introduced = ((((((byte(1) shl 8) or byte(1)) shl 8) or byte(0)) shl 8) or byte(0)) shl 4;
  X509_STORE_CTX_get0_cert_introduced = ((((((byte(1) shl 8) or byte(1)) shl 8) or byte(0)) shl 8) or byte(0)) shl 4;
  X509_STORE_CTX_get_verify_cb_introduced = ((((((byte(1) shl 8) or byte(1)) shl 8) or byte(0)) shl 8) or byte(0)) shl 4;
  X509_STORE_CTX_get_verify_introduced = ((((((byte(1) shl 8) or byte(1)) shl 8) or byte(0)) shl 8) or byte(0)) shl 4;
  X509_STORE_CTX_get_get_issuer_introduced = ((((((byte(1) shl 8) or byte(1)) shl 8) or byte(0)) shl 8) or byte(0)) shl 4;
  X509_STORE_CTX_get_check_issued_introduced = ((((((byte(1) shl 8) or byte(1)) shl 8) or byte(0)) shl 8) or byte(0)) shl 4;
  X509_STORE_CTX_get_check_revocation_introduced = ((((((byte(1) shl 8) or byte(1)) shl 8) or byte(0)) shl 8) or byte(0)) shl 4;
  X509_STORE_CTX_get_get_crl_introduced = ((((((byte(1) shl 8) or byte(1)) shl 8) or byte(0)) shl 8) or byte(0)) shl 4;
  X509_STORE_CTX_get_check_crl_introduced = ((((((byte(1) shl 8) or byte(1)) shl 8) or byte(0)) shl 8) or byte(0)) shl 4;
  X509_STORE_CTX_get_cert_crl_introduced = ((((((byte(1) shl 8) or byte(1)) shl 8) or byte(0)) shl 8) or byte(0)) shl 4;
  X509_STORE_CTX_get_check_policy_introduced = ((((((byte(1) shl 8) or byte(1)) shl 8) or byte(0)) shl 8) or byte(0)) shl 4;
  X509_STORE_CTX_get_cleanup_introduced = ((((((byte(1) shl 8) or byte(1)) shl 8) or byte(0)) shl 8) or byte(0)) shl 4;
  X509_LOOKUP_meth_new_introduced = ((((((byte(1) shl 8) or byte(1)) shl 8) or byte(0)) shl 8) or byte(0)) shl 4;
  X509_LOOKUP_meth_free_introduced = ((((((byte(1) shl 8) or byte(1)) shl 8) or byte(0)) shl 8) or byte(0)) shl 4;
  X509_LOOKUP_meth_set_ctrl_introduced = ((((((byte(1) shl 8) or byte(1)) shl 8) or byte(0)) shl 8) or byte(0)) shl 4;
  X509_LOOKUP_meth_get_ctrl_introduced = ((((((byte(1) shl 8) or byte(1)) shl 8) or byte(0)) shl 8) or byte(0)) shl 4;
  X509_LOOKUP_meth_set_get_by_subject_introduced = ((((((byte(1) shl 8) or byte(1)) shl 8) or byte(0)) shl 8) or byte(0)) shl 4;
  X509_LOOKUP_meth_get_get_by_subject_introduced = ((((((byte(1) shl 8) or byte(1)) shl 8) or byte(0)) shl 8) or byte(0)) shl 4;
  X509_LOOKUP_meth_set_get_by_issuer_serial_introduced = ((((((byte(1) shl 8) or byte(1)) shl 8) or byte(0)) shl 8) or byte(0)) shl 4;
  X509_LOOKUP_meth_get_get_by_issuer_serial_introduced = ((((((byte(1) shl 8) or byte(1)) shl 8) or byte(0)) shl 8) or byte(0)) shl 4;
  X509_LOOKUP_meth_set_get_by_fingerprint_introduced = ((((((byte(1) shl 8) or byte(1)) shl 8) or byte(0)) shl 8) or byte(0)) shl 4;
  X509_LOOKUP_meth_get_get_by_fingerprint_introduced = ((((((byte(1) shl 8) or byte(1)) shl 8) or byte(0)) shl 8) or byte(0)) shl 4;
  X509_LOOKUP_meth_set_get_by_alias_introduced = ((((((byte(1) shl 8) or byte(1)) shl 8) or byte(0)) shl 8) or byte(0)) shl 4;
  X509_LOOKUP_meth_get_get_by_alias_introduced = ((((((byte(1) shl 8) or byte(1)) shl 8) or byte(0)) shl 8) or byte(0)) shl 4;
  X509_STORE_CTX_get_by_subject_introduced = ((((((byte(1) shl 8) or byte(1)) shl 8) or byte(0)) shl 8) or byte(0)) shl 4;
  X509_STORE_CTX_get_obj_by_subject_introduced = ((((((byte(1) shl 8) or byte(1)) shl 8) or byte(0)) shl 8) or byte(0)) shl 4;
  X509_LOOKUP_set_method_data_introduced = ((((((byte(1) shl 8) or byte(1)) shl 8) or byte(0)) shl 8) or byte(0)) shl 4;
  X509_LOOKUP_get_method_data_introduced = ((((((byte(1) shl 8) or byte(1)) shl 8) or byte(0)) shl 8) or byte(0)) shl 4;
  X509_LOOKUP_get_store_introduced = ((((((byte(1) shl 8) or byte(1)) shl 8) or byte(0)) shl 8) or byte(0)) shl 4;
  X509_STORE_CTX_set_error_depth_introduced = ((((((byte(1) shl 8) or byte(1)) shl 8) or byte(0)) shl 8) or byte(0)) shl 4;
  X509_STORE_CTX_set_current_cert_introduced = ((((((byte(1) shl 8) or byte(1)) shl 8) or byte(0)) shl 8) or byte(0)) shl 4;
  X509_STORE_CTX_get_num_untrusted_introduced = ((((((byte(1) shl 8) or byte(1)) shl 8) or byte(0)) shl 8) or byte(0)) shl 4;
  X509_STORE_CTX_set0_dane_introduced = ((((((byte(1) shl 8) or byte(1)) shl 8) or byte(0)) shl 8) or byte(0)) shl 4;
  X509_VERIFY_PARAM_set_auth_level_introduced = ((((((byte(1) shl 8) or byte(1)) shl 8) or byte(0)) shl 8) or byte(0)) shl 4;
  X509_VERIFY_PARAM_set_inh_flags_introduced = ((((((byte(1) shl 8) or byte(1)) shl 8) or byte(0)) shl 8) or byte(0)) shl 4;
  X509_VERIFY_PARAM_get_inh_flags_introduced = ((((((byte(1) shl 8) or byte(1)) shl 8) or byte(0)) shl 8) or byte(0)) shl 4;
  X509_VERIFY_PARAM_get_hostflags_introduced = ((((((byte(1) shl 8) or byte(1)) shl 8) or byte(0)) shl 8) or byte(0)) shl 4;
  X509_VERIFY_PARAM_move_peername_introduced = ((((((byte(1) shl 8) or byte(1)) shl 8) or byte(0)) shl 8) or byte(0)) shl 4;
  X509_VERIFY_PARAM_get_auth_level_introduced = ((((((byte(1) shl 8) or byte(1)) shl 8) or byte(0)) shl 8) or byte(0)) shl 4;
