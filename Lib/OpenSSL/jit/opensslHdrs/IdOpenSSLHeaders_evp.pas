...
function EVP_PKEY_assign_RSA(pkey: PEVP_PKEY; rsa: Pointer): TOpenSSL_C_INT; cdecl;
function EVP_PKEY_assign_DSA(pkey: PEVP_PKEY; dsa: Pointer): TOpenSSL_C_INT; cdecl;
function EVP_PKEY_assign_DH(pkey: PEVP_PKEY; dh: Pointer): TOpenSSL_C_INT; cdecl;
function EVP_PKEY_assign_EC_KEY(pkey: PEVP_PKEY; eckey: Pointer): TOpenSSL_C_INT; cdecl;
function EVP_PKEY_assign_SIPHASH(pkey: PEVP_PKEY; shkey: Pointer): TOpenSSL_C_INT; cdecl;
function EVP_PKEY_assign_POLY1305(pkey: PEVP_PKEY; polykey: Pointer): TOpenSSL_C_INT; cdecl;
procedure BIO_set_md(v1: PBIO; const md: PEVP_MD); cdecl;
{$IFNDEF OPENSSL_NO_MD2}
...
{$ENDIF}
function EVP_PKEY_security_bits(const pkey: PEVP_PKEY): TOpenSSL_C_INT; cdecl;
function EVP_PKEY_size(const pkey: PEVP_PKEY): TOpenSSL_C_INT; cdecl;
...
var
  EVP_MD_meth_new: function (md_type: TOpenSSL_C_INT; pkey_type: TOpenSSL_C_INT): PEVP_MD; cdecl = Load_EVP_MD_meth_new; {introduced 1.1.0 }
  EVP_MD_meth_dup: function (const md: PEVP_MD): PEVP_MD; cdecl = Load_EVP_MD_meth_dup; {introduced 1.1.0 }
  EVP_MD_meth_free: procedure (md: PEVP_MD); cdecl = Load_EVP_MD_meth_free; {introduced 1.1.0 }
  EVP_MD_meth_set_input_blocksize: function (md: PEVP_MD; blocksize: TOpenSSL_C_INT): TOpenSSL_C_INT; cdecl = Load_EVP_MD_meth_set_input_blocksize; {introduced 1.1.0 }
  EVP_MD_meth_set_result_size: function (md: PEVP_MD; resultsize: TOpenSSL_C_INT): TOpenSSL_C_INT; cdecl = Load_EVP_MD_meth_set_result_size; {introduced 1.1.0 }
  EVP_MD_meth_set_app_datasize: function (md: PEVP_MD; datasize: TOpenSSL_C_INT): TOpenSSL_C_INT; cdecl = Load_EVP_MD_meth_set_app_datasize; {introduced 1.1.0 }
  EVP_MD_meth_set_flags: function (md: PEVP_MD; flags: TOpenSSL_C_ULONG): TOpenSSL_C_INT; cdecl = Load_EVP_MD_meth_set_flags; {introduced 1.1.0 }
  EVP_MD_meth_set_init: function (md: PEVP_MD; init: EVP_MD_meth_init): TOpenSSL_C_INT; cdecl = Load_EVP_MD_meth_set_init; {introduced 1.1.0 }
  EVP_MD_meth_set_update: function (md: PEVP_MD; update: EVP_MD_meth_update): TOpenSSL_C_INT; cdecl = Load_EVP_MD_meth_set_update; {introduced 1.1.0 }
  EVP_MD_meth_set_final: function (md: PEVP_MD; final_: EVP_MD_meth_final): TOpenSSL_C_INT; cdecl = Load_EVP_MD_meth_set_final; {introduced 1.1.0 }
  EVP_MD_meth_set_copy: function (md: PEVP_MD; copy: EVP_MD_meth_copy): TOpenSSL_C_INT; cdecl = Load_EVP_MD_meth_set_copy; {introduced 1.1.0 }
  EVP_MD_meth_set_cleanup: function (md: PEVP_MD; cleanup: EVP_MD_meth_cleanup): TOpenSSL_C_INT; cdecl = Load_EVP_MD_meth_set_cleanup; {introduced 1.1.0 }
  EVP_MD_meth_set_ctrl: function (md: PEVP_MD; ctrl: EVP_MD_meth_ctrl): TOpenSSL_C_INT; cdecl = Load_EVP_MD_meth_set_ctrl; {introduced 1.1.0 }
  EVP_MD_meth_get_input_blocksize: function (const md: PEVP_MD): TOpenSSL_C_INT; cdecl = Load_EVP_MD_meth_get_input_blocksize; {introduced 1.1.0 }
  EVP_MD_meth_get_result_size: function (const md: PEVP_MD): TOpenSSL_C_INT; cdecl = Load_EVP_MD_meth_get_result_size; {introduced 1.1.0 }
  EVP_MD_meth_get_app_datasize: function (const md: PEVP_MD): TOpenSSL_C_INT; cdecl = Load_EVP_MD_meth_get_app_datasize; {introduced 1.1.0 }
  EVP_MD_meth_get_flags: function (const md: PEVP_MD): TOpenSSL_C_ULONG; cdecl = Load_EVP_MD_meth_get_flags; {introduced 1.1.0 }
  EVP_MD_meth_get_init: function (const md: PEVP_MD): EVP_MD_meth_init; cdecl = Load_EVP_MD_meth_get_init; {introduced 1.1.0 }
  EVP_MD_meth_get_update: function (const md: PEVP_MD): EVP_MD_meth_update; cdecl = Load_EVP_MD_meth_get_update; {introduced 1.1.0 }
  EVP_MD_meth_get_final: function (const md: PEVP_MD): EVP_MD_meth_final; cdecl = Load_EVP_MD_meth_get_final; {introduced 1.1.0 }
  EVP_MD_meth_get_copy: function (const md: PEVP_MD): EVP_MD_meth_copy; cdecl = Load_EVP_MD_meth_get_copy; {introduced 1.1.0 }
  EVP_MD_meth_get_cleanup: function (const md: PEVP_MD): EVP_MD_meth_cleanup; cdecl = Load_EVP_MD_meth_get_cleanup; {introduced 1.1.0 }
  EVP_MD_meth_get_ctrl: function (const md: PEVP_MD): EVP_MD_meth_ctrl; cdecl = Load_EVP_MD_meth_get_ctrl; {introduced 1.1.0 }
  EVP_CIPHER_meth_new: function (cipher_type: TOpenSSL_C_INT; block_size: TOpenSSL_C_INT; key_len: TOpenSSL_C_INT): PEVP_CIPHER; cdecl = Load_EVP_CIPHER_meth_new; {introduced 1.1.0 }
  EVP_CIPHER_meth_dup: function (const cipher: PEVP_CIPHER): PEVP_CIPHER; cdecl = Load_EVP_CIPHER_meth_dup; {introduced 1.1.0 }
  EVP_CIPHER_meth_free: procedure (cipher: PEVP_CIPHER); cdecl = Load_EVP_CIPHER_meth_free; {introduced 1.1.0 }
  EVP_CIPHER_meth_set_iv_length: function (cipher: PEVP_CIPHER; iv_len: TOpenSSL_C_INT): TOpenSSL_C_INT; cdecl = Load_EVP_CIPHER_meth_set_iv_length; {introduced 1.1.0 }
  EVP_CIPHER_meth_set_flags: function (cipher: PEVP_CIPHER; flags: TOpenSSL_C_ULONG): TOpenSSL_C_INT; cdecl = Load_EVP_CIPHER_meth_set_flags; {introduced 1.1.0 }
  EVP_CIPHER_meth_set_impl_ctx_size: function (cipher: PEVP_CIPHER; ctx_size: TOpenSSL_C_INT): TOpenSSL_C_INT; cdecl = Load_EVP_CIPHER_meth_set_impl_ctx_size; {introduced 1.1.0 }
  EVP_CIPHER_meth_set_init: function (cipher: PEVP_CIPHER; init: EVP_CIPHER_meth_init): TOpenSSL_C_INT; cdecl = Load_EVP_CIPHER_meth_set_init; {introduced 1.1.0 }
  EVP_CIPHER_meth_set_do_cipher: function (cipher: PEVP_CIPHER; do_cipher: EVP_CIPHER_meth_do_cipher): TOpenSSL_C_INT; cdecl = Load_EVP_CIPHER_meth_set_do_cipher; {introduced 1.1.0 }
  EVP_CIPHER_meth_set_cleanup: function (cipher: PEVP_CIPHER; cleanup: EVP_CIPHER_meth_cleanup): TOpenSSL_C_INT; cdecl = Load_EVP_CIPHER_meth_set_cleanup; {introduced 1.1.0 }
  EVP_CIPHER_meth_set_set_asn1_params: function (cipher: PEVP_CIPHER; set_asn1_parameters: EVP_CIPHER_meth_set_asn1_params): TOpenSSL_C_INT; cdecl = Load_EVP_CIPHER_meth_set_set_asn1_params; {introduced 1.1.0 }
  EVP_CIPHER_meth_set_get_asn1_params: function (cipher: PEVP_CIPHER; get_asn1_parameters: EVP_CIPHER_meth_get_asn1_params): TOpenSSL_C_INT; cdecl = Load_EVP_CIPHER_meth_set_get_asn1_params; {introduced 1.1.0 }
  EVP_CIPHER_meth_set_ctrl: function (cipher: PEVP_CIPHER; ctrl: EVP_CIPHER_meth_ctrl): TOpenSSL_C_INT; cdecl = Load_EVP_CIPHER_meth_set_ctrl; {introduced 1.1.0 }
  EVP_CIPHER_meth_get_init: function (const cipher: PEVP_CIPHER): EVP_CIPHER_meth_init; cdecl = Load_EVP_CIPHER_meth_get_init; {introduced 1.1.0 }
  EVP_CIPHER_meth_get_do_cipher: function (const cipher: PEVP_CIPHER): EVP_CIPHER_meth_do_cipher; cdecl = Load_EVP_CIPHER_meth_get_do_cipher; {introduced 1.1.0 }
  EVP_CIPHER_meth_get_cleanup: function (const cipher: PEVP_CIPHER): EVP_CIPHER_meth_cleanup; cdecl = Load_EVP_CIPHER_meth_get_cleanup; {introduced 1.1.0 }
  EVP_CIPHER_meth_get_set_asn1_params: function (const cipher: PEVP_CIPHER): EVP_CIPHER_meth_set_asn1_params; cdecl = Load_EVP_CIPHER_meth_get_set_asn1_params; {introduced 1.1.0 }
  EVP_CIPHER_meth_get_get_asn1_params: function (const cipher: PEVP_CIPHER): EVP_CIPHER_meth_get_asn1_params; cdecl = Load_EVP_CIPHER_meth_get_get_asn1_params; {introduced 1.1.0 }
  EVP_CIPHER_meth_get_ctrl: function (const cipher: PEVP_CIPHER): EVP_CIPHER_meth_ctrl; cdecl = Load_EVP_CIPHER_meth_get_ctrl; {introduced 1.1.0 }
  EVP_MD_CTX_md: function (ctx: PEVP_MD_CTX): PEVP_MD; cdecl = Load_EVP_MD_CTX_md;
  EVP_MD_CTX_update_fn: function (ctx: PEVP_MD_CTX): EVP_MD_CTX_update; cdecl = Load_EVP_MD_CTX_update_fn; {introduced 1.1.0 }
  EVP_MD_CTX_set_update_fn: procedure (ctx: PEVP_MD_CTX; update: EVP_MD_CTX_update); cdecl = Load_EVP_MD_CTX_set_update_fn; {introduced 1.1.0 }
  EVP_MD_CTX_set_pkey_ctx: procedure (ctx: PEVP_MD_CTX; pctx: PEVP_PKEY_CTX); cdecl = Load_EVP_MD_CTX_set_pkey_ctx; {introduced 1.1.0 }
  EVP_CIPHER_impl_ctx_size: function (const cipher: PEVP_CIPHER): TOpenSSL_C_INT; cdecl = Load_EVP_CIPHER_impl_ctx_size; {introduced 1.1.0 }
  EVP_CIPHER_CTX_cipher: function (const ctx: PEVP_CIPHER_CTX): PEVP_CIPHER; cdecl = Load_EVP_CIPHER_CTX_cipher;
  EVP_CIPHER_CTX_iv: function (const ctx: PEVP_CIPHER_CTX): PByte; cdecl = Load_EVP_CIPHER_CTX_iv; {introduced 1.1.0 }
  EVP_CIPHER_CTX_original_iv: function (const ctx: PEVP_CIPHER_CTX): PByte; cdecl = Load_EVP_CIPHER_CTX_original_iv; {introduced 1.1.0 }
  EVP_CIPHER_CTX_iv_noconst: function (ctx: PEVP_CIPHER_CTX): PByte; cdecl = Load_EVP_CIPHER_CTX_iv_noconst; {introduced 1.1.0 }
  EVP_CIPHER_CTX_buf_noconst: function (ctx: PEVP_CIPHER_CTX): PByte; cdecl = Load_EVP_CIPHER_CTX_buf_noconst; {introduced 1.1.0 }
  EVP_CIPHER_CTX_set_num: procedure (ctx: PEVP_CIPHER_CTX; num: TOpenSSL_C_INT); cdecl = Load_EVP_CIPHER_CTX_set_num; {introduced 1.1.0 }
  ...
  EVP_CIPHER_CTX_get_cipher_data: function (const ctx: PEVP_CIPHER_CTX): Pointer; cdecl = Load_EVP_CIPHER_CTX_get_cipher_data; {introduced 1.1.0 }
  EVP_CIPHER_CTX_set_cipher_data: function (ctx: PEVP_CIPHER_CTX; cipher_data: Pointer): Pointer; cdecl = Load_EVP_CIPHER_CTX_set_cipher_data; {introduced 1.1.0 }
  EVP_MD_CTX_ctrl: function (ctx: PEVP_MD_CTX; cmd: TOpenSSL_C_INT; p1: TOpenSSL_C_INT; p2: Pointer): TOpenSSL_C_INT; cdecl = Load_EVP_MD_CTX_ctrl; {introduced 1.1.0 }
  EVP_MD_CTX_new: function : PEVP_MD_CTX; cdecl = Load_EVP_MD_CTX_new; {introduced 1.1.0 }
  EVP_MD_CTX_reset: function (ctx: PEVP_MD_CTX): TOpenSSL_C_INT; cdecl = Load_EVP_MD_CTX_reset; {introduced 1.1.0 }
  EVP_MD_CTX_free: procedure (ctx: PEVP_MD_CTX); cdecl = Load_EVP_MD_CTX_free; {introduced 1.1.0 }
  ...
  EVP_DigestFinalXOF: function (ctx: PEVP_MD_CTX; md: PByte; len: TOpenSSL_C_SIZET): TOpenSSL_C_INT; cdecl = Load_EVP_DigestFinalXOF; {introduced 1.1.0 }
  ...
  EVP_DigestSign: function (ctx: PEVP_CIPHER_CTX; sigret: PByte; siglen: POpenSSL_C_SIZET; const tbs: PByte; tbslen: TOpenSSL_C_SIZET): TOpenSSL_C_INT; cdecl = Load_EVP_DigestSign; {introduced 1.1.0 }
  ...
  EVP_DigestVerify: function (ctx: PEVP_CIPHER_CTX; const sigret: PByte; siglen: TOpenSSL_C_SIZET; const tbs: PByte; tbslen: TOpenSSL_C_SIZET): TOpenSSL_C_INT; cdecl = Load_EVP_DigestVerify; {introduced 1.1.0 }
  ...
  EVP_ENCODE_CTX_new: function : PEVP_ENCODE_CTX; cdecl = Load_EVP_ENCODE_CTX_new; {introduced 1.1.0 }
  EVP_ENCODE_CTX_free: procedure (ctx: PEVP_ENCODE_CTX); cdecl = Load_EVP_ENCODE_CTX_free; {introduced 1.1.0 }
  EVP_ENCODE_CTX_copy: function (dctx: PEVP_ENCODE_CTX; sctx: PEVP_ENCODE_CTX): TOpenSSL_C_INT; cdecl = Load_EVP_ENCODE_CTX_copy; {introduced 1.1.0 }
  EVP_ENCODE_CTX_num: function (ctx: PEVP_ENCODE_CTX): TOpenSSL_C_INT; cdecl = Load_EVP_ENCODE_CTX_num; {introduced 1.1.0 }
  ...
  EVP_CIPHER_CTX_reset: function (c: PEVP_CIPHER_CTX): TOpenSSL_C_INT; cdecl = Load_EVP_CIPHER_CTX_reset; {introduced 1.1.0 }
...
{$ENDIF}
  ...
  EVP_md5_sha1: function : PEVP_MD; cdecl = Load_EVP_md5_sha1; {introduced 1.1.0 }
  ...
  EVP_sha512_224: function : PEVP_MD; cdecl = Load_EVP_sha512_224; {introduced 1.1.0 }
  EVP_sha512_256: function : PEVP_MD; cdecl = Load_EVP_sha512_256; {introduced 1.1.0 }
  EVP_sha3_224: function : PEVP_MD; cdecl = Load_EVP_sha3_224; {introduced 1.1.0 }
  EVP_sha3_256: function : PEVP_MD; cdecl = Load_EVP_sha3_256; {introduced 1.1.0 }
  EVP_sha3_384: function : PEVP_MD; cdecl = Load_EVP_sha3_384; {introduced 1.1.0 }
  EVP_sha3_512: function : PEVP_MD; cdecl = Load_EVP_sha3_512; {introduced 1.1.0 }
  EVP_shake128: function : PEVP_MD; cdecl = Load_EVP_shake128; {introduced 1.1.0 }
  EVP_shake256: function : PEVP_MD; cdecl = Load_EVP_shake256; {introduced 1.1.0 }
  ...
  EVP_aes_128_wrap_pad: function : PEVP_CIPHER; cdecl = Load_EVP_aes_128_wrap_pad; {introduced 1.1.0 }
  EVP_aes_128_ocb: function : PEVP_CIPHER; cdecl = Load_EVP_aes_128_ocb; {introduced 1.1.0 }
  ...
  EVP_aes_192_wrap_pad: function : PEVP_CIPHER; cdecl = Load_EVP_aes_192_wrap_pad; {introduced 1.1.0 }
  EVP_aes_192_ocb: function : PEVP_CIPHER; cdecl = Load_EVP_aes_192_ocb; {introduced 1.1.0 }
  ...
  EVP_aes_256_wrap_pad: function : PEVP_CIPHER; cdecl = Load_EVP_aes_256_wrap_pad; {introduced 1.1.0 }
  EVP_aes_256_ocb: function : PEVP_CIPHER; cdecl = Load_EVP_aes_256_ocb; {introduced 1.1.0 }
  ...
  EVP_aria_128_ecb: function : PEVP_CIPHER; cdecl = Load_EVP_aria_128_ecb; {introduced 1.1.0 }
  EVP_aria_128_cbc: function : PEVP_CIPHER; cdecl = Load_EVP_aria_128_cbc; {introduced 1.1.0 }
  EVP_aria_128_cfb1: function : PEVP_CIPHER; cdecl = Load_EVP_aria_128_cfb1; {introduced 1.1.0 }
  EVP_aria_128_cfb8: function : PEVP_CIPHER; cdecl = Load_EVP_aria_128_cfb8; {introduced 1.1.0 }
  EVP_aria_128_cfb128: function : PEVP_CIPHER; cdecl = Load_EVP_aria_128_cfb128; {introduced 1.1.0 }
  EVP_aria_128_ctr: function : PEVP_CIPHER; cdecl = Load_EVP_aria_128_ctr; {introduced 1.1.0 }
  EVP_aria_128_ofb: function : PEVP_CIPHER; cdecl = Load_EVP_aria_128_ofb; {introduced 1.1.0 }
  EVP_aria_128_gcm: function : PEVP_CIPHER; cdecl = Load_EVP_aria_128_gcm; {introduced 1.1.0 }
  EVP_aria_128_ccm: function : PEVP_CIPHER; cdecl = Load_EVP_aria_128_ccm; {introduced 1.1.0 }
  EVP_aria_192_ecb: function : PEVP_CIPHER; cdecl = Load_EVP_aria_192_ecb; {introduced 1.1.0 }
  EVP_aria_192_cbc: function : PEVP_CIPHER; cdecl = Load_EVP_aria_192_cbc; {introduced 1.1.0 }
  EVP_aria_192_cfb1: function : PEVP_CIPHER; cdecl = Load_EVP_aria_192_cfb1; {introduced 1.1.0 }
  EVP_aria_192_cfb8: function : PEVP_CIPHER; cdecl = Load_EVP_aria_192_cfb8; {introduced 1.1.0 }
  EVP_aria_192_cfb128: function : PEVP_CIPHER; cdecl = Load_EVP_aria_192_cfb128; {introduced 1.1.0 }
  EVP_aria_192_ctr: function : PEVP_CIPHER; cdecl = Load_EVP_aria_192_ctr; {introduced 1.1.0 }
  EVP_aria_192_ofb: function : PEVP_CIPHER; cdecl = Load_EVP_aria_192_ofb; {introduced 1.1.0 }
  EVP_aria_192_gcm: function : PEVP_CIPHER; cdecl = Load_EVP_aria_192_gcm; {introduced 1.1.0 }
  EVP_aria_192_ccm: function : PEVP_CIPHER; cdecl = Load_EVP_aria_192_ccm; {introduced 1.1.0 }
  EVP_aria_256_ecb: function : PEVP_CIPHER; cdecl = Load_EVP_aria_256_ecb; {introduced 1.1.0 }
  EVP_aria_256_cbc: function : PEVP_CIPHER; cdecl = Load_EVP_aria_256_cbc; {introduced 1.1.0 }
  EVP_aria_256_cfb1: function : PEVP_CIPHER; cdecl = Load_EVP_aria_256_cfb1; {introduced 1.1.0 }
  EVP_aria_256_cfb8: function : PEVP_CIPHER; cdecl = Load_EVP_aria_256_cfb8; {introduced 1.1.0 }
  EVP_aria_256_cfb128: function : PEVP_CIPHER; cdecl = Load_EVP_aria_256_cfb128; {introduced 1.1.0 }
  EVP_aria_256_ctr: function : PEVP_CIPHER; cdecl = Load_EVP_aria_256_ctr; {introduced 1.1.0 }
  EVP_aria_256_ofb: function : PEVP_CIPHER; cdecl = Load_EVP_aria_256_ofb; {introduced 1.1.0 }
  EVP_aria_256_gcm: function : PEVP_CIPHER; cdecl = Load_EVP_aria_256_gcm; {introduced 1.1.0 }
  EVP_aria_256_ccm: function : PEVP_CIPHER; cdecl = Load_EVP_aria_256_ccm; {introduced 1.1.0 }
  ...
  EVP_camellia_128_ctr: function : PEVP_CIPHER; cdecl = Load_EVP_camellia_128_ctr; {introduced 1.1.0 }
  ...
  EVP_camellia_192_ctr: function : PEVP_CIPHER; cdecl = Load_EVP_camellia_192_ctr; {introduced 1.1.0 }
  ...
  EVP_camellia_256_ctr: function : PEVP_CIPHER; cdecl = Load_EVP_camellia_256_ctr; {introduced 1.1.0 }
  EVP_chacha20: function : PEVP_CIPHER; cdecl = Load_EVP_chacha20; {introduced 1.1.0 }
  EVP_chacha20_poly1305: function : PEVP_CIPHER; cdecl = Load_EVP_chacha20_poly1305; {introduced 1.1.0 }
  ...
  EVP_sm4_ecb: function : PEVP_CIPHER; cdecl = Load_EVP_sm4_ecb; {introduced 1.1.0 }
  EVP_sm4_cbc: function : PEVP_CIPHER; cdecl = Load_EVP_sm4_cbc; {introduced 1.1.0 }
  EVP_sm4_cfb128: function : PEVP_CIPHER; cdecl = Load_EVP_sm4_cfb128; {introduced 1.1.0 }
  EVP_sm4_ofb: function : PEVP_CIPHER; cdecl = Load_EVP_sm4_ofb; {introduced 1.1.0 }
  EVP_sm4_ctr: function : PEVP_CIPHER; cdecl = Load_EVP_sm4_ctr; {introduced 1.1.0 }
  ...
  EVP_PKEY_get_base_id: function (const pkey: PEVP_PKEY): TOpenSSL_C_INT; cdecl = Load_EVP_PKEY_get_base_id; {introduced 3.0.0 }
  EVP_PKEY_get_security_bits: function (const pkey: PEVP_PKEY): TOpenSSL_C_INT; cdecl = Load_EVP_PKEY_get_security_bits; {introduced 3.0.0 }
  EVP_PKEY_get_size: function (const pkey: PEVP_PKEY): TOpenSSL_C_INT; cdecl = Load_EVP_PKEY_get_size; {introduced 3.0.0 }
  ...
  EVP_PKEY_set1_engine: function (pkey: PEVP_PKEY; e: PENGINE): TOpenSSL_C_INT; cdecl = Load_EVP_PKEY_set1_engine; {introduced 1.1.0 }
  EVP_PKEY_get0_engine: function (const pkey: PEVP_PKEY): PENGINE; cdecl = Load_EVP_PKEY_get0_engine; {introduced 1.1.0 }
  ...
  EVP_PKEY_get0_hmac: function (const pkey: PEVP_PKEY; len: POpenSSL_C_SIZET): PByte; cdecl = Load_EVP_PKEY_get0_hmac; {introduced 1.1.0 }
  EVP_PKEY_get0_poly1305: function (const pkey: PEVP_PKEY; len: POpenSSL_C_SIZET): PByte; cdecl = Load_EVP_PKEY_get0_poly1305; {introduced 1.1.0 }
  EVP_PKEY_get0_siphash: function (const pkey: PEVP_PKEY; len: POpenSSL_C_SIZET): PByte; cdecl = Load_EVP_PKEY_get0_siphash; {introduced 1.1.0 }
  EVP_PKEY_set1_RSA: function (pkey: PEVP_PKEY; key: PRSA): TOpenSSL_C_INT; cdecl = Load_EVP_PKEY_set1_RSA;
  EVP_PKEY_get0_RSA: function (pkey: PEVP_PKEY): PRSA; cdecl = Load_EVP_PKEY_get0_RSA; {introduced 1.1.0 }
  ...
  EVP_PKEY_get0_DSA: function (pkey: PEVP_PKEY): PDSA; cdecl = Load_EVP_PKEY_get0_DSA; {introduced 1.1.0 }
  ...
  EVP_PKEY_get0_DH: function (pkey: PEVP_PKEY): PDH; cdecl = Load_EVP_PKEY_get0_DH; {introduced 1.1.0 }
  ...
  EVP_PKEY_get0_EC_KEY: function (pkey: PEVP_PKEY): PEC_KEY; cdecl = Load_EVP_PKEY_get0_EC_KEY; {introduced 1.1.0 }
  ...
  EVP_PKEY_up_ref: function (pkey: PEVP_PKEY): TOpenSSL_C_INT; cdecl = Load_EVP_PKEY_up_ref; {introduced 1.1.0 }
  ...
  EVP_PBE_scrypt: function (const pass: PAnsiChar; passlen: TOpenSSL_C_SIZET; const salt: PByte; saltlen: TOpenSSL_C_SIZET; N: TOpenSSL_C_UINT64; r: TOpenSSL_C_UINT64; p: TOpenSSL_C_UINT64; maxmem: TOpenSSL_C_UINT64; key: PByte; keylen: TOpenSSL_C_SIZET): TOpenSSL_C_INT; cdecl = Load_EVP_PBE_scrypt; {introduced 1.1.0 }
  PKCS5_v2_scrypt_keyivgen: function (ctx: PEVP_CIPHER_CTX; const pass: PAnsiChar; passlen: TOpenSSL_C_INT; param: PASN1_TYPE; const c: PEVP_CIPHER; const md: PEVP_MD; en_de: TOpenSSL_C_INT): TOpenSSL_C_INT; cdecl = Load_PKCS5_v2_scrypt_keyivgen; {introduced 1.1.0 }
  ...
  EVP_PBE_get: function (ptype: POpenSSL_C_INT; ppbe_nid: POpenSSL_C_INT; num: TOpenSSL_C_SIZET): TOpenSSL_C_INT; cdecl = Load_EVP_PBE_get; {introduced 1.1.0 }
  ...
  EVP_PKEY_asn1_set_siginf: procedure (ameth: PEVP_PKEY_ASN1_METHOD; ASiginf_set: siginf_set); cdecl = Load_EVP_PKEY_asn1_set_siginf; {introduced 1.1.0 }
  EVP_PKEY_asn1_set_check: procedure (ameth: PEVP_PKEY_ASN1_METHOD; APkey_check: pkey_check); cdecl = Load_EVP_PKEY_asn1_set_check; {introduced 1.1.0 }
  EVP_PKEY_asn1_set_public_check: procedure (ameth: PEVP_PKEY_ASN1_METHOD; APkey_pub_check: pkey_pub_check); cdecl = Load_EVP_PKEY_asn1_set_public_check; {introduced 1.1.0 }
  EVP_PKEY_asn1_set_param_check: procedure (ameth: PEVP_PKEY_ASN1_METHOD; APkey_param_check: pkey_param_check); cdecl = Load_EVP_PKEY_asn1_set_param_check; {introduced 1.1.0 }
  EVP_PKEY_asn1_set_set_priv_key: procedure (ameth: PEVP_PKEY_ASN1_METHOD; ASet_priv_key: set_priv_key); cdecl = Load_EVP_PKEY_asn1_set_set_priv_key; {introduced 1.1.0 }
  EVP_PKEY_asn1_set_set_pub_key: procedure (ameth: PEVP_PKEY_ASN1_METHOD; ASet_pub_key: set_pub_key); cdecl = Load_EVP_PKEY_asn1_set_set_pub_key; {introduced 1.1.0 }
  EVP_PKEY_asn1_set_get_priv_key: procedure (ameth: PEVP_PKEY_ASN1_METHOD; AGet_priv_key: get_priv_key); cdecl = Load_EVP_PKEY_asn1_set_get_priv_key; {introduced 1.1.0 }
  EVP_PKEY_asn1_set_get_pub_key: procedure (ameth: PEVP_PKEY_ASN1_METHOD; AGet_pub_key: get_pub_key); cdecl = Load_EVP_PKEY_asn1_set_get_pub_key; {introduced 1.1.0 }
  EVP_PKEY_asn1_set_security_bits: procedure (ameth: PEVP_PKEY_ASN1_METHOD; APkey_security_bits: pkey_security_bits); cdecl = Load_EVP_PKEY_asn1_set_security_bits; {introduced 1.1.0 }
  ...
  EVP_PKEY_meth_remove: function (const pmeth: PEVP_PKEY_METHOD): TOpenSSL_C_INT; cdecl = Load_EVP_PKEY_meth_remove; {introduced 1.1.0 }
  EVP_PKEY_meth_get_count: function : TOpenSSL_C_SIZET; cdecl = Load_EVP_PKEY_meth_get_count; {introduced 1.1.0 }
  EVP_PKEY_meth_get0: function (idx: TOpenSSL_C_SIZET): PEVP_PKEY_METHOD; cdecl = Load_EVP_PKEY_meth_get0; {introduced 1.1.0 }
  ...
  EVP_PKEY_CTX_ctrl_uint64: function (ctx: PEVP_PKEY_CTX; keytype: TOpenSSL_C_INT; optype: TOpenSSL_C_INT; cmd: TOpenSSL_C_INT; value: TOpenSSL_C_UINT64): TOpenSSL_C_INT; cdecl = Load_EVP_PKEY_CTX_ctrl_uint64; {introduced 1.1.0 }
  EVP_PKEY_CTX_str2ctrl: function (ctx: PEVP_PKEY_CTX; cmd: TOpenSSL_C_INT; const str: PAnsiChar): TOpenSSL_C_INT; cdecl = Load_EVP_PKEY_CTX_str2ctrl; {introduced 1.1.0 }
  EVP_PKEY_CTX_hex2ctrl: function (ctx: PEVP_PKEY_CTX; cmd: TOpenSSL_C_INT; const hex: PAnsiChar): TOpenSSL_C_INT; cdecl = Load_EVP_PKEY_CTX_hex2ctrl; {introduced 1.1.0 }
  EVP_PKEY_CTX_md: function (ctx: PEVP_PKEY_CTX; optype: TOpenSSL_C_INT; cmd: TOpenSSL_C_INT; const md: PAnsiChar): TOpenSSL_C_INT; cdecl = Load_EVP_PKEY_CTX_md; {introduced 1.1.0 }
  ...
  EVP_PKEY_new_raw_private_key: function (type_: TOpenSSL_C_INT; e: PENGINE; const priv: PByte; len: TOpenSSL_C_SIZET): PEVP_PKEY; cdecl = Load_EVP_PKEY_new_raw_private_key; {introduced 1.1.0 }
  EVP_PKEY_new_raw_public_key: function (type_: TOpenSSL_C_INT; e: PENGINE; const pub: PByte; len: TOpenSSL_C_SIZET): PEVP_PKEY; cdecl = Load_EVP_PKEY_new_raw_public_key; {introduced 1.1.0 }
  EVP_PKEY_get_raw_private_key: function (const pkey: PEVP_PKEY; priv: PByte; len: POpenSSL_C_SIZET): TOpenSSL_C_INT; cdecl = Load_EVP_PKEY_get_raw_private_key; {introduced 1.1.0 }
  EVP_PKEY_get_raw_public_key: function (const pkey: PEVP_PKEY; pub: PByte; len: POpenSSL_C_SIZET): TOpenSSL_C_INT; cdecl = Load_EVP_PKEY_get_raw_public_key; {introduced 1.1.0 }
  EVP_PKEY_new_CMAC_key: function (e: PENGINE; const priv: PByte; len: TOpenSSL_C_SIZET; const cipher: PEVP_CIPHER): PEVP_PKEY; cdecl = Load_EVP_PKEY_new_CMAC_key; {introduced 1.1.0 }
  ...
  EVP_PKEY_check: function (ctx: PEVP_PKEY_CTX): TOpenSSL_C_INT; cdecl = Load_EVP_PKEY_check; {introduced 1.1.0 }
  EVP_PKEY_public_check: function (ctx: PEVP_PKEY_CTX): TOpenSSL_C_INT; cdecl = Load_EVP_PKEY_public_check; {introduced 1.1.0 }
  EVP_PKEY_param_check: function (ctx: PEVP_PKEY_CTX): TOpenSSL_C_INT; cdecl = Load_EVP_PKEY_param_check; {introduced 1.1.0 }
  ...
  EVP_PKEY_meth_set_digestsign: procedure (pmeth: PEVP_PKEY_METHOD; AEVP_PKEY_meth_digestsign: EVP_PKEY_meth_digestsign); cdecl = Load_EVP_PKEY_meth_set_digestsign; {introduced 1.1.0 }
  EVP_PKEY_meth_set_digestverify: procedure (pmeth: PEVP_PKEY_METHOD; AEVP_PKEY_meth_digestverify: EVP_PKEY_meth_digestverify); cdecl = Load_EVP_PKEY_meth_set_digestverify; {introduced 1.1.0 }
  EVP_PKEY_meth_set_check: procedure (pmeth: PEVP_PKEY_METHOD; AEVP_PKEY_meth_check: EVP_PKEY_meth_check); cdecl = Load_EVP_PKEY_meth_set_check; {introduced 1.1.0 }
  EVP_PKEY_meth_set_public_check: procedure (pmeth: PEVP_PKEY_METHOD; AEVP_PKEY_meth_public_check: EVP_PKEY_meth_public_check); cdecl = Load_EVP_PKEY_meth_set_public_check; {introduced 1.1.0 }
  EVP_PKEY_meth_set_param_check: procedure (pmeth: PEVP_PKEY_METHOD; AEVP_PKEY_meth_param_check: EVP_PKEY_meth_param_check); cdecl = Load_EVP_PKEY_meth_set_param_check; {introduced 1.1.0 }
  EVP_PKEY_meth_set_digest_custom: procedure (pmeth: PEVP_PKEY_METHOD; AEVP_PKEY_meth_digest_custom: EVP_PKEY_meth_digest_custom); cdecl = Load_EVP_PKEY_meth_set_digest_custom; {introduced 1.1.0 }
  ...
  EVP_PKEY_meth_get_digestsign: procedure (pmeth: PEVP_PKEY_METHOD; AEVP_PKEY_meth_digestsign: PEVP_PKEY_meth_digestsign); cdecl = Load_EVP_PKEY_meth_get_digestsign; {introduced 1.1.0 }
  EVP_PKEY_meth_get_digestverify: procedure (pmeth: PEVP_PKEY_METHOD; AEVP_PKEY_meth_digestverify: PEVP_PKEY_meth_digestverify); cdecl = Load_EVP_PKEY_meth_get_digestverify; {introduced 1.1.0 }
  EVP_PKEY_meth_get_check: procedure (pmeth: PEVP_PKEY_METHOD; AEVP_PKEY_meth_check: PEVP_PKEY_meth_check); cdecl = Load_EVP_PKEY_meth_get_check; {introduced 1.1.0 }
  EVP_PKEY_meth_get_public_check: procedure (pmeth: PEVP_PKEY_METHOD; AEVP_PKEY_meth_public_check: PEVP_PKEY_meth_public_check); cdecl = Load_EVP_PKEY_meth_get_public_check; {introduced 1.1.0 }
  EVP_PKEY_meth_get_param_check: procedure (pmeth: PEVP_PKEY_METHOD; AEVP_PKEY_meth_param_check: PEVP_PKEY_meth_param_check); cdecl = Load_EVP_PKEY_meth_get_param_check; {introduced 1.1.0 }
  EVP_PKEY_meth_get_digest_custom: procedure (pmeth: PEVP_PKEY_METHOD; AEVP_PKEY_meth_digest_custom: PEVP_PKEY_meth_digest_custom); cdecl = Load_EVP_PKEY_meth_get_digest_custom; {introduced 1.1.0 }
...
{$ENDIF}
  EVP_PKEY_security_bits: function (const pkey: PEVP_PKEY): TOpenSSL_C_INT; cdecl = Load_EVP_PKEY_security_bits; {introduced 1.1.0 removed 3.0.0}
...
{$ENDIF}
const
  EVP_PKEY_assign_RSA_removed = ((((((byte(1) shl 8) or byte(0)) shl 8) or byte(0)) shl 8) or byte(0)) shl 4;
  EVP_PKEY_assign_DSA_removed = ((((((byte(1) shl 8) or byte(0)) shl 8) or byte(0)) shl 8) or byte(0)) shl 4;
  EVP_PKEY_assign_DH_removed = ((((((byte(1) shl 8) or byte(0)) shl 8) or byte(0)) shl 8) or byte(0)) shl 4;
  EVP_PKEY_assign_EC_KEY_removed = ((((((byte(1) shl 8) or byte(0)) shl 8) or byte(0)) shl 8) or byte(0)) shl 4;
  EVP_PKEY_assign_SIPHASH_removed = ((((((byte(1) shl 8) or byte(0)) shl 8) or byte(0)) shl 8) or byte(0)) shl 4;
  EVP_PKEY_assign_POLY1305_removed = ((((((byte(1) shl 8) or byte(0)) shl 8) or byte(0)) shl 8) or byte(0)) shl 4;
  EVP_MD_meth_new_introduced = ((((((byte(1) shl 8) or byte(1)) shl 8) or byte(0)) shl 8) or byte(0)) shl 4;
  EVP_MD_meth_dup_introduced = ((((((byte(1) shl 8) or byte(1)) shl 8) or byte(0)) shl 8) or byte(0)) shl 4;
  EVP_MD_meth_free_introduced = ((((((byte(1) shl 8) or byte(1)) shl 8) or byte(0)) shl 8) or byte(0)) shl 4;
  EVP_MD_meth_set_input_blocksize_introduced = ((((((byte(1) shl 8) or byte(1)) shl 8) or byte(0)) shl 8) or byte(0)) shl 4;
  EVP_MD_meth_set_result_size_introduced = ((((((byte(1) shl 8) or byte(1)) shl 8) or byte(0)) shl 8) or byte(0)) shl 4;
  EVP_MD_meth_set_app_datasize_introduced = ((((((byte(1) shl 8) or byte(1)) shl 8) or byte(0)) shl 8) or byte(0)) shl 4;
  EVP_MD_meth_set_flags_introduced = ((((((byte(1) shl 8) or byte(1)) shl 8) or byte(0)) shl 8) or byte(0)) shl 4;
  EVP_MD_meth_set_init_introduced = ((((((byte(1) shl 8) or byte(1)) shl 8) or byte(0)) shl 8) or byte(0)) shl 4;
  EVP_MD_meth_set_update_introduced = ((((((byte(1) shl 8) or byte(1)) shl 8) or byte(0)) shl 8) or byte(0)) shl 4;
  EVP_MD_meth_set_final_introduced = ((((((byte(1) shl 8) or byte(1)) shl 8) or byte(0)) shl 8) or byte(0)) shl 4;
  EVP_MD_meth_set_copy_introduced = ((((((byte(1) shl 8) or byte(1)) shl 8) or byte(0)) shl 8) or byte(0)) shl 4;
  EVP_MD_meth_set_cleanup_introduced = ((((((byte(1) shl 8) or byte(1)) shl 8) or byte(0)) shl 8) or byte(0)) shl 4;
  EVP_MD_meth_set_ctrl_introduced = ((((((byte(1) shl 8) or byte(1)) shl 8) or byte(0)) shl 8) or byte(0)) shl 4;
  EVP_MD_meth_get_input_blocksize_introduced = ((((((byte(1) shl 8) or byte(1)) shl 8) or byte(0)) shl 8) or byte(0)) shl 4;
  EVP_MD_meth_get_result_size_introduced = ((((((byte(1) shl 8) or byte(1)) shl 8) or byte(0)) shl 8) or byte(0)) shl 4;
  EVP_MD_meth_get_app_datasize_introduced = ((((((byte(1) shl 8) or byte(1)) shl 8) or byte(0)) shl 8) or byte(0)) shl 4;
  EVP_MD_meth_get_flags_introduced = ((((((byte(1) shl 8) or byte(1)) shl 8) or byte(0)) shl 8) or byte(0)) shl 4;
  EVP_MD_meth_get_init_introduced = ((((((byte(1) shl 8) or byte(1)) shl 8) or byte(0)) shl 8) or byte(0)) shl 4;
  EVP_MD_meth_get_update_introduced = ((((((byte(1) shl 8) or byte(1)) shl 8) or byte(0)) shl 8) or byte(0)) shl 4;
  EVP_MD_meth_get_final_introduced = ((((((byte(1) shl 8) or byte(1)) shl 8) or byte(0)) shl 8) or byte(0)) shl 4;
  EVP_MD_meth_get_copy_introduced = ((((((byte(1) shl 8) or byte(1)) shl 8) or byte(0)) shl 8) or byte(0)) shl 4;
  EVP_MD_meth_get_cleanup_introduced = ((((((byte(1) shl 8) or byte(1)) shl 8) or byte(0)) shl 8) or byte(0)) shl 4;
  EVP_MD_meth_get_ctrl_introduced = ((((((byte(1) shl 8) or byte(1)) shl 8) or byte(0)) shl 8) or byte(0)) shl 4;
  EVP_CIPHER_meth_new_introduced = ((((((byte(1) shl 8) or byte(1)) shl 8) or byte(0)) shl 8) or byte(0)) shl 4;
  EVP_CIPHER_meth_dup_introduced = ((((((byte(1) shl 8) or byte(1)) shl 8) or byte(0)) shl 8) or byte(0)) shl 4;
  EVP_CIPHER_meth_free_introduced = ((((((byte(1) shl 8) or byte(1)) shl 8) or byte(0)) shl 8) or byte(0)) shl 4;
  EVP_CIPHER_meth_set_iv_length_introduced = ((((((byte(1) shl 8) or byte(1)) shl 8) or byte(0)) shl 8) or byte(0)) shl 4;
  EVP_CIPHER_meth_set_flags_introduced = ((((((byte(1) shl 8) or byte(1)) shl 8) or byte(0)) shl 8) or byte(0)) shl 4;
  EVP_CIPHER_meth_set_impl_ctx_size_introduced = ((((((byte(1) shl 8) or byte(1)) shl 8) or byte(0)) shl 8) or byte(0)) shl 4;
  EVP_CIPHER_meth_set_init_introduced = ((((((byte(1) shl 8) or byte(1)) shl 8) or byte(0)) shl 8) or byte(0)) shl 4;
  EVP_CIPHER_meth_set_do_cipher_introduced = ((((((byte(1) shl 8) or byte(1)) shl 8) or byte(0)) shl 8) or byte(0)) shl 4;
  EVP_CIPHER_meth_set_cleanup_introduced = ((((((byte(1) shl 8) or byte(1)) shl 8) or byte(0)) shl 8) or byte(0)) shl 4;
  EVP_CIPHER_meth_set_set_asn1_params_introduced = ((((((byte(1) shl 8) or byte(1)) shl 8) or byte(0)) shl 8) or byte(0)) shl 4;
  EVP_CIPHER_meth_set_get_asn1_params_introduced = ((((((byte(1) shl 8) or byte(1)) shl 8) or byte(0)) shl 8) or byte(0)) shl 4;
  EVP_CIPHER_meth_set_ctrl_introduced = ((((((byte(1) shl 8) or byte(1)) shl 8) or byte(0)) shl 8) or byte(0)) shl 4;
  EVP_CIPHER_meth_get_init_introduced = ((((((byte(1) shl 8) or byte(1)) shl 8) or byte(0)) shl 8) or byte(0)) shl 4;
  EVP_CIPHER_meth_get_do_cipher_introduced = ((((((byte(1) shl 8) or byte(1)) shl 8) or byte(0)) shl 8) or byte(0)) shl 4;
  EVP_CIPHER_meth_get_cleanup_introduced = ((((((byte(1) shl 8) or byte(1)) shl 8) or byte(0)) shl 8) or byte(0)) shl 4;
  EVP_CIPHER_meth_get_set_asn1_params_introduced = ((((((byte(1) shl 8) or byte(1)) shl 8) or byte(0)) shl 8) or byte(0)) shl 4;
  EVP_CIPHER_meth_get_get_asn1_params_introduced = ((((((byte(1) shl 8) or byte(1)) shl 8) or byte(0)) shl 8) or byte(0)) shl 4;
  EVP_CIPHER_meth_get_ctrl_introduced = ((((((byte(1) shl 8) or byte(1)) shl 8) or byte(0)) shl 8) or byte(0)) shl 4;
  EVP_MD_type_removed = ((((((byte(3) shl 8) or byte(0)) shl 8) or byte(0)) shl 8) or byte(0)) shl 4;
  EVP_MD_pkey_type_removed = ((((((byte(3) shl 8) or byte(0)) shl 8) or byte(0)) shl 8) or byte(0)) shl 4;
  EVP_MD_size_removed = ((((((byte(3) shl 8) or byte(0)) shl 8) or byte(0)) shl 8) or byte(0)) shl 4;
  EVP_MD_block_size_removed = ((((((byte(3) shl 8) or byte(0)) shl 8) or byte(0)) shl 8) or byte(0)) shl 4;
  EVP_MD_flags_removed = ((((((byte(3) shl 8) or byte(0)) shl 8) or byte(0)) shl 8) or byte(0)) shl 4;
  EVP_MD_CTX_update_fn_introduced = ((((((byte(1) shl 8) or byte(1)) shl 8) or byte(0)) shl 8) or byte(0)) shl 4;
  EVP_MD_CTX_set_update_fn_introduced = ((((((byte(1) shl 8) or byte(1)) shl 8) or byte(0)) shl 8) or byte(0)) shl 4;
  EVP_MD_CTX_pkey_ctx_introduced = ((((((byte(1) shl 8) or byte(1)) shl 8) or byte(0)) shl 8) or byte(0)) shl 4;
  EVP_MD_CTX_pkey_ctx_removed = ((((((byte(3) shl 8) or byte(0)) shl 8) or byte(0)) shl 8) or byte(0)) shl 4;
  EVP_MD_CTX_set_pkey_ctx_introduced = ((((((byte(1) shl 8) or byte(1)) shl 8) or byte(0)) shl 8) or byte(0)) shl 4;
  EVP_MD_CTX_md_data_introduced = ((((((byte(1) shl 8) or byte(1)) shl 8) or byte(0)) shl 8) or byte(0)) shl 4;
  EVP_MD_CTX_md_data_removed = ((((((byte(3) shl 8) or byte(0)) shl 8) or byte(0)) shl 8) or byte(0)) shl 4;
  EVP_CIPHER_nid_removed = ((((((byte(3) shl 8) or byte(0)) shl 8) or byte(0)) shl 8) or byte(0)) shl 4;
  EVP_CIPHER_block_size_removed = ((((((byte(3) shl 8) or byte(0)) shl 8) or byte(0)) shl 8) or byte(0)) shl 4;
  EVP_CIPHER_impl_ctx_size_introduced = ((((((byte(1) shl 8) or byte(1)) shl 8) or byte(0)) shl 8) or byte(0)) shl 4;
  EVP_CIPHER_key_length_removed = ((((((byte(3) shl 8) or byte(0)) shl 8) or byte(0)) shl 8) or byte(0)) shl 4;
  EVP_CIPHER_iv_length_removed = ((((((byte(3) shl 8) or byte(0)) shl 8) or byte(0)) shl 8) or byte(0)) shl 4;
  EVP_CIPHER_flags_removed = ((((((byte(3) shl 8) or byte(0)) shl 8) or byte(0)) shl 8) or byte(0)) shl 4;
  EVP_CIPHER_CTX_encrypting_introduced = ((((((byte(1) shl 8) or byte(1)) shl 8) or byte(0)) shl 8) or byte(0)) shl 4;
  EVP_CIPHER_CTX_encrypting_removed = ((((((byte(3) shl 8) or byte(0)) shl 8) or byte(0)) shl 8) or byte(0)) shl 4;
  EVP_CIPHER_CTX_nid_removed = ((((((byte(3) shl 8) or byte(0)) shl 8) or byte(0)) shl 8) or byte(0)) shl 4;
  EVP_CIPHER_CTX_block_size_removed = ((((((byte(3) shl 8) or byte(0)) shl 8) or byte(0)) shl 8) or byte(0)) shl 4;
  EVP_CIPHER_CTX_key_length_removed = ((((((byte(3) shl 8) or byte(0)) shl 8) or byte(0)) shl 8) or byte(0)) shl 4;
  EVP_CIPHER_CTX_iv_length_removed = ((((((byte(3) shl 8) or byte(0)) shl 8) or byte(0)) shl 8) or byte(0)) shl 4;
  EVP_CIPHER_CTX_iv_introduced = ((((((byte(1) shl 8) or byte(1)) shl 8) or byte(0)) shl 8) or byte(0)) shl 4;
  EVP_CIPHER_CTX_original_iv_introduced = ((((((byte(1) shl 8) or byte(1)) shl 8) or byte(0)) shl 8) or byte(0)) shl 4;
  EVP_CIPHER_CTX_iv_noconst_introduced = ((((((byte(1) shl 8) or byte(1)) shl 8) or byte(0)) shl 8) or byte(0)) shl 4;
  EVP_CIPHER_CTX_buf_noconst_introduced = ((((((byte(1) shl 8) or byte(1)) shl 8) or byte(0)) shl 8) or byte(0)) shl 4;
  EVP_CIPHER_CTX_num_introduced = ((((((byte(1) shl 8) or byte(1)) shl 8) or byte(0)) shl 8) or byte(0)) shl 4;
  EVP_CIPHER_CTX_num_removed = ((((((byte(3) shl 8) or byte(0)) shl 8) or byte(0)) shl 8) or byte(0)) shl 4;
  EVP_CIPHER_CTX_set_num_introduced = ((((((byte(1) shl 8) or byte(1)) shl 8) or byte(0)) shl 8) or byte(0)) shl 4;
  EVP_CIPHER_CTX_get_cipher_data_introduced = ((((((byte(1) shl 8) or byte(1)) shl 8) or byte(0)) shl 8) or byte(0)) shl 4;
  EVP_CIPHER_CTX_set_cipher_data_introduced = ((((((byte(1) shl 8) or byte(1)) shl 8) or byte(0)) shl 8) or byte(0)) shl 4;
  BIO_set_md_removed = ((((((byte(1) shl 8) or byte(0)) shl 8) or byte(0)) shl 8) or byte(0)) shl 4;
  EVP_MD_CTX_init_removed = ((((((byte(1) shl 8) or byte(1)) shl 8) or byte(0)) shl 8) or byte(0)) shl 4;
  EVP_MD_CTX_cleanup_removed = ((((((byte(1) shl 8) or byte(1)) shl 8) or byte(0)) shl 8) or byte(0)) shl 4;
  EVP_MD_CTX_ctrl_introduced = ((((((byte(1) shl 8) or byte(1)) shl 8) or byte(0)) shl 8) or byte(0)) shl 4;
  EVP_MD_CTX_new_introduced = ((((((byte(1) shl 8) or byte(1)) shl 8) or byte(0)) shl 8) or byte(0)) shl 4;
  EVP_MD_CTX_reset_introduced = ((((((byte(1) shl 8) or byte(1)) shl 8) or byte(0)) shl 8) or byte(0)) shl 4;
  EVP_MD_CTX_free_introduced = ((((((byte(1) shl 8) or byte(1)) shl 8) or byte(0)) shl 8) or byte(0)) shl 4;
  EVP_DigestFinalXOF_introduced = ((((((byte(1) shl 8) or byte(1)) shl 8) or byte(0)) shl 8) or byte(0)) shl 4;
  EVP_DigestSign_introduced = ((((((byte(1) shl 8) or byte(1)) shl 8) or byte(0)) shl 8) or byte(0)) shl 4;
  EVP_DigestVerify_introduced = ((((((byte(1) shl 8) or byte(1)) shl 8) or byte(0)) shl 8) or byte(0)) shl 4;
  EVP_ENCODE_CTX_new_introduced = ((((((byte(1) shl 8) or byte(1)) shl 8) or byte(0)) shl 8) or byte(0)) shl 4;
  EVP_ENCODE_CTX_free_introduced = ((((((byte(1) shl 8) or byte(1)) shl 8) or byte(0)) shl 8) or byte(0)) shl 4;
  EVP_ENCODE_CTX_copy_introduced = ((((((byte(1) shl 8) or byte(1)) shl 8) or byte(0)) shl 8) or byte(0)) shl 4;
  EVP_ENCODE_CTX_num_introduced = ((((((byte(1) shl 8) or byte(1)) shl 8) or byte(0)) shl 8) or byte(0)) shl 4;
  EVP_CIPHER_CTX_reset_introduced = ((((((byte(1) shl 8) or byte(1)) shl 8) or byte(0)) shl 8) or byte(0)) shl 4;
  EVP_md2_removed = ((((((byte(1) shl 8) or byte(1)) shl 8) or byte(0)) shl 8) or byte(0)) shl 4;
  EVP_md4_removed = ((((((byte(1) shl 8) or byte(1)) shl 8) or byte(0)) shl 8) or byte(0)) shl 4;
  EVP_md5_removed = ((((((byte(1) shl 8) or byte(1)) shl 8) or byte(0)) shl 8) or byte(0)) shl 4;
  EVP_md5_sha1_introduced = ((((((byte(1) shl 8) or byte(1)) shl 8) or byte(0)) shl 8) or byte(0)) shl 4;
  EVP_sha512_224_introduced = ((((((byte(1) shl 8) or byte(1)) shl 8) or byte(0)) shl 8) or byte(0)) shl 4;
  EVP_sha512_256_introduced = ((((((byte(1) shl 8) or byte(1)) shl 8) or byte(0)) shl 8) or byte(0)) shl 4;
  EVP_sha3_224_introduced = ((((((byte(1) shl 8) or byte(1)) shl 8) or byte(0)) shl 8) or byte(0)) shl 4;
  EVP_sha3_256_introduced = ((((((byte(1) shl 8) or byte(1)) shl 8) or byte(0)) shl 8) or byte(0)) shl 4;
  EVP_sha3_384_introduced = ((((((byte(1) shl 8) or byte(1)) shl 8) or byte(0)) shl 8) or byte(0)) shl 4;
  EVP_sha3_512_introduced = ((((((byte(1) shl 8) or byte(1)) shl 8) or byte(0)) shl 8) or byte(0)) shl 4;
  EVP_shake128_introduced = ((((((byte(1) shl 8) or byte(1)) shl 8) or byte(0)) shl 8) or byte(0)) shl 4;
  EVP_shake256_introduced = ((((((byte(1) shl 8) or byte(1)) shl 8) or byte(0)) shl 8) or byte(0)) shl 4;
  EVP_aes_128_wrap_pad_introduced = ((((((byte(1) shl 8) or byte(1)) shl 8) or byte(0)) shl 8) or byte(0)) shl 4;
  EVP_aes_128_ocb_introduced = ((((((byte(1) shl 8) or byte(1)) shl 8) or byte(0)) shl 8) or byte(0)) shl 4;
  EVP_aes_192_wrap_pad_introduced = ((((((byte(1) shl 8) or byte(1)) shl 8) or byte(0)) shl 8) or byte(0)) shl 4;
  EVP_aes_192_ocb_introduced = ((((((byte(1) shl 8) or byte(1)) shl 8) or byte(0)) shl 8) or byte(0)) shl 4;
  EVP_aes_256_wrap_pad_introduced = ((((((byte(1) shl 8) or byte(1)) shl 8) or byte(0)) shl 8) or byte(0)) shl 4;
  EVP_aes_256_ocb_introduced = ((((((byte(1) shl 8) or byte(1)) shl 8) or byte(0)) shl 8) or byte(0)) shl 4;
  EVP_aria_128_ecb_introduced = ((((((byte(1) shl 8) or byte(1)) shl 8) or byte(0)) shl 8) or byte(0)) shl 4;
  EVP_aria_128_cbc_introduced = ((((((byte(1) shl 8) or byte(1)) shl 8) or byte(0)) shl 8) or byte(0)) shl 4;
  EVP_aria_128_cfb1_introduced = ((((((byte(1) shl 8) or byte(1)) shl 8) or byte(0)) shl 8) or byte(0)) shl 4;
  EVP_aria_128_cfb8_introduced = ((((((byte(1) shl 8) or byte(1)) shl 8) or byte(0)) shl 8) or byte(0)) shl 4;
  EVP_aria_128_cfb128_introduced = ((((((byte(1) shl 8) or byte(1)) shl 8) or byte(0)) shl 8) or byte(0)) shl 4;
  EVP_aria_128_ctr_introduced = ((((((byte(1) shl 8) or byte(1)) shl 8) or byte(0)) shl 8) or byte(0)) shl 4;
  EVP_aria_128_ofb_introduced = ((((((byte(1) shl 8) or byte(1)) shl 8) or byte(0)) shl 8) or byte(0)) shl 4;
  EVP_aria_128_gcm_introduced = ((((((byte(1) shl 8) or byte(1)) shl 8) or byte(0)) shl 8) or byte(0)) shl 4;
  EVP_aria_128_ccm_introduced = ((((((byte(1) shl 8) or byte(1)) shl 8) or byte(0)) shl 8) or byte(0)) shl 4;
  EVP_aria_192_ecb_introduced = ((((((byte(1) shl 8) or byte(1)) shl 8) or byte(0)) shl 8) or byte(0)) shl 4;
  EVP_aria_192_cbc_introduced = ((((((byte(1) shl 8) or byte(1)) shl 8) or byte(0)) shl 8) or byte(0)) shl 4;
  EVP_aria_192_cfb1_introduced = ((((((byte(1) shl 8) or byte(1)) shl 8) or byte(0)) shl 8) or byte(0)) shl 4;
  EVP_aria_192_cfb8_introduced = ((((((byte(1) shl 8) or byte(1)) shl 8) or byte(0)) shl 8) or byte(0)) shl 4;
  EVP_aria_192_cfb128_introduced = ((((((byte(1) shl 8) or byte(1)) shl 8) or byte(0)) shl 8) or byte(0)) shl 4;
  EVP_aria_192_ctr_introduced = ((((((byte(1) shl 8) or byte(1)) shl 8) or byte(0)) shl 8) or byte(0)) shl 4;
  EVP_aria_192_ofb_introduced = ((((((byte(1) shl 8) or byte(1)) shl 8) or byte(0)) shl 8) or byte(0)) shl 4;
  EVP_aria_192_gcm_introduced = ((((((byte(1) shl 8) or byte(1)) shl 8) or byte(0)) shl 8) or byte(0)) shl 4;
  EVP_aria_192_ccm_introduced = ((((((byte(1) shl 8) or byte(1)) shl 8) or byte(0)) shl 8) or byte(0)) shl 4;
  EVP_aria_256_ecb_introduced = ((((((byte(1) shl 8) or byte(1)) shl 8) or byte(0)) shl 8) or byte(0)) shl 4;
  EVP_aria_256_cbc_introduced = ((((((byte(1) shl 8) or byte(1)) shl 8) or byte(0)) shl 8) or byte(0)) shl 4;
  EVP_aria_256_cfb1_introduced = ((((((byte(1) shl 8) or byte(1)) shl 8) or byte(0)) shl 8) or byte(0)) shl 4;
  EVP_aria_256_cfb8_introduced = ((((((byte(1) shl 8) or byte(1)) shl 8) or byte(0)) shl 8) or byte(0)) shl 4;
  EVP_aria_256_cfb128_introduced = ((((((byte(1) shl 8) or byte(1)) shl 8) or byte(0)) shl 8) or byte(0)) shl 4;
  EVP_aria_256_ctr_introduced = ((((((byte(1) shl 8) or byte(1)) shl 8) or byte(0)) shl 8) or byte(0)) shl 4;
  EVP_aria_256_ofb_introduced = ((((((byte(1) shl 8) or byte(1)) shl 8) or byte(0)) shl 8) or byte(0)) shl 4;
  EVP_aria_256_gcm_introduced = ((((((byte(1) shl 8) or byte(1)) shl 8) or byte(0)) shl 8) or byte(0)) shl 4;
  EVP_aria_256_ccm_introduced = ((((((byte(1) shl 8) or byte(1)) shl 8) or byte(0)) shl 8) or byte(0)) shl 4;
  EVP_camellia_128_ctr_introduced = ((((((byte(1) shl 8) or byte(1)) shl 8) or byte(0)) shl 8) or byte(0)) shl 4;
  EVP_camellia_192_ctr_introduced = ((((((byte(1) shl 8) or byte(1)) shl 8) or byte(0)) shl 8) or byte(0)) shl 4;
  EVP_camellia_256_ctr_introduced = ((((((byte(1) shl 8) or byte(1)) shl 8) or byte(0)) shl 8) or byte(0)) shl 4;
  EVP_chacha20_introduced = ((((((byte(1) shl 8) or byte(1)) shl 8) or byte(0)) shl 8) or byte(0)) shl 4;
  EVP_chacha20_poly1305_introduced = ((((((byte(1) shl 8) or byte(1)) shl 8) or byte(0)) shl 8) or byte(0)) shl 4;
  EVP_sm4_ecb_introduced = ((((((byte(1) shl 8) or byte(1)) shl 8) or byte(0)) shl 8) or byte(0)) shl 4;
  EVP_sm4_cbc_introduced = ((((((byte(1) shl 8) or byte(1)) shl 8) or byte(0)) shl 8) or byte(0)) shl 4;
  EVP_sm4_cfb128_introduced = ((((((byte(1) shl 8) or byte(1)) shl 8) or byte(0)) shl 8) or byte(0)) shl 4;
  EVP_sm4_ofb_introduced = ((((((byte(1) shl 8) or byte(1)) shl 8) or byte(0)) shl 8) or byte(0)) shl 4;
  EVP_sm4_ctr_introduced = ((((((byte(1) shl 8) or byte(1)) shl 8) or byte(0)) shl 8) or byte(0)) shl 4;
  EVP_PKEY_id_removed = ((((((byte(3) shl 8) or byte(0)) shl 8) or byte(0)) shl 8) or byte(0)) shl 4;
  EVP_PKEY_base_id_removed = ((((((byte(3) shl 8) or byte(0)) shl 8) or byte(0)) shl 8) or byte(0)) shl 4;
  EVP_PKEY_get_base_id_introduced = ((((((byte(3) shl 8) or byte(0)) shl 8) or byte(0)) shl 8) or byte(0)) shl 4;
  EVP_PKEY_bits_removed = ((((((byte(3) shl 8) or byte(0)) shl 8) or byte(0)) shl 8) or byte(0)) shl 4;
  EVP_PKEY_security_bits_introduced = ((((((byte(1) shl 8) or byte(1)) shl 8) or byte(0)) shl 8) or byte(0)) shl 4;
  EVP_PKEY_security_bits_removed = ((((((byte(3) shl 8) or byte(0)) shl 8) or byte(0)) shl 8) or byte(0)) shl 4;
  EVP_PKEY_get_security_bits_introduced = ((((((byte(3) shl 8) or byte(0)) shl 8) or byte(0)) shl 8) or byte(0)) shl 4;
  EVP_PKEY_size_removed = ((((((byte(3) shl 8) or byte(0)) shl 8) or byte(0)) shl 8) or byte(0)) shl 4;
  EVP_PKEY_get_size_introduced = ((((((byte(3) shl 8) or byte(0)) shl 8) or byte(0)) shl 8) or byte(0)) shl 4;
  EVP_PKEY_set_alias_type_introduced = ((((((byte(1) shl 8) or byte(1)) shl 8) or byte(0)) shl 8) or byte(0)) shl 4;
  EVP_PKEY_set_alias_type_removed = ((((((byte(3) shl 8) or byte(0)) shl 8) or byte(0)) shl 8) or byte(0)) shl 4;
  EVP_PKEY_set1_engine_introduced = ((((((byte(1) shl 8) or byte(1)) shl 8) or byte(0)) shl 8) or byte(0)) shl 4;
  EVP_PKEY_get0_engine_introduced = ((((((byte(1) shl 8) or byte(1)) shl 8) or byte(0)) shl 8) or byte(0)) shl 4;
  EVP_PKEY_get0_hmac_introduced = ((((((byte(1) shl 8) or byte(1)) shl 8) or byte(0)) shl 8) or byte(0)) shl 4;
  EVP_PKEY_get0_poly1305_introduced = ((((((byte(1) shl 8) or byte(1)) shl 8) or byte(0)) shl 8) or byte(0)) shl 4;
  EVP_PKEY_get0_siphash_introduced = ((((((byte(1) shl 8) or byte(1)) shl 8) or byte(0)) shl 8) or byte(0)) shl 4;
  EVP_PKEY_get0_RSA_introduced = ((((((byte(1) shl 8) or byte(1)) shl 8) or byte(0)) shl 8) or byte(0)) shl 4;
  EVP_PKEY_get0_DSA_introduced = ((((((byte(1) shl 8) or byte(1)) shl 8) or byte(0)) shl 8) or byte(0)) shl 4;
  EVP_PKEY_get0_DH_introduced = ((((((byte(1) shl 8) or byte(1)) shl 8) or byte(0)) shl 8) or byte(0)) shl 4;
  EVP_PKEY_get0_EC_KEY_introduced = ((((((byte(1) shl 8) or byte(1)) shl 8) or byte(0)) shl 8) or byte(0)) shl 4;
  EVP_PKEY_up_ref_introduced = ((((((byte(1) shl 8) or byte(1)) shl 8) or byte(0)) shl 8) or byte(0)) shl 4;
  EVP_PKEY_set1_tls_encodedpoint_introduced = ((((((byte(1) shl 8) or byte(1)) shl 8) or byte(0)) shl 8) or byte(0)) shl 4;
  EVP_PKEY_set1_tls_encodedpoint_removed = ((((((byte(3) shl 8) or byte(0)) shl 8) or byte(0)) shl 8) or byte(0)) shl 4;
  EVP_PKEY_get1_tls_encodedpoint_introduced = ((((((byte(1) shl 8) or byte(1)) shl 8) or byte(0)) shl 8) or byte(0)) shl 4;
  EVP_PKEY_get1_tls_encodedpoint_removed = ((((((byte(3) shl 8) or byte(0)) shl 8) or byte(0)) shl 8) or byte(0)) shl 4;
  EVP_CIPHER_type_removed = ((((((byte(3) shl 8) or byte(0)) shl 8) or byte(0)) shl 8) or byte(0)) shl 4;
  EVP_PBE_scrypt_introduced = ((((((byte(1) shl 8) or byte(1)) shl 8) or byte(0)) shl 8) or byte(0)) shl 4;
  PKCS5_v2_scrypt_keyivgen_introduced = ((((((byte(1) shl 8) or byte(1)) shl 8) or byte(0)) shl 8) or byte(0)) shl 4;
  EVP_PBE_get_introduced = ((((((byte(1) shl 8) or byte(1)) shl 8) or byte(0)) shl 8) or byte(0)) shl 4;
  EVP_PKEY_asn1_set_siginf_introduced = ((((((byte(1) shl 8) or byte(1)) shl 8) or byte(0)) shl 8) or byte(0)) shl 4;
  EVP_PKEY_asn1_set_check_introduced = ((((((byte(1) shl 8) or byte(1)) shl 8) or byte(0)) shl 8) or byte(0)) shl 4;
  EVP_PKEY_asn1_set_public_check_introduced = ((((((byte(1) shl 8) or byte(1)) shl 8) or byte(0)) shl 8) or byte(0)) shl 4;
  EVP_PKEY_asn1_set_param_check_introduced = ((((((byte(1) shl 8) or byte(1)) shl 8) or byte(0)) shl 8) or byte(0)) shl 4;
  EVP_PKEY_asn1_set_set_priv_key_introduced = ((((((byte(1) shl 8) or byte(1)) shl 8) or byte(0)) shl 8) or byte(0)) shl 4;
  EVP_PKEY_asn1_set_set_pub_key_introduced = ((((((byte(1) shl 8) or byte(1)) shl 8) or byte(0)) shl 8) or byte(0)) shl 4;
  EVP_PKEY_asn1_set_get_priv_key_introduced = ((((((byte(1) shl 8) or byte(1)) shl 8) or byte(0)) shl 8) or byte(0)) shl 4;
  EVP_PKEY_asn1_set_get_pub_key_introduced = ((((((byte(1) shl 8) or byte(1)) shl 8) or byte(0)) shl 8) or byte(0)) shl 4;
  EVP_PKEY_asn1_set_security_bits_introduced = ((((((byte(1) shl 8) or byte(1)) shl 8) or byte(0)) shl 8) or byte(0)) shl 4;
  EVP_PKEY_meth_remove_introduced = ((((((byte(1) shl 8) or byte(1)) shl 8) or byte(0)) shl 8) or byte(0)) shl 4;
  EVP_PKEY_meth_get_count_introduced = ((((((byte(1) shl 8) or byte(1)) shl 8) or byte(0)) shl 8) or byte(0)) shl 4;
  EVP_PKEY_meth_get0_introduced = ((((((byte(1) shl 8) or byte(1)) shl 8) or byte(0)) shl 8) or byte(0)) shl 4;
  EVP_PKEY_CTX_ctrl_uint64_introduced = ((((((byte(1) shl 8) or byte(1)) shl 8) or byte(0)) shl 8) or byte(0)) shl 4;
  EVP_PKEY_CTX_str2ctrl_introduced = ((((((byte(1) shl 8) or byte(1)) shl 8) or byte(0)) shl 8) or byte(0)) shl 4;
  EVP_PKEY_CTX_hex2ctrl_introduced = ((((((byte(1) shl 8) or byte(1)) shl 8) or byte(0)) shl 8) or byte(0)) shl 4;
  EVP_PKEY_CTX_md_introduced = ((((((byte(1) shl 8) or byte(1)) shl 8) or byte(0)) shl 8) or byte(0)) shl 4;
  EVP_PKEY_new_raw_private_key_introduced = ((((((byte(1) shl 8) or byte(1)) shl 8) or byte(0)) shl 8) or byte(0)) shl 4;
  EVP_PKEY_new_raw_public_key_introduced = ((((((byte(1) shl 8) or byte(1)) shl 8) or byte(0)) shl 8) or byte(0)) shl 4;
  EVP_PKEY_get_raw_private_key_introduced = ((((((byte(1) shl 8) or byte(1)) shl 8) or byte(0)) shl 8) or byte(0)) shl 4;
  EVP_PKEY_get_raw_public_key_introduced = ((((((byte(1) shl 8) or byte(1)) shl 8) or byte(0)) shl 8) or byte(0)) shl 4;
  EVP_PKEY_new_CMAC_key_introduced = ((((((byte(1) shl 8) or byte(1)) shl 8) or byte(0)) shl 8) or byte(0)) shl 4;
  EVP_PKEY_check_introduced = ((((((byte(1) shl 8) or byte(1)) shl 8) or byte(0)) shl 8) or byte(0)) shl 4;
  EVP_PKEY_public_check_introduced = ((((((byte(1) shl 8) or byte(1)) shl 8) or byte(0)) shl 8) or byte(0)) shl 4;
  EVP_PKEY_param_check_introduced = ((((((byte(1) shl 8) or byte(1)) shl 8) or byte(0)) shl 8) or byte(0)) shl 4;
  EVP_PKEY_meth_set_digestsign_introduced = ((((((byte(1) shl 8) or byte(1)) shl 8) or byte(0)) shl 8) or byte(0)) shl 4;
  EVP_PKEY_meth_set_digestverify_introduced = ((((((byte(1) shl 8) or byte(1)) shl 8) or byte(0)) shl 8) or byte(0)) shl 4;
  EVP_PKEY_meth_set_check_introduced = ((((((byte(1) shl 8) or byte(1)) shl 8) or byte(0)) shl 8) or byte(0)) shl 4;
  EVP_PKEY_meth_set_public_check_introduced = ((((((byte(1) shl 8) or byte(1)) shl 8) or byte(0)) shl 8) or byte(0)) shl 4;
  EVP_PKEY_meth_set_param_check_introduced = ((((((byte(1) shl 8) or byte(1)) shl 8) or byte(0)) shl 8) or byte(0)) shl 4;
  EVP_PKEY_meth_set_digest_custom_introduced = ((((((byte(1) shl 8) or byte(1)) shl 8) or byte(0)) shl 8) or byte(0)) shl 4;
  EVP_PKEY_meth_get_digestsign_introduced = ((((((byte(1) shl 8) or byte(1)) shl 8) or byte(0)) shl 8) or byte(0)) shl 4;
  EVP_PKEY_meth_get_digestverify_introduced = ((((((byte(1) shl 8) or byte(1)) shl 8) or byte(0)) shl 8) or byte(0)) shl 4;
  EVP_PKEY_meth_get_check_introduced = ((((((byte(1) shl 8) or byte(1)) shl 8) or byte(0)) shl 8) or byte(0)) shl 4;
  EVP_PKEY_meth_get_public_check_introduced = ((((((byte(1) shl 8) or byte(1)) shl 8) or byte(0)) shl 8) or byte(0)) shl 4;
  EVP_PKEY_meth_get_param_check_introduced = ((((((byte(1) shl 8) or byte(1)) shl 8) or byte(0)) shl 8) or byte(0)) shl 4;
  EVP_PKEY_meth_get_digest_custom_introduced = ((((((byte(1) shl 8) or byte(1)) shl 8) or byte(0)) shl 8) or byte(0)) shl 4;
  OpenSSL_add_all_ciphers_removed = ((((((byte(1) shl 8) or byte(1)) shl 8) or byte(0)) shl 8) or byte(0)) shl 4;
  OpenSSL_add_all_digests_removed = ((((((byte(1) shl 8) or byte(1)) shl 8) or byte(0)) shl 8) or byte(0)) shl 4;
  EVP_cleanup_removed = ((((((byte(1) shl 8) or byte(1)) shl 8) or byte(0)) shl 8) or byte(0)) shl 4;
...
var
  ...
  EVP_MD_CTX_pkey_ctx: function (const ctx: PEVP_MD_CTX): PEVP_PKEY_CTX; cdecl = Load_EVP_MD_CTX_pkey_ctx; {introduced 1.1.0 removed 3.0.0}
  EVP_MD_CTX_md_data: function (const ctx: PEVP_MD_CTX): Pointer; cdecl = Load_EVP_MD_CTX_md_data; {introduced 1.1.0 removed 3.0.0}
  ...
  EVP_CIPHER_CTX_encrypting: function (const ctx: PEVP_CIPHER_CTX): TOpenSSL_C_INT; cdecl = Load_EVP_CIPHER_CTX_encrypting; {introduced 1.1.0 removed 3.0.0}
  ...
  EVP_CIPHER_CTX_num: function (const ctx: PEVP_CIPHER_CTX): TOpenSSL_C_INT; cdecl = Load_EVP_CIPHER_CTX_num; {introduced 1.1.0 removed 3.0.0}
  ...
  EVP_PKEY_set_alias_type: function (pkey: PEVP_PKEY; type_: TOpenSSL_C_INT): TOpenSSL_C_INT; cdecl = Load_EVP_PKEY_set_alias_type; {introduced 1.1.0 removed 3.0.0}
  EVP_PKEY_set1_tls_encodedpoint: function (pkey: PEVP_PKEY; const pt: PByte; ptlen: TOpenSSL_C_SIZET): TOpenSSL_C_INT; cdecl = Load_EVP_PKEY_set1_tls_encodedpoint; {introduced 1.1.0 removed 3.0.0}
  EVP_PKEY_get1_tls_encodedpoint: function (pkey: PEVP_PKEY; ppt: PPByte): TOpenSSL_C_SIZET; cdecl = Load_EVP_PKEY_get1_tls_encodedpoint; {introduced 1.1.0 removed 3.0.0}
