...
var
  ...
  DH_bits: function (const dh: PDH): TOpenSSL_C_INT; cdecl = nil; {introduced 1.1.0 }
  DH_size: function (const dh: PDH): TOpenSSL_C_INT; cdecl = nil;
  DH_security_bits: function (const dh: PDH): TOpenSSL_C_INT; cdecl = nil; {introduced 1.1.0 }
  ...
  DH_check_params_ex: function (const dh: PDH): TOpenSSL_C_INT; cdecl = nil; {introduced 1.1.0 }
  DH_check_ex: function (const dh: PDH): TOpenSSL_C_INT; cdecl = nil; {introduced 1.1.0 }
  DH_check_pub_key_ex: function (const dh: PDH; const pub_key: PBIGNUM): TOpenSSL_C_INT; cdecl = nil; {introduced 1.1.0 }
  DH_check_params: function (const dh: PDH; ret: POpenSSL_C_INT): TOpenSSL_C_INT; cdecl = nil; {introduced 1.1.0 }
  ...
  DH_new_by_nid: function (nid: TOpenSSL_C_INT): PDH; cdecl = nil; {introduced 1.1.0 }
  DH_get_nid: function (const dh: PDH): TOpenSSL_C_INT; cdecl = nil; {introduced 1.1.0 }
  ...
  DH_set0_pqg: function (dh: PDH; p: PBIGNUM; q: PBIGNUM; g: PBIGNUM): TOpenSSL_C_INT; cdecl = nil; {introduced 1.1.0 }
  DH_get0_key: procedure (const dh: PDH; const pub_key: PPBIGNUM; const priv_key: PPBIGNUM); cdecl = nil; {introduced 1.1.0 }
  DH_set0_key: function (dh: PDH; pub_key: PBIGNUM; priv_key: PBIGNUM): TOpenSSL_C_INT; cdecl = nil; {introduced 1.1.0 }
  ...
  DH_clear_flags: procedure (dh: PDH; flags: TOpenSSL_C_INT); cdecl = nil; {introduced 1.1.0 }
  DH_test_flags: function (const dh: PDH; flags: TOpenSSL_C_INT): TOpenSSL_C_INT; cdecl = nil; {introduced 1.1.0 }
  DH_set_flags: procedure (dh: PDH; flags: TOpenSSL_C_INT); cdecl = nil; {introduced 1.1.0 }
  DH_get0_engine: function (d: PDH): PENGINE; cdecl = nil; {introduced 1.1.0 }
  DH_get_length: function (const dh: PDH): TOpenSSL_C_LONG; cdecl = nil; {introduced 1.1.0 }
  DH_set_length: function (dh: PDH; length: TOpenSSL_C_LONG): TOpenSSL_C_INT; cdecl = nil; {introduced 1.1.0 }
  DH_meth_new: function (const name: PAnsiChar; flags: TOpenSSL_C_INT): PDH_Method; cdecl = nil; {introduced 1.1.0 }
  ...
  DH_meth_get0_name: function (const dhm: PDH_Method): PAnsiChar; cdecl = nil; {introduced 1.1.0 }
  DH_meth_set1_name: function (dhm: PDH_Method; const name: PAnsiChar): TOpenSSL_C_INT; cdecl = nil; {introduced 1.1.0 }
  DH_meth_get_flags: function (const dhm: PDH_Method): TOpenSSL_C_INT; cdecl = nil; {introduced 1.1.0 }
  DH_meth_set_flags: function (const dhm: PDH_Method; flags: TOpenSSL_C_INT): TOpenSSL_C_INT; cdecl = nil; {introduced 1.1.0 }
  DH_meth_get0_app_data: function (const dhm: PDH_Method): Pointer; cdecl = nil; {introduced 1.1.0 }
  DH_meth_set0_app_data: function (const dhm: PDH_Method; app_data: Pointer): TOpenSSL_C_INT; cdecl = nil; {introduced 1.1.0 }
  DH_meth_get_generate_key: function (const dhm: PDH_Method): DH_meth_generate_key_cb; cdecl = nil; {introduced 1.1.0 }
  DH_meth_set_generate_key: function (const dhm: PDH_Method; generate_key: DH_meth_generate_key_cb): TOpenSSL_C_INT; cdecl = nil; {introduced 1.1.0 }
  DH_meth_get_compute_key: function (const dhm: PDH_Method): DH_meth_compute_key_cb; cdecl = nil; {introduced 1.1.0 }
  DH_meth_set_compute_key: function (const dhm: PDH_Method; compute_key: DH_meth_compute_key_cb): TOpenSSL_C_INT; cdecl = nil; {introduced 1.1.0 }
  DH_meth_get_bn_mod_exp: function (const dhm: PDH_Method): DH_meth_bn_mod_exp_cb; cdecl = nil; {introduced 1.1.0 }
  DH_meth_set_bn_mod_exp: function (const dhm: PDH_Method; bn_mod_expr: DH_meth_bn_mod_exp_cb): TOpenSSL_C_INT; cdecl = nil; {introduced 1.1.0 }
  DH_meth_get_init: function (const dhm: PDH_Method): DH_meth_init_cb; cdecl = nil; {introduced 1.1.0 }
  DH_meth_set_init: function (const dhm: PDH_Method; init: DH_meth_init_cb): TOpenSSL_C_INT; cdecl = nil; {introduced 1.1.0 }
  DH_meth_get_finish: function (const dhm: PDH_Method): DH_meth_finish_cb; cdecl = nil; {introduced 1.1.0 }
  DH_meth_set_finish: function (const dhm: PDH_Method; finish: DH_meth_finish_cb): TOpenSSL_C_INT; cdecl = nil; {introduced 1.1.0 }
  DH_meth_get_generate_params: function (const dhm: PDH_Method): DH_meth_generate_params_cb; cdecl = nil; {introduced 1.1.0 }
  DH_meth_set_generate_params: function (const dhm: PDH_Method; generate_params: DH_meth_generate_params_cb): TOpenSSL_C_INT; cdecl = nil; {introduced 1.1.0 }
{$ENDIF}
const
  DH_bits_introduced = ((((((byte(1) shl 8) or byte(1)) shl 8) or byte(0)) shl 8) or byte(0)) shl 4;
  DH_security_bits_introduced = ((((((byte(1) shl 8) or byte(1)) shl 8) or byte(0)) shl 8) or byte(0)) shl 4;
  DH_check_params_ex_introduced = ((((((byte(1) shl 8) or byte(1)) shl 8) or byte(0)) shl 8) or byte(0)) shl 4;
  DH_check_ex_introduced = ((((((byte(1) shl 8) or byte(1)) shl 8) or byte(0)) shl 8) or byte(0)) shl 4;
  DH_check_pub_key_ex_introduced = ((((((byte(1) shl 8) or byte(1)) shl 8) or byte(0)) shl 8) or byte(0)) shl 4;
  DH_check_params_introduced = ((((((byte(1) shl 8) or byte(1)) shl 8) or byte(0)) shl 8) or byte(0)) shl 4;
  DH_new_by_nid_introduced = ((((((byte(1) shl 8) or byte(1)) shl 8) or byte(0)) shl 8) or byte(0)) shl 4;
  DH_get_nid_introduced = ((((((byte(1) shl 8) or byte(1)) shl 8) or byte(0)) shl 8) or byte(0)) shl 4;
  DH_get0_pqg_introduced = ((((((byte(1) shl 8) or byte(1)) shl 8) or byte(0)) shl 8) or byte(0)) shl 4;
  DH_set0_pqg_introduced = ((((((byte(1) shl 8) or byte(1)) shl 8) or byte(0)) shl 8) or byte(0)) shl 4;
  DH_get0_key_introduced = ((((((byte(1) shl 8) or byte(1)) shl 8) or byte(0)) shl 8) or byte(0)) shl 4;
  DH_set0_key_introduced = ((((((byte(1) shl 8) or byte(1)) shl 8) or byte(0)) shl 8) or byte(0)) shl 4;
  DH_get0_p_introduced = ((((((byte(1) shl 8) or byte(1)) shl 8) or byte(0)) shl 8) or byte(0)) shl 4;
  DH_get0_q_introduced = ((((((byte(1) shl 8) or byte(1)) shl 8) or byte(0)) shl 8) or byte(0)) shl 4;
  DH_get0_g_introduced = ((((((byte(1) shl 8) or byte(1)) shl 8) or byte(0)) shl 8) or byte(0)) shl 4;
  DH_get0_priv_key_introduced = ((((((byte(1) shl 8) or byte(1)) shl 8) or byte(0)) shl 8) or byte(0)) shl 4;
  DH_get0_pub_key_introduced = ((((((byte(1) shl 8) or byte(1)) shl 8) or byte(0)) shl 8) or byte(0)) shl 4;
  DH_clear_flags_introduced = ((((((byte(1) shl 8) or byte(1)) shl 8) or byte(0)) shl 8) or byte(0)) shl 4;
  DH_test_flags_introduced = ((((((byte(1) shl 8) or byte(1)) shl 8) or byte(0)) shl 8) or byte(0)) shl 4;
  DH_set_flags_introduced = ((((((byte(1) shl 8) or byte(1)) shl 8) or byte(0)) shl 8) or byte(0)) shl 4;
  DH_get0_engine_introduced = ((((((byte(1) shl 8) or byte(1)) shl 8) or byte(0)) shl 8) or byte(0)) shl 4;
  DH_get_length_introduced = ((((((byte(1) shl 8) or byte(1)) shl 8) or byte(0)) shl 8) or byte(0)) shl 4;
  DH_set_length_introduced = ((((((byte(1) shl 8) or byte(1)) shl 8) or byte(0)) shl 8) or byte(0)) shl 4;
  DH_meth_new_introduced = ((((((byte(1) shl 8) or byte(1)) shl 8) or byte(0)) shl 8) or byte(0)) shl 4;
  DH_meth_free_introduced = ((((((byte(1) shl 8) or byte(1)) shl 8) or byte(0)) shl 8) or byte(0)) shl 4;
  DH_meth_dup_introduced = ((((((byte(1) shl 8) or byte(1)) shl 8) or byte(0)) shl 8) or byte(0)) shl 4;
  DH_meth_get0_name_introduced = ((((((byte(1) shl 8) or byte(1)) shl 8) or byte(0)) shl 8) or byte(0)) shl 4;
  DH_meth_set1_name_introduced = ((((((byte(1) shl 8) or byte(1)) shl 8) or byte(0)) shl 8) or byte(0)) shl 4;
  DH_meth_get_flags_introduced = ((((((byte(1) shl 8) or byte(1)) shl 8) or byte(0)) shl 8) or byte(0)) shl 4;
  DH_meth_set_flags_introduced = ((((((byte(1) shl 8) or byte(1)) shl 8) or byte(0)) shl 8) or byte(0)) shl 4;
  DH_meth_get0_app_data_introduced = ((((((byte(1) shl 8) or byte(1)) shl 8) or byte(0)) shl 8) or byte(0)) shl 4;
  DH_meth_set0_app_data_introduced = ((((((byte(1) shl 8) or byte(1)) shl 8) or byte(0)) shl 8) or byte(0)) shl 4;
  DH_meth_get_generate_key_introduced = ((((((byte(1) shl 8) or byte(1)) shl 8) or byte(0)) shl 8) or byte(0)) shl 4;
  DH_meth_set_generate_key_introduced = ((((((byte(1) shl 8) or byte(1)) shl 8) or byte(0)) shl 8) or byte(0)) shl 4;
  DH_meth_get_compute_key_introduced = ((((((byte(1) shl 8) or byte(1)) shl 8) or byte(0)) shl 8) or byte(0)) shl 4;
  DH_meth_set_compute_key_introduced = ((((((byte(1) shl 8) or byte(1)) shl 8) or byte(0)) shl 8) or byte(0)) shl 4;
  DH_meth_get_bn_mod_exp_introduced = ((((((byte(1) shl 8) or byte(1)) shl 8) or byte(0)) shl 8) or byte(0)) shl 4;
  DH_meth_set_bn_mod_exp_introduced = ((((((byte(1) shl 8) or byte(1)) shl 8) or byte(0)) shl 8) or byte(0)) shl 4;
  DH_meth_get_init_introduced = ((((((byte(1) shl 8) or byte(1)) shl 8) or byte(0)) shl 8) or byte(0)) shl 4;
  DH_meth_set_init_introduced = ((((((byte(1) shl 8) or byte(1)) shl 8) or byte(0)) shl 8) or byte(0)) shl 4;
  DH_meth_get_finish_introduced = ((((((byte(1) shl 8) or byte(1)) shl 8) or byte(0)) shl 8) or byte(0)) shl 4;
  DH_meth_set_finish_introduced = ((((((byte(1) shl 8) or byte(1)) shl 8) or byte(0)) shl 8) or byte(0)) shl 4;
  DH_meth_get_generate_params_introduced = ((((((byte(1) shl 8) or byte(1)) shl 8) or byte(0)) shl 8) or byte(0)) shl 4;
  DH_meth_set_generate_params_introduced = ((((((byte(1) shl 8) or byte(1)) shl 8) or byte(0)) shl 8) or byte(0)) shl 4;
