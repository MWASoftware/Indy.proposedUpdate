...
var
  ...
  EC_GROUP_order_bits: function (const group: PEC_GROUP): TOpenSSL_C_INT; cdecl = nil; {introduced 1.1.0 }
  ...
  EC_GROUP_set_curve: function (group: PEC_GROUP; const p: PBIGNUM; const a: PBIGNUM; const b: PBIGNUM; ctx: PBN_CTX): TOpenSSL_C_INT; cdecl = nil; {introduced 1.1.0 }
  EC_GROUP_get_curve: function (const group: PEC_GROUP; p: PBIGNUM; a: PBIGNUM; b: PBIGNUM; ctx: PBN_CTX): TOpenSSL_C_INT; cdecl = nil; {introduced 1.1.0 }
  ...
  EC_POINT_set_affine_coordinates: function (const group: PEC_GROUP; p: PEC_POINT; const x: PBIGNUM; const y: PBIGNUM; ctx: PBN_CTX): TOpenSSL_C_INT; cdecl = nil; {introduced 1.1.0 }
  EC_POINT_get_affine_coordinates: function (const group: PEC_GROUP; const p: PEC_POINT; x: PBIGNUM; y: PBIGNUM; ctx: PBN_CTX): TOpenSSL_C_INT; cdecl = nil; {introduced 1.1.0 }
  ...
  EC_POINT_set_compressed_coordinates: function (const group: PEC_GROUP; p: PEC_POINT; x: PBIGNUM; y_bit: TOpenSSL_C_INT; ctx: PBN_CTX): TOpenSSL_C_INT; cdecl = nil; {introduced 1.1.0 }
  ...
  EC_POINT_point2buf: function (const group: PEC_GROUP; const point: PEC_POINT; form: point_conversion_form_t; pbuf: PPByte; ctx: PBN_CTX): TOpenSSL_C_SIZET; cdecl = nil; {introduced 1.1.0 }
  ...
  EC_KEY_set_ex_data: function (key: PEC_KEY; idx: TOpenSSL_C_INT; arg: Pointer): TOpenSSL_C_INT; cdecl = nil; {introduced 1.1.0 }
  EC_KEY_get_ex_data: function (const key: PEC_KEY; idx: TOpenSSL_C_INT): Pointer; cdecl = nil; {introduced 1.1.0 }
  ...
  EC_KEY_can_sign: function (const eckey: PEC_KEY): TOpenSSL_C_INT; cdecl = nil; {introduced 1.1.0 }
  EC_KEY_set_public_key_affine_coordinates: function (key: PEC_KEY; x: PBIGNUM; y: PBIGNUM): TOpenSSL_C_INT; cdecl = nil;
  EC_KEY_key2buf: function (const key: PEC_KEY; form: point_conversion_form_t; pbuf: PPByte; ctx: PBN_CTX): TOpenSSL_C_SIZET; cdecl = nil; {introduced 1.1.0 }
  EC_KEY_oct2key: function (key: PEC_KEY; const buf: PByte; len: TOpenSSL_C_SIZET; ctx: PBN_CTX): TOpenSSL_C_INT; cdecl = nil; {introduced 1.1.0 }
  EC_KEY_oct2priv: function (key: PEC_KEY; const buf: PByte; len: TOpenSSL_C_SIZET): TOpenSSL_C_INT; cdecl = nil; {introduced 1.1.0 }
  EC_KEY_priv2oct: function (const key: PEC_KEY; buf: PByte; len: TOpenSSL_C_SIZET): TOpenSSL_C_SIZET; cdecl = nil; {introduced 1.1.0 }
  EC_KEY_priv2buf: function (const eckey: PEC_KEY; buf: PPByte): TOpenSSL_C_SIZET; cdecl = nil; {introduced 1.1.0 }
  ...
  EC_KEY_set_method: function (key: PEC_KEY; const meth: PEC_KEY_METHOD): TOpenSSL_C_INT; cdecl = nil; {introduced 1.1.0 }
  ...
  ECDSA_SIG_set0: function (sig: PECDSA_SIG; r: PBIGNUM; s: PBIGNUM): TOpenSSL_C_INT; cdecl = nil; {introduced 1.1.0 }
...
function ERROR_EC_GFp_nistp224_method: PEC_METHOD; cdecl;
begin
  EOpenSSLAPIFunctionNotPresent.RaiseException('EC_GFp_nistp224_method');
end;

function ERROR_EC_GFp_nistp256_method: PEC_METHOD; cdecl;
begin
  EOpenSSLAPIFunctionNotPresent.RaiseException('EC_GFp_nistp256_method');
end;

function ERROR_EC_GFp_nistp521_method: PEC_METHOD; cdecl;
begin
