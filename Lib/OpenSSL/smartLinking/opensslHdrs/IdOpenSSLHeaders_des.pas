...
{$ENDIF}
const
  DES_ecb2_encrypt_removed = ((((((byte(1) shl 8) or byte(0)) shl 8) or byte(0)) shl 8) or byte(0)) shl 4;
  DES_ede2_cbc_encrypt_removed = ((((((byte(1) shl 8) or byte(0)) shl 8) or byte(0)) shl 8) or byte(0)) shl 4;
  DES_ede2_cfb64_encrypt_removed = ((((((byte(1) shl 8) or byte(0)) shl 8) or byte(0)) shl 8) or byte(0)) shl 4;
  DES_ede2_ofb64_encrypt_removed = ((((((byte(1) shl 8) or byte(0)) shl 8) or byte(0)) shl 8) or byte(0)) shl 4;
  DES_fixup_key_parity_removed = ((((((byte(1) shl 8) or byte(0)) shl 8) or byte(0)) shl 8) or byte(0)) shl 4;
...
procedure ERROR_DES_ecb2_encrypt(input:Pconst_DES_cblock; output:PDES_cblock; ks1:PDES_key_schedule; ks2:PDES_key_schedule; enc:longint); cdecl;
begin
...
{$IFDEF OPENSSL_NO_LEGACY_SUPPORT}
procedure ERROR_DES_ede2_cbc_encrypt(input:Pbyte; output:Pbyte; length:longint; ks1:PDES_key_schedule; ks2:PDES_key_schedule; ivec:PDES_cblock; enc:longint); cdecl;
begin
...
{$IFDEF OPENSSL_NO_LEGACY_SUPPORT}
procedure ERROR_DES_ede2_cfb64_encrypt(in_:Pbyte; out_:Pbyte; length:longint; ks1:PDES_key_schedule; ks2:PDES_key_schedule; ivec:PDES_cblock; num:Plongint; enc:longint); cdecl;
begin
...
{$IFDEF OPENSSL_NO_LEGACY_SUPPORT}
procedure ERROR_DES_ede2_ofb64_encrypt(in_:Pbyte; out_:Pbyte; length:longint; ks1:PDES_key_schedule; ks2:PDES_key_schedule; ivec:PDES_cblock; num:Plongint); cdecl;
begin
...
procedure ERROR_DES_set_odd_parity(key:PDES_cblock); cdecl;
begin
...
function ERROR_DES_set_key(key:Pconst_DES_cblock; var schedule: DES_key_schedule): longint; cdecl;
begin
...
{$IFDEF OPENSSL_NO_LEGACY_SUPPORT}
procedure ERROR_DES_fixup_key_parity(key: PDES_cblock); cdecl;
begin
...
{$ENDIF} //of OPENSSL_NO_LEGACY_SUPPORT
  ...
  if FuncLoadError then
  begin
    DES_set_odd_parity :=  @ERROR_DES_set_odd_parity;
  end;
