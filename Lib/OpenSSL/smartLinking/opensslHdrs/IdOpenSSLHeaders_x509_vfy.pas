...
var
  ...
  X509_OBJECT_set1_X509: function (a: PX509_OBJECT; obj: PX509): TOpenSSL_C_INT; cdecl = nil; {introduced 1.1.0 }
  X509_OBJECT_get0_X509_CRL: function (a: PX509_OBJECT): PX509_CRL; cdecl = nil; {introduced 1.1.0 }
  X509_OBJECT_set1_X509_CRL: function (a: PX509_OBJECT; obj: PX509_CRL): TOpenSSL_C_INT; cdecl = nil; {introduced 1.1.0 }
  X509_STORE_new: function : PX509_STORE; cdecl = nil;
  X509_STORE_free: procedure (v: PX509_STORE); cdecl = nil;
  X509_STORE_lock: function (ctx: PX509_STORE): TOpenSSL_C_INT; cdecl = nil; {introduced 1.1.0 }
  X509_STORE_unlock: function (ctx: PX509_STORE): TOpenSSL_C_INT; cdecl = nil; {introduced 1.1.0 }
  X509_STORE_up_ref: function (v: PX509_STORE): TOpenSSL_C_INT; cdecl = nil; {introduced 1.1.0 }
  ...
  X509_STORE_set_ex_data: function (ctx: PX509_STORE; idx: TOpenSSL_C_INT; data: Pointer): TOpenSSL_C_INT; cdecl = nil; {introduced 1.1.0 }
  X509_STORE_get_ex_data: function (ctx: PX509_STORE; idx: TOpenSSL_C_INT): Pointer; cdecl = nil; {introduced 1.1.0 }
  ...
  X509_LOOKUP_meth_new: function (const name: PAnsiChar): PX509_LOOKUP_METHOD; cdecl = nil; {introduced 1.1.0 }
  X509_LOOKUP_meth_free: procedure (method: PX509_LOOKUP_METHOD); cdecl = nil; {introduced 1.1.0 }
  X509_LOOKUP_meth_set_ctrl: function (method: PX509_LOOKUP_METHOD; ctrl_fn: X509_LOOKUP_ctrl_fn): TOpenSSL_C_INT; cdecl = nil; {introduced 1.1.0 }
  X509_LOOKUP_meth_get_ctrl: function (const method: PX509_LOOKUP_METHOD): X509_LOOKUP_ctrl_fn; cdecl = nil; {introduced 1.1.0 }
  X509_LOOKUP_meth_set_get_by_subject: function (method: PX509_LOOKUP_METHOD; fn: X509_LOOKUP_get_by_subject_fn): TOpenSSL_C_INT; cdecl = nil; {introduced 1.1.0 }
  ...
  X509_LOOKUP_meth_set_get_by_issuer_serial: function (method: PX509_LOOKUP_METHOD; fn: X509_LOOKUP_get_by_issuer_serial_fn): TOpenSSL_C_INT; cdecl = nil; {introduced 1.1.0 }
  ...
  X509_LOOKUP_meth_set_get_by_fingerprint: function (method: PX509_LOOKUP_METHOD; fn: X509_LOOKUP_get_by_fingerprint_fn): TOpenSSL_C_INT; cdecl = nil; {introduced 1.1.0 }
  ...
  X509_LOOKUP_meth_set_get_by_alias: function (method: PX509_LOOKUP_METHOD; fn: X509_LOOKUP_get_by_alias_fn): TOpenSSL_C_INT; cdecl = nil; {introduced 1.1.0 }
  ...
  X509_STORE_CTX_get_by_subject: function (vs: PX509_STORE_CTX; type_: X509_LOOKUP_TYPE; name: PX509_NAME; ret: PX509_OBJECT): TOpenSSL_C_INT; cdecl = nil; {introduced 1.1.0 }
  ...
  X509_LOOKUP_set_method_data: function (ctx: PX509_LOOKUP; data: Pointer): TOpenSSL_C_INT; cdecl = nil; {introduced 1.1.0 }
  ...
  X509_STORE_CTX_set_error_depth: procedure (ctx: PX509_STORE_CTX; depth: TOpenSSL_C_INT); cdecl = nil; {introduced 1.1.0 }
  ...
  X509_STORE_CTX_get_num_untrusted: function (ctx: PX509_STORE_CTX): TOpenSSL_C_INT; cdecl = nil; {introduced 1.1.0 }
  ...
  X509_VERIFY_PARAM_set_auth_level: procedure (param: PX509_VERIFY_PARAM; auth_level: TOpenSSL_C_INT); cdecl = nil; {introduced 1.1.0 }
  X509_VERIFY_PARAM_add0_policy: function (param: PX509_VERIFY_PARAM; policy: PASN1_OBJECT): TOpenSSL_C_INT; cdecl = nil;
  X509_VERIFY_PARAM_set_inh_flags: function (param: PX509_VERIFY_PARAM; flags: TOpenSSL_C_UINT32): TOpenSSL_C_INT; cdecl = nil; {introduced 1.1.0 }
  X509_VERIFY_PARAM_get_inh_flags: function (const param: PX509_VERIFY_PARAM): TOpenSSL_C_UINT32; cdecl = nil; {introduced 1.1.0 }
  ...
  X509_VERIFY_PARAM_get_hostflags: function (const param: PX509_VERIFY_PARAM): TOpenSSL_C_UINT; cdecl = nil; {introduced 1.1.0 }
  ...
  X509_VERIFY_PARAM_get_auth_level: function (const param: PX509_VERIFY_PARAM): TOpenSSL_C_INT; cdecl = nil; {introduced 1.1.0 }
...
function ERROR_X509_STORE_CTX_get_app_data(ctx: PX509_STORE_CTX): Pointer; cdecl;
begin
