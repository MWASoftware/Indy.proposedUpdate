...
{$ELSE}
var
  PKCS12_mac_present: function (const p12: PPKCS12): TOpenSSL_C_INT; cdecl = nil; {introduced 1.1.0 }
  ...
  PKCS12_SAFEBAG_get0_attr: function (const bag: PPKCS12_SAFEBAG; attr_nid: TOpenSSL_C_INT): PASN1_TYPE; cdecl = nil; {introduced 1.1.0 }
  PKCS12_SAFEBAG_get0_type: function (const bag: PPKCS12_SAFEBAG): PASN1_OBJECT; cdecl = nil; {introduced 1.1.0 }
  PKCS12_SAFEBAG_get_nid: function (const bag: PPKCS12_SAFEBAG): TOpenSSL_C_INT; cdecl = nil; {introduced 1.1.0 }
  PKCS12_SAFEBAG_get_bag_nid: function (const bag: PPKCS12_SAFEBAG): TOpenSSL_C_INT; cdecl = nil; {introduced 1.1.0 }
  ...
  PKCS12_SAFEBAG_create_pkcs8_encrypt: function (pbe_nid: TOpenSSL_C_INT; const pass: PAnsiChar; passlen: TOpenSSL_C_INT; salt: PByte; saltlen: TOpenSSL_C_INT; iter: TOpenSSL_C_INT; p8inf: PPKCS8_PRIV_KEY_INFO): PPKCS12_SAFEBAG; cdecl = nil; {introduced 1.1.0 }
  ...
  PKCS8_set0_pbe: function (const pass: PAnsiChar; passlen: TOpenSSL_C_INT; p8inf: PPKCS8_PRIV_KEY_INFO; pbe: PX509_ALGOR): PX509_SIG; cdecl = nil; {introduced 1.1.0 }
  ...
  PKCS12_add_friendlyname_utf8: function (bag: PPKCS12_SAFEBAG; const name: PAnsiChar; namelen: TOpenSSL_C_INT): TOpenSSL_C_INT; cdecl = nil; {introduced 1.1.0 }
  ...
  PKCS12_key_gen_utf8: function (const pass: PAnsiChar; passlen: TOpenSSL_C_INT; salt: PByte; saltlen: TOpenSSL_C_INT; id: TOpenSSL_C_INT; iter: TOpenSSL_C_INT; n: TOpenSSL_C_INT; out_: PByte; const md_type: PEVP_MD): TOpenSSL_C_INT; cdecl = nil; {introduced 1.1.0 }
  ...
  OPENSSL_utf82uni: function (const asc: PAnsiChar; asclen: TOpenSSL_C_INT; uni: PPByte; unilen: POpenSSL_C_INT): PByte; cdecl = nil; {introduced 1.1.0 }
  OPENSSL_uni2utf8: function (const uni: PByte; unilen: TOpenSSL_C_INT): PAnsiChar; cdecl = nil; {introduced 1.1.0 }
...
const
  ...
  PKCS12_get0_mac_introduced = ((((((byte(1) shl 8) or byte(1)) shl 8) or byte(0)) shl 8) or byte(0)) shl 4;
  PKCS12_SAFEBAG_get0_attr_introduced = ((((((byte(1) shl 8) or byte(1)) shl 8) or byte(0)) shl 8) or byte(0)) shl 4;
  PKCS12_SAFEBAG_get0_type_introduced = ((((((byte(1) shl 8) or byte(1)) shl 8) or byte(0)) shl 8) or byte(0)) shl 4;
  PKCS12_SAFEBAG_get_nid_introduced = ((((((byte(1) shl 8) or byte(1)) shl 8) or byte(0)) shl 8) or byte(0)) shl 4;
  PKCS12_SAFEBAG_get_bag_nid_introduced = ((((((byte(1) shl 8) or byte(1)) shl 8) or byte(0)) shl 8) or byte(0)) shl 4;
  PKCS12_SAFEBAG_get1_cert_introduced = ((((((byte(1) shl 8) or byte(1)) shl 8) or byte(0)) shl 8) or byte(0)) shl 4;
  PKCS12_SAFEBAG_get1_crl_introduced = ((((((byte(1) shl 8) or byte(1)) shl 8) or byte(0)) shl 8) or byte(0)) shl 4;
  PKCS12_SAFEBAG_get0_p8inf_introduced = ((((((byte(1) shl 8) or byte(1)) shl 8) or byte(0)) shl 8) or byte(0)) shl 4;
  PKCS12_SAFEBAG_get0_pkcs8_introduced = ((((((byte(1) shl 8) or byte(1)) shl 8) or byte(0)) shl 8) or byte(0)) shl 4;
  PKCS12_SAFEBAG_create_cert_introduced = ((((((byte(1) shl 8) or byte(1)) shl 8) or byte(0)) shl 8) or byte(0)) shl 4;
  PKCS12_SAFEBAG_create_crl_introduced = ((((((byte(1) shl 8) or byte(1)) shl 8) or byte(0)) shl 8) or byte(0)) shl 4;
  PKCS12_SAFEBAG_create0_p8inf_introduced = ((((((byte(1) shl 8) or byte(1)) shl 8) or byte(0)) shl 8) or byte(0)) shl 4;
  PKCS12_SAFEBAG_create0_pkcs8_introduced = ((((((byte(1) shl 8) or byte(1)) shl 8) or byte(0)) shl 8) or byte(0)) shl 4;
  PKCS12_SAFEBAG_create_pkcs8_encrypt_introduced = ((((((byte(1) shl 8) or byte(1)) shl 8) or byte(0)) shl 8) or byte(0)) shl 4;
  PKCS8_set0_pbe_introduced = ((((((byte(1) shl 8) or byte(1)) shl 8) or byte(0)) shl 8) or byte(0)) shl 4;
  PKCS12_add_friendlyname_utf8_introduced = ((((((byte(1) shl 8) or byte(1)) shl 8) or byte(0)) shl 8) or byte(0)) shl 4;
  PKCS12_key_gen_utf8_introduced = ((((((byte(1) shl 8) or byte(1)) shl 8) or byte(0)) shl 8) or byte(0)) shl 4;
  OPENSSL_utf82uni_introduced = ((((((byte(1) shl 8) or byte(1)) shl 8) or byte(0)) shl 8) or byte(0)) shl 4;
  OPENSSL_uni2utf8_introduced = ((((((byte(1) shl 8) or byte(1)) shl 8) or byte(0)) shl 8) or byte(0)) shl 4;
