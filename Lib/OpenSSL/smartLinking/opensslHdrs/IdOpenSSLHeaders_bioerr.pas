...
{$ELSE}
var
  ERR_load_BIO_strings: function : TOpenSSL_C_INT; cdecl = nil;
{$ENDIF}
...
{$WARN  NO_RETVAL OFF}
function ERROR_ERR_load_BIO_strings: TOpenSSL_C_INT; cdecl;
begin
...
begin
  ...
  begin
    ERR_load_BIO_strings :=  @ERROR_ERR_load_BIO_strings;
  end;
