...
var
  ...
  OBJ_length: function (const obj: PASN1_OBJECT): TOpenSSL_C_SIZET; cdecl = nil; {introduced 1.1.0 }
...
const
  ...
  OBJ_get0_data_introduced = ((((((byte(1) shl 8) or byte(1)) shl 8) or byte(0)) shl 8) or byte(0)) shl 4;
