(* This unit was generated from the source file sslerr.h2pas 
It should not be modified directly. All changes should be made to sslerr.h2pas
...
function ERR_load_SSL_strings: TOpenSSL_C_INT; cdecl; external CLibSSL;

{$ELSE}
var
  ERR_load_SSL_strings: function : TOpenSSL_C_INT; cdecl = nil;
{$ENDIF}
...
{$WARN  NO_RETVAL OFF}
function ERROR_ERR_load_SSL_strings: TOpenSSL_C_INT; cdecl;
begin
...
begin
  ERR_load_SSL_strings := LoadLibSSLFunction('ERR_load_SSL_strings');
  FuncLoadError := not assigned(ERR_load_SSL_strings);
  if FuncLoadError then
  begin
    ERR_load_SSL_strings :=  @ERROR_ERR_load_SSL_strings;
  end;
