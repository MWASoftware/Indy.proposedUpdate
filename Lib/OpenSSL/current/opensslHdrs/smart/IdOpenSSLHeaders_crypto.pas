...
function OPENSSL_malloc(num: TOpenSSL_C_SIZET): Pointer; cdecl;
function OPENSSL_zalloc(num: TOpenSSL_C_SIZET): Pointer; cdecl;
function OPENSSL_realloc(addr: Pointer; num: TOpenSSL_C_SIZET): Pointer; cdecl;
function OPENSSL_clear_realloc(addr: Pointer; old_num: TOpenSSL_C_SIZET; num: TOpenSSL_C_SIZET): Pointer; cdecl;
procedure OPENSSL_clear_free(addr: Pointer; num: TOpenSSL_C_SIZET); cdecl;
procedure OPENSSL_free(addr: Pointer); cdecl;
function OPENSSL_memdup(const str: Pointer; s: TOpenSSL_C_SIZET): Pointer; cdecl;
function OPENSSL_strdup(const str: PAnsiChar): PAnsiChar; cdecl;
function OPENSSL_strndup(const str: PAnsiChar; n: TOpenSSL_C_SIZET): PAnsiChar; cdecl;
function OPENSSL_secure_malloc(num: TOpenSSL_C_SIZET): Pointer; cdecl;
function OPENSSL_secure_zalloc(num: TOpenSSL_C_SIZET): Pointer; cdecl;
procedure OPENSSL_secure_free(addr: Pointer); cdecl;
procedure OPENSSL_secure_clear_free(addr: Pointer; num: TOpenSSL_C_SIZET); cdecl;
function OPENSSL_secure_actual_size(ptr: Pointer): TOpenSSL_C_SIZET; cdecl;
function CRYPTO_num_locks: TOpenSSL_C_INT; cdecl;
procedure CRYPTO_set_locking_callback(func: TIdSslLockingCallback); cdecl;
procedure CRYPTO_THREADID_set_numeric(id : PCRYPTO_THREADID; val: TOpenSSL_C_ULONG); cdecl;
procedure CRYPTO_THREADID_set_callback(threadid_func: Tthreadid_func); cdecl;
procedure CRYPTO_set_id_callback(func: TIdSslIdCallback); cdecl;
function FIPS_mode: TOpenSSL_C_INT; cdecl;
function FIPS_mode_set(r: TOpenSSL_C_INT): TOpenSSL_C_INT; cdecl;
function SSLeay_version(type_ : TOpenSSL_C_INT): PAnsiChar; cdecl;
function SSLeay: TOpenSSL_C_ULONG; cdecl;
{$ENDIF} { End of OPENSSL_NO_LEGACY_SUPPORT}
{$ELSE}
var
  CRYPTO_THREAD_lock_new: function : PCRYPTO_RWLOCK; cdecl = nil; {introduced 1.1.0 }
  CRYPTO_THREAD_read_lock: function (lock: PCRYPTO_RWLOCK): TOpenSSL_C_INT; cdecl = nil; {introduced 1.1.0 }
  CRYPTO_THREAD_write_lock: function (lock: PCRYPTO_RWLOCK): TOpenSSL_C_INT; cdecl = nil; {introduced 1.1.0 }
  CRYPTO_THREAD_unlock: function (lock: PCRYPTO_RWLOCK): TOpenSSL_C_INT; cdecl = nil; {introduced 1.1.0 }
  CRYPTO_THREAD_lock_free: procedure (lock: PCRYPTO_RWLOCK); cdecl = nil; {introduced 1.1.0 }
  CRYPTO_atomic_add: function (val: POpenSSL_C_INT; amount: TOpenSSL_C_INT; ret: POpenSSL_C_INT; lock: PCRYPTO_RWLOCK): TOpenSSL_C_INT; cdecl = nil; {introduced 1.1.0 }
  OPENSSL_strlcpy: function (dst: PAnsiChar; const src: PAnsiChar; siz: TOpenSSL_C_SIZET): TOpenSSL_C_SIZET; cdecl = nil; {introduced 1.1.0 }
  OPENSSL_strlcat: function (dst: PAnsiChar; const src: PAnsiChar; siz: TOpenSSL_C_SIZET): TOpenSSL_C_SIZET; cdecl = nil; {introduced 1.1.0 }
  OPENSSL_strnlen: function (const str: PAnsiChar; maxlen: TOpenSSL_C_SIZET): TOpenSSL_C_SIZET; cdecl = nil; {introduced 1.1.0 }
  OPENSSL_buf2hexstr: function (const buffer: PByte; len: TOpenSSL_C_LONG): PAnsiChar; cdecl = nil; {introduced 1.1.0 }
  OPENSSL_hexstr2buf: function (const str: PAnsiChar; len: POpenSSL_C_LONG): PByte; cdecl = nil; {introduced 1.1.0 }
  OPENSSL_hexchar2int: function (c: Byte): TOpenSSL_C_INT; cdecl = nil; {introduced 1.1.0 }
  OpenSSL_version_num: function : TOpenSSL_C_ULONG; cdecl = nil; {introduced 1.1.0 }
  OpenSSL_version: function (type_: TOpenSSL_C_INT): PAnsiChar; cdecl = nil; {introduced 1.1.0 }
  ...
  CRYPTO_zalloc: function (num: TOpenSSL_C_SIZET; const file_: PAnsiChar; line: TOpenSSL_C_INT): Pointer; cdecl = nil; {introduced 1.1.0 }
  CRYPTO_memdup: function (const str: Pointer; siz: TOpenSSL_C_SIZET; const file_: PAnsiChar; line: TOpenSSL_C_INT): Pointer; cdecl = nil; {introduced 1.1.0 }
  CRYPTO_strdup: function (const str: PAnsiChar; const file_: PAnsiChar; line: TOpenSSL_C_INT): PAnsiChar; cdecl = nil;
  CRYPTO_strndup: function (const str: PAnsiChar; s: TOpenSSL_C_SIZET; const file_: PAnsiChar; line: TOpenSSL_C_INT): PAnsiChar; cdecl = nil; {introduced 1.1.0 }
  CRYPTO_free: procedure (ptr: Pointer; const file_: PAnsiChar; line: TOpenSSL_C_INT); cdecl = nil;
  CRYPTO_clear_free: procedure (ptr: Pointer; num: TOpenSSL_C_SIZET; const file_: PAnsiChar; line: TOpenSSL_C_INT); cdecl = nil; {introduced 1.1.0 }
  CRYPTO_realloc: function (addr: Pointer; num: TOpenSSL_C_SIZET; const file_: PAnsiChar; line: TOpenSSL_C_INT): Pointer; cdecl = nil;
  CRYPTO_clear_realloc: function (addr: Pointer; old_num: TOpenSSL_C_SIZET; num: TOpenSSL_C_SIZET; const file_: PAnsiChar; line: TOpenSSL_C_INT): Pointer; cdecl = nil; {introduced 1.1.0 }
  CRYPTO_secure_malloc_init: function (sz: TOpenSSL_C_SIZET; minsize: TOpenSSL_C_INT): TOpenSSL_C_INT; cdecl = nil; {introduced 1.1.0 }
  CRYPTO_secure_malloc_done: function : TOpenSSL_C_INT; cdecl = nil; {introduced 1.1.0 }
  CRYPTO_secure_malloc: function (num: TOpenSSL_C_SIZET; const file_: PAnsiChar; line: TOpenSSL_C_INT): Pointer; cdecl = nil; {introduced 1.1.0 }
  CRYPTO_secure_zalloc: function (num: TOpenSSL_C_SIZET; const file_: PAnsiChar; line: TOpenSSL_C_INT): Pointer; cdecl = nil; {introduced 1.1.0 }
  CRYPTO_secure_free: procedure (ptr: Pointer; const file_: PAnsiChar; line: TOpenSSL_C_INT); cdecl = nil; {introduced 1.1.0 }
  CRYPTO_secure_clear_free: procedure (ptr: Pointer; num: TOpenSSL_C_SIZET; const file_: PAnsiChar; line: TOpenSSL_C_INT); cdecl = nil; {introduced 1.1.0 }
  CRYPTO_secure_allocated: function (const ptr: Pointer): TOpenSSL_C_INT; cdecl = nil; {introduced 1.1.0 }
  CRYPTO_secure_malloc_initialized: function : TOpenSSL_C_INT; cdecl = nil; {introduced 1.1.0 }
  CRYPTO_secure_actual_size: function (ptr: Pointer): TOpenSSL_C_SIZET; cdecl = nil; {introduced 1.1.0 }
  CRYPTO_secure_used: function : TOpenSSL_C_SIZET; cdecl = nil; {introduced 1.1.0 }
  ...
  OPENSSL_init_crypto: function (opts: TOpenSSL_C_UINT64; const settings: POPENSSL_INIT_SETTINGS): TOpenSSL_C_INT; cdecl = nil; {introduced 1.1.0 }
  ...
  CRYPTO_THREAD_run_once: function (once: PCRYPTO_ONCE; init: CRYPTO_THREAD_run_once_init): TOpenSSL_C_INT; cdecl = nil; {introduced 1.1.0 }
  CRYPTO_THREAD_get_local: function (key: PCRYPTO_THREAD_LOCAL): Pointer; cdecl = nil; {introduced 1.1.0 }
  CRYPTO_THREAD_set_local: function (key: PCRYPTO_THREAD_LOCAL; val: Pointer): TOpenSSL_C_INT; cdecl = nil; {introduced 1.1.0 }
  CRYPTO_THREAD_cleanup_local: function (key: PCRYPTO_THREAD_LOCAL): TOpenSSL_C_INT; cdecl = nil; {introduced 1.1.0 }
  CRYPTO_THREAD_get_current_id: function : CRYPTO_THREAD_ID; cdecl = nil; {introduced 1.1.0 }
  CRYPTO_THREAD_compare_id: function (a: CRYPTO_THREAD_ID; b: CRYPTO_THREAD_ID): TOpenSSL_C_INT; cdecl = nil; {introduced 1.1.0 }
...
function CRYPTO_num_locks: TOpenSSL_C_INT;
...
procedure CRYPTO_THREADID_set_numeric(id : PCRYPTO_THREADID; val: TOpenSSL_C_ULONG);
...
var
  ...
  CRYPTO_set_mem_debug: function (flag: TOpenSSL_C_INT): TOpenSSL_C_INT; cdecl = nil; {introduced 1.1.0 removed 3.0.0}
...
function COMPAT_CRYPTO_num_locks: TOpenSSL_C_INT; cdecl;
...
procedure COMPAT_CRYPTO_set_locking_callback; cdecl;
...
procedure COMPAT_CRYPTO_set_id_callback(func: TIdSslIdCallback); cdecl;
...
procedure COMPAT_CRYPTO_THREADID_set_numeric(id : PCRYPTO_THREADID; val: TOpenSSL_C_ULONG); cdecl;
...
procedure COMPAT_CRYPTO_THREADID_set_callback(threadid_func: Tthreadid_func); cdecl;
...
{$IFDEF OPENSSL_NO_LEGACY_SUPPORT}
function ERROR_OPENSSL_zalloc(num: TOpenSSL_C_SIZET): Pointer; cdecl;
begin
...
{$IFDEF OPENSSL_NO_LEGACY_SUPPORT}
function ERROR_OPENSSL_realloc(addr: Pointer; num: TOpenSSL_C_SIZET): Pointer; cdecl;
begin
...
{$IFDEF OPENSSL_NO_LEGACY_SUPPORT}
function ERROR_OPENSSL_clear_realloc(addr: Pointer; old_num: TOpenSSL_C_SIZET; num: TOpenSSL_C_SIZET): Pointer; cdecl;
begin
...
{$IFDEF OPENSSL_NO_LEGACY_SUPPORT}
procedure ERROR_OPENSSL_clear_free(addr: Pointer; num: TOpenSSL_C_SIZET); cdecl;
begin
...
{$IFDEF OPENSSL_NO_LEGACY_SUPPORT}
procedure ERROR_OPENSSL_free(addr: Pointer); cdecl;
begin
...
{$IFDEF OPENSSL_NO_LEGACY_SUPPORT}
function ERROR_OPENSSL_memdup(const str: Pointer; s: TOpenSSL_C_SIZET): Pointer; cdecl;
begin
...
{$IFDEF OPENSSL_NO_LEGACY_SUPPORT}
function ERROR_OPENSSL_strdup(const str: PAnsiChar): PAnsiChar; cdecl;
begin
...
{$IFDEF OPENSSL_NO_LEGACY_SUPPORT}
function ERROR_OPENSSL_strndup(const str: PAnsiChar; n: TOpenSSL_C_SIZET): PAnsiChar; cdecl;
begin
...
{$IFDEF OPENSSL_NO_LEGACY_SUPPORT}
function ERROR_OPENSSL_secure_malloc(num: TOpenSSL_C_SIZET): Pointer; cdecl;
begin
...
{$IFDEF OPENSSL_NO_LEGACY_SUPPORT}
function ERROR_OPENSSL_secure_zalloc(num: TOpenSSL_C_SIZET): Pointer; cdecl;
begin
...
{$IFDEF OPENSSL_NO_LEGACY_SUPPORT}
procedure ERROR_OPENSSL_secure_free(addr: Pointer); cdecl;
begin
...
{$IFDEF OPENSSL_NO_LEGACY_SUPPORT}
procedure ERROR_OPENSSL_secure_clear_free(addr: Pointer; num: TOpenSSL_C_SIZET); cdecl;
begin
...
{$IFDEF OPENSSL_NO_LEGACY_SUPPORT}
function ERROR_OPENSSL_secure_actual_size(ptr: Pointer): TOpenSSL_C_SIZET; cdecl;
begin
...
function ERROR_CRYPTO_mem_ctrl(mode: TOpenSSL_C_INT): TOpenSSL_C_INT; cdecl;
begin
...
{$IFDEF OPENSSL_NO_LEGACY_SUPPORT}
function ERROR_CRYPTO_num_locks: TOpenSSL_C_INT; cdecl;
begin
...
{$IFDEF OPENSSL_NO_LEGACY_SUPPORT}
procedure ERROR_CRYPTO_set_locking_callback(func: TIdSslLockingCallback); cdecl;
begin
...
{$IFDEF OPENSSL_NO_LEGACY_SUPPORT}
procedure ERROR_CRYPTO_THREADID_set_numeric(id : PCRYPTO_THREADID; val: TOpenSSL_C_ULONG); cdecl;
begin
...
{$IFDEF OPENSSL_NO_LEGACY_SUPPORT}
procedure ERROR_CRYPTO_THREADID_set_callback(threadid_func: Tthreadid_func); cdecl;
begin
...
{$IFDEF OPENSSL_NO_LEGACY_SUPPORT}
procedure ERROR_CRYPTO_set_id_callback(func: TIdSslIdCallback); cdecl;
begin
...
function ERROR_CRYPTO_set_mem_debug(flag: TOpenSSL_C_INT): TOpenSSL_C_INT; cdecl;
begin
...
{$IFDEF OPENSSL_NO_LEGACY_SUPPORT}
function ERROR_FIPS_mode: TOpenSSL_C_INT; cdecl;
begin
...
{$IFDEF OPENSSL_NO_LEGACY_SUPPORT}
function ERROR_FIPS_mode_set(r: TOpenSSL_C_INT): TOpenSSL_C_INT; cdecl;
begin
...
{$IFDEF OPENSSL_NO_LEGACY_SUPPORT}
function ERROR_SSLeay_version(type_ : TOpenSSL_C_INT): PAnsiChar; cdecl;
begin
...
{$IFDEF OPENSSL_NO_LEGACY_SUPPORT}
function ERROR_SSLeay: TOpenSSL_C_ULONG; cdecl;
begin
...
{$IFNDEF OPENSSL_NO_LEGACY_SUPPORT}
  ...
  if FuncLoadError then
  begin
    CRYPTO_num_locks := @COMPAT_CRYPTO_num_locks;
  ...
  if FuncLoadError then
  begin
    CRYPTO_set_locking_callback := @COMPAT_CRYPTO_set_locking_callback;
  ...
  if FuncLoadError then
  begin
    CRYPTO_THREADID_set_numeric := @COMPAT_CRYPTO_THREADID_set_numeric;
  ...
  if FuncLoadError then
  begin
    CRYPTO_THREADID_set_callback := @COMPAT_CRYPTO_THREADID_set_callback;
  ...
  if FuncLoadError then
  begin
    CRYPTO_set_id_callback := @COMPAT_CRYPTO_set_id_callback;
...
{$IFNDEF OPENSSL_NO_LEGACY_SUPPORT}
  ...
  if FuncLoadError then
  begin
    SSLeay_version := @COMPAT_SSLeay_version;
