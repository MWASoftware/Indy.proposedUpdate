...
{$ELSE}
var
  HMAC_size: function (const e: PHMAC_CTX): TOpenSSL_C_SIZET; cdecl = nil; {introduced 1.1.0 }
  HMAC_CTX_new: function : PHMAC_CTX; cdecl = nil; {introduced 1.1.0 }
  HMAC_CTX_reset: function (ctx: PHMAC_CTX): TOpenSSL_C_INT; cdecl = nil; {introduced 1.1.0 }
...
{$WARN  NO_RETVAL OFF}
procedure ERROR_HMAC_CTX_init(ctx : PHMAC_CTX); cdecl;
begin
...
procedure ERROR_HMAC_CTX_cleanup(ctx : PHMAC_CTX); cdecl;
begin
