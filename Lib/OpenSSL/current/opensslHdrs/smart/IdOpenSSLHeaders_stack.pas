...
function ERROR_sk_num(_para1:POPENSSL_STACK): longint; cdecl;
begin
  EOpenSSLAPIFunctionNotPresent.RaiseException('sk_num');
end;

function ERROR_sk_value(_para1:POPENSSL_STACK; _para2:longint): pointer; cdecl;
begin
  EOpenSSLAPIFunctionNotPresent.RaiseException('sk_value');
end;

function ERROR_sk_set(st:POPENSSL_STACK; i:longint; data:pointer): pointer; cdecl;
begin
  EOpenSSLAPIFunctionNotPresent.RaiseException('sk_set');
end;

function ERROR_sk_new(cmp:TOPENSSL_sk_compfunc): POPENSSL_STACK; cdecl;
begin
  EOpenSSLAPIFunctionNotPresent.RaiseException('sk_new');
end;

function ERROR_sk_new_null: POPENSSL_STACK; cdecl;
begin
  EOpenSSLAPIFunctionNotPresent.RaiseException('sk_new_null');
end;

function ERROR_sk_new_reserve(c:TOPENSSL_sk_compfunc; n:longint): POPENSSL_STACK; cdecl;
begin
  EOpenSSLAPIFunctionNotPresent.RaiseException('sk_new_reserve');
end;

function ERROR_sk_reserve(st:POPENSSL_STACK; n:longint): longint; cdecl;
begin
  EOpenSSLAPIFunctionNotPresent.RaiseException('sk_reserve');
end;

procedure ERROR_sk_free(_para1:POPENSSL_STACK); cdecl;
begin
  EOpenSSLAPIFunctionNotPresent.RaiseException('sk_free');
end;

procedure ERROR_sk_pop_free(st:POPENSSL_STACK; func:TOPENSSL_sk_freefunc); cdecl;
begin
  EOpenSSLAPIFunctionNotPresent.RaiseException('sk_pop_free');
end;

function ERROR_sk_deep_copy(_para1:POPENSSL_STACK; c:TOPENSSL_sk_copyfunc; f:TOPENSSL_sk_freefunc): POPENSSL_STACK; cdecl;
begin
  EOpenSSLAPIFunctionNotPresent.RaiseException('sk_deep_copy');
end;

function ERROR_sk_insert(sk:POPENSSL_STACK; data:pointer; where:longint): longint; cdecl;
begin
  EOpenSSLAPIFunctionNotPresent.RaiseException('sk_insert');
end;

function ERROR_sk_delete(st:POPENSSL_STACK; loc:longint): pointer; cdecl;
begin
  EOpenSSLAPIFunctionNotPresent.RaiseException('sk_delete');
end;

function ERROR_sk_delete_ptr(st:POPENSSL_STACK; p:pointer): pointer; cdecl;
begin
  EOpenSSLAPIFunctionNotPresent.RaiseException('sk_delete_ptr');
end;

function ERROR_sk_find(st:POPENSSL_STACK; data:pointer): longint; cdecl;
begin
  EOpenSSLAPIFunctionNotPresent.RaiseException('sk_find');
end;

function ERROR_sk_find_ex(st:POPENSSL_STACK; data:pointer): longint; cdecl;
begin
  EOpenSSLAPIFunctionNotPresent.RaiseException('sk_find_ex');
end;

function ERROR_sk_push(st:POPENSSL_STACK; data:pointer): longint; cdecl;
begin
  EOpenSSLAPIFunctionNotPresent.RaiseException('sk_push');
end;

function ERROR_sk_unshift(st:POPENSSL_STACK; data:pointer): longint; cdecl;
begin
  EOpenSSLAPIFunctionNotPresent.RaiseException('sk_unshift');
end;

function ERROR_sk_shift(st:POPENSSL_STACK): pointer; cdecl;
begin
  EOpenSSLAPIFunctionNotPresent.RaiseException('sk_shift');
end;

function ERROR_sk_pop(st:POPENSSL_STACK): pointer; cdecl;
begin
  EOpenSSLAPIFunctionNotPresent.RaiseException('sk_pop');
end;

procedure ERROR_sk_zero(st:POPENSSL_STACK); cdecl;
begin
  EOpenSSLAPIFunctionNotPresent.RaiseException('sk_zero');
end;

function ERROR_sk_set_cmp_func(sk:POPENSSL_STACK; cmp:TOPENSSL_sk_compfunc): TOPENSSL_sk_compfunc; cdecl;
begin
  EOpenSSLAPIFunctionNotPresent.RaiseException('sk_set_cmp_func');
end;

function ERROR_sk_dup(st:POPENSSL_STACK): POPENSSL_STACK; cdecl;
begin
  EOpenSSLAPIFunctionNotPresent.RaiseException('sk_dup');
end;

procedure ERROR_sk_sort(st:POPENSSL_STACK); cdecl;
begin
  EOpenSSLAPIFunctionNotPresent.RaiseException('sk_sort');
end;

function ERROR_sk_is_sorted(st:POPENSSL_STACK): longint; cdecl;
begin
