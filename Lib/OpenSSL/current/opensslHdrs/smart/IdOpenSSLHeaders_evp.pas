...
{$ELSE}
var
  EVP_MD_meth_new: function (md_type: TOpenSSL_C_INT; pkey_type: TOpenSSL_C_INT): PEVP_MD; cdecl = nil; {introduced 1.1.0 }
  ...
  EVP_MD_meth_set_input_blocksize: function (md: PEVP_MD; blocksize: TOpenSSL_C_INT): TOpenSSL_C_INT; cdecl = nil; {introduced 1.1.0 }
  EVP_MD_meth_set_result_size: function (md: PEVP_MD; resultsize: TOpenSSL_C_INT): TOpenSSL_C_INT; cdecl = nil; {introduced 1.1.0 }
  EVP_MD_meth_set_app_datasize: function (md: PEVP_MD; datasize: TOpenSSL_C_INT): TOpenSSL_C_INT; cdecl = nil; {introduced 1.1.0 }
  EVP_MD_meth_set_flags: function (md: PEVP_MD; flags: TOpenSSL_C_ULONG): TOpenSSL_C_INT; cdecl = nil; {introduced 1.1.0 }
  EVP_MD_meth_set_init: function (md: PEVP_MD; init: EVP_MD_meth_init): TOpenSSL_C_INT; cdecl = nil; {introduced 1.1.0 }
  EVP_MD_meth_set_update: function (md: PEVP_MD; update: EVP_MD_meth_update): TOpenSSL_C_INT; cdecl = nil; {introduced 1.1.0 }
  EVP_MD_meth_set_final: function (md: PEVP_MD; final_: EVP_MD_meth_final): TOpenSSL_C_INT; cdecl = nil; {introduced 1.1.0 }
  EVP_MD_meth_set_copy: function (md: PEVP_MD; copy: EVP_MD_meth_copy): TOpenSSL_C_INT; cdecl = nil; {introduced 1.1.0 }
  EVP_MD_meth_set_cleanup: function (md: PEVP_MD; cleanup: EVP_MD_meth_cleanup): TOpenSSL_C_INT; cdecl = nil; {introduced 1.1.0 }
  EVP_MD_meth_set_ctrl: function (md: PEVP_MD; ctrl: EVP_MD_meth_ctrl): TOpenSSL_C_INT; cdecl = nil; {introduced 1.1.0 }
  EVP_MD_meth_get_input_blocksize: function (const md: PEVP_MD): TOpenSSL_C_INT; cdecl = nil; {introduced 1.1.0 }
  EVP_MD_meth_get_result_size: function (const md: PEVP_MD): TOpenSSL_C_INT; cdecl = nil; {introduced 1.1.0 }
  EVP_MD_meth_get_app_datasize: function (const md: PEVP_MD): TOpenSSL_C_INT; cdecl = nil; {introduced 1.1.0 }
  EVP_MD_meth_get_flags: function (const md: PEVP_MD): TOpenSSL_C_ULONG; cdecl = nil; {introduced 1.1.0 }
  ...
  EVP_CIPHER_meth_new: function (cipher_type: TOpenSSL_C_INT; block_size: TOpenSSL_C_INT; key_len: TOpenSSL_C_INT): PEVP_CIPHER; cdecl = nil; {introduced 1.1.0 }
  ...
  EVP_CIPHER_meth_set_iv_length: function (cipher: PEVP_CIPHER; iv_len: TOpenSSL_C_INT): TOpenSSL_C_INT; cdecl = nil; {introduced 1.1.0 }
  EVP_CIPHER_meth_set_flags: function (cipher: PEVP_CIPHER; flags: TOpenSSL_C_ULONG): TOpenSSL_C_INT; cdecl = nil; {introduced 1.1.0 }
  EVP_CIPHER_meth_set_impl_ctx_size: function (cipher: PEVP_CIPHER; ctx_size: TOpenSSL_C_INT): TOpenSSL_C_INT; cdecl = nil; {introduced 1.1.0 }
  EVP_CIPHER_meth_set_init: function (cipher: PEVP_CIPHER; init: EVP_CIPHER_meth_init): TOpenSSL_C_INT; cdecl = nil; {introduced 1.1.0 }
  EVP_CIPHER_meth_set_do_cipher: function (cipher: PEVP_CIPHER; do_cipher: EVP_CIPHER_meth_do_cipher): TOpenSSL_C_INT; cdecl = nil; {introduced 1.1.0 }
  EVP_CIPHER_meth_set_cleanup: function (cipher: PEVP_CIPHER; cleanup: EVP_CIPHER_meth_cleanup): TOpenSSL_C_INT; cdecl = nil; {introduced 1.1.0 }
  EVP_CIPHER_meth_set_set_asn1_params: function (cipher: PEVP_CIPHER; set_asn1_parameters: EVP_CIPHER_meth_set_asn1_params): TOpenSSL_C_INT; cdecl = nil; {introduced 1.1.0 }
  EVP_CIPHER_meth_set_get_asn1_params: function (cipher: PEVP_CIPHER; get_asn1_parameters: EVP_CIPHER_meth_get_asn1_params): TOpenSSL_C_INT; cdecl = nil; {introduced 1.1.0 }
  EVP_CIPHER_meth_set_ctrl: function (cipher: PEVP_CIPHER; ctrl: EVP_CIPHER_meth_ctrl): TOpenSSL_C_INT; cdecl = nil; {introduced 1.1.0 }
  ...
  EVP_CIPHER_impl_ctx_size: function (const cipher: PEVP_CIPHER): TOpenSSL_C_INT; cdecl = nil; {introduced 1.1.0 }
  ...
  EVP_CIPHER_CTX_set_num: procedure (ctx: PEVP_CIPHER_CTX; num: TOpenSSL_C_INT); cdecl = nil; {introduced 1.1.0 }
  ...
  EVP_MD_CTX_ctrl: function (ctx: PEVP_MD_CTX; cmd: TOpenSSL_C_INT; p1: TOpenSSL_C_INT; p2: Pointer): TOpenSSL_C_INT; cdecl = nil; {introduced 1.1.0 }
  EVP_MD_CTX_new: function : PEVP_MD_CTX; cdecl = nil; {introduced 1.1.0 }
  EVP_MD_CTX_reset: function (ctx: PEVP_MD_CTX): TOpenSSL_C_INT; cdecl = nil; {introduced 1.1.0 }
  ...
  EVP_DigestFinalXOF: function (ctx: PEVP_MD_CTX; md: PByte; len: TOpenSSL_C_SIZET): TOpenSSL_C_INT; cdecl = nil; {introduced 1.1.0 }
  ...
  EVP_DigestSign: function (ctx: PEVP_CIPHER_CTX; sigret: PByte; siglen: POpenSSL_C_SIZET; const tbs: PByte; tbslen: TOpenSSL_C_SIZET): TOpenSSL_C_INT; cdecl = nil; {introduced 1.1.0 }
  ...
  EVP_DigestVerify: function (ctx: PEVP_CIPHER_CTX; const sigret: PByte; siglen: TOpenSSL_C_SIZET; const tbs: PByte; tbslen: TOpenSSL_C_SIZET): TOpenSSL_C_INT; cdecl = nil; {introduced 1.1.0 }
  ...
  EVP_ENCODE_CTX_copy: function (dctx: PEVP_ENCODE_CTX; sctx: PEVP_ENCODE_CTX): TOpenSSL_C_INT; cdecl = nil; {introduced 1.1.0 }
  EVP_ENCODE_CTX_num: function (ctx: PEVP_ENCODE_CTX): TOpenSSL_C_INT; cdecl = nil; {introduced 1.1.0 }
  ...
  EVP_CIPHER_CTX_reset: function (c: PEVP_CIPHER_CTX): TOpenSSL_C_INT; cdecl = nil; {introduced 1.1.0 }
...
{$ENDIF}
  ...
  EVP_PKEY_get_base_id: function (const pkey: PEVP_PKEY): TOpenSSL_C_INT; cdecl = nil; {introduced 3.0.0 }
  EVP_PKEY_get_security_bits: function (const pkey: PEVP_PKEY): TOpenSSL_C_INT; cdecl = nil; {introduced 3.0.0 }
  EVP_PKEY_get_size: function (const pkey: PEVP_PKEY): TOpenSSL_C_INT; cdecl = nil; {introduced 3.0.0 }
  ...
  EVP_PKEY_set1_engine: function (pkey: PEVP_PKEY; e: PENGINE): TOpenSSL_C_INT; cdecl = nil; {introduced 1.1.0 }
  ...
  EVP_PKEY_get0_hmac: function (const pkey: PEVP_PKEY; len: POpenSSL_C_SIZET): PByte; cdecl = nil; {introduced 1.1.0 }
  EVP_PKEY_get0_poly1305: function (const pkey: PEVP_PKEY; len: POpenSSL_C_SIZET): PByte; cdecl = nil; {introduced 1.1.0 }
  EVP_PKEY_get0_siphash: function (const pkey: PEVP_PKEY; len: POpenSSL_C_SIZET): PByte; cdecl = nil; {introduced 1.1.0 }
  ...
  EVP_PKEY_up_ref: function (pkey: PEVP_PKEY): TOpenSSL_C_INT; cdecl = nil; {introduced 1.1.0 }
  ...
  EVP_PBE_scrypt: function (const pass: PAnsiChar; passlen: TOpenSSL_C_SIZET; const salt: PByte; saltlen: TOpenSSL_C_SIZET; N: TOpenSSL_C_UINT64; r: TOpenSSL_C_UINT64; p: TOpenSSL_C_UINT64; maxmem: TOpenSSL_C_UINT64; key: PByte; keylen: TOpenSSL_C_SIZET): TOpenSSL_C_INT; cdecl = nil; {introduced 1.1.0 }
  PKCS5_v2_scrypt_keyivgen: function (ctx: PEVP_CIPHER_CTX; const pass: PAnsiChar; passlen: TOpenSSL_C_INT; param: PASN1_TYPE; const c: PEVP_CIPHER; const md: PEVP_MD; en_de: TOpenSSL_C_INT): TOpenSSL_C_INT; cdecl = nil; {introduced 1.1.0 }
  ...
  EVP_PBE_get: function (ptype: POpenSSL_C_INT; ppbe_nid: POpenSSL_C_INT; num: TOpenSSL_C_SIZET): TOpenSSL_C_INT; cdecl = nil; {introduced 1.1.0 }
  ...
  EVP_PKEY_meth_remove: function (const pmeth: PEVP_PKEY_METHOD): TOpenSSL_C_INT; cdecl = nil; {introduced 1.1.0 }
  EVP_PKEY_meth_get_count: function : TOpenSSL_C_SIZET; cdecl = nil; {introduced 1.1.0 }
  EVP_PKEY_meth_get0: function (idx: TOpenSSL_C_SIZET): PEVP_PKEY_METHOD; cdecl = nil; {introduced 1.1.0 }
  ...
  EVP_PKEY_CTX_ctrl_uint64: function (ctx: PEVP_PKEY_CTX; keytype: TOpenSSL_C_INT; optype: TOpenSSL_C_INT; cmd: TOpenSSL_C_INT; value: TOpenSSL_C_UINT64): TOpenSSL_C_INT; cdecl = nil; {introduced 1.1.0 }
  EVP_PKEY_CTX_str2ctrl: function (ctx: PEVP_PKEY_CTX; cmd: TOpenSSL_C_INT; const str: PAnsiChar): TOpenSSL_C_INT; cdecl = nil; {introduced 1.1.0 }
  EVP_PKEY_CTX_hex2ctrl: function (ctx: PEVP_PKEY_CTX; cmd: TOpenSSL_C_INT; const hex: PAnsiChar): TOpenSSL_C_INT; cdecl = nil; {introduced 1.1.0 }
  EVP_PKEY_CTX_md: function (ctx: PEVP_PKEY_CTX; optype: TOpenSSL_C_INT; cmd: TOpenSSL_C_INT; const md: PAnsiChar): TOpenSSL_C_INT; cdecl = nil; {introduced 1.1.0 }
  ...
  EVP_PKEY_new_raw_private_key: function (type_: TOpenSSL_C_INT; e: PENGINE; const priv: PByte; len: TOpenSSL_C_SIZET): PEVP_PKEY; cdecl = nil; {introduced 1.1.0 }
  EVP_PKEY_new_raw_public_key: function (type_: TOpenSSL_C_INT; e: PENGINE; const pub: PByte; len: TOpenSSL_C_SIZET): PEVP_PKEY; cdecl = nil; {introduced 1.1.0 }
  EVP_PKEY_get_raw_private_key: function (const pkey: PEVP_PKEY; priv: PByte; len: POpenSSL_C_SIZET): TOpenSSL_C_INT; cdecl = nil; {introduced 1.1.0 }
  EVP_PKEY_get_raw_public_key: function (const pkey: PEVP_PKEY; pub: PByte; len: POpenSSL_C_SIZET): TOpenSSL_C_INT; cdecl = nil; {introduced 1.1.0 }
  EVP_PKEY_new_CMAC_key: function (e: PENGINE; const priv: PByte; len: TOpenSSL_C_SIZET; const cipher: PEVP_CIPHER): PEVP_PKEY; cdecl = nil; {introduced 1.1.0 }
  ...
  EVP_PKEY_check: function (ctx: PEVP_PKEY_CTX): TOpenSSL_C_INT; cdecl = nil; {introduced 1.1.0 }
  EVP_PKEY_public_check: function (ctx: PEVP_PKEY_CTX): TOpenSSL_C_INT; cdecl = nil; {introduced 1.1.0 }
  EVP_PKEY_param_check: function (ctx: PEVP_PKEY_CTX): TOpenSSL_C_INT; cdecl = nil; {introduced 1.1.0 }
...
{$ENDIF}
  EVP_PKEY_security_bits: function (const pkey: PEVP_PKEY): TOpenSSL_C_INT; cdecl = nil; {introduced 1.1.0 removed 3.0.0}
...
var
  ...
  EVP_CIPHER_CTX_encrypting: function (const ctx: PEVP_CIPHER_CTX): TOpenSSL_C_INT; cdecl = nil; {introduced 1.1.0 removed 3.0.0}
  ...
  EVP_CIPHER_CTX_num: function (const ctx: PEVP_CIPHER_CTX): TOpenSSL_C_INT; cdecl = nil; {introduced 1.1.0 removed 3.0.0}
  ...
  EVP_PKEY_set_alias_type: function (pkey: PEVP_PKEY; type_: TOpenSSL_C_INT): TOpenSSL_C_INT; cdecl = nil; {introduced 1.1.0 removed 3.0.0}
  EVP_PKEY_set1_tls_encodedpoint: function (pkey: PEVP_PKEY; const pt: PByte; ptlen: TOpenSSL_C_SIZET): TOpenSSL_C_INT; cdecl = nil; {introduced 1.1.0 removed 3.0.0}
  EVP_PKEY_get1_tls_encodedpoint: function (pkey: PEVP_PKEY; ppt: PPByte): TOpenSSL_C_SIZET; cdecl = nil; {introduced 1.1.0 removed 3.0.0}
...
function ERROR_EVP_PKEY_assign_RSA(pkey: PEVP_PKEY; rsa: Pointer): TOpenSSL_C_INT; cdecl;
begin
...
{$IFDEF OPENSSL_NO_LEGACY_SUPPORT}
function ERROR_EVP_PKEY_assign_DSA(pkey: PEVP_PKEY; dsa: Pointer): TOpenSSL_C_INT; cdecl;
begin
...
{$IFDEF OPENSSL_NO_LEGACY_SUPPORT}
function ERROR_EVP_PKEY_assign_DH(pkey: PEVP_PKEY; dh: Pointer): TOpenSSL_C_INT; cdecl;
begin
...
{$IFDEF OPENSSL_NO_LEGACY_SUPPORT}
function ERROR_EVP_PKEY_assign_EC_KEY(pkey: PEVP_PKEY; eckey: Pointer): TOpenSSL_C_INT; cdecl;
begin
...
{$IFDEF OPENSSL_NO_LEGACY_SUPPORT}
function ERROR_EVP_PKEY_assign_SIPHASH(pkey: PEVP_PKEY; shkey: Pointer): TOpenSSL_C_INT; cdecl;
begin
...
{$IFDEF OPENSSL_NO_LEGACY_SUPPORT}
function ERROR_EVP_PKEY_assign_POLY1305(pkey: PEVP_PKEY; polykey: Pointer): TOpenSSL_C_INT; cdecl;
begin
...
function ERROR_EVP_MD_type(const md: PEVP_MD): TOpenSSL_C_INT; cdecl;
begin
  EOpenSSLAPIFunctionNotPresent.RaiseException('EVP_MD_type');
end;

function ERROR_EVP_MD_pkey_type(const md: PEVP_MD): TOpenSSL_C_INT; cdecl;
begin
  EOpenSSLAPIFunctionNotPresent.RaiseException('EVP_MD_pkey_type');
end;

function ERROR_EVP_MD_size(const md: PEVP_MD): TOpenSSL_C_INT; cdecl;
begin
  EOpenSSLAPIFunctionNotPresent.RaiseException('EVP_MD_size');
end;

function ERROR_EVP_MD_block_size(const md: PEVP_MD): TOpenSSL_C_INT; cdecl;
begin
  EOpenSSLAPIFunctionNotPresent.RaiseException('EVP_MD_block_size');
end;

function ERROR_EVP_MD_flags(const md: PEVP_MD): POpenSSL_C_ULONG; cdecl;
begin
...
function ERROR_EVP_MD_CTX_pkey_ctx(const ctx: PEVP_MD_CTX): PEVP_PKEY_CTX; cdecl;
begin
...
function ERROR_EVP_MD_CTX_md_data(const ctx: PEVP_MD_CTX): Pointer; cdecl;
begin
  EOpenSSLAPIFunctionNotPresent.RaiseException('EVP_MD_CTX_md_data');
end;

function ERROR_EVP_CIPHER_nid(const ctx: PEVP_MD_CTX): TOpenSSL_C_INT; cdecl;
begin
  EOpenSSLAPIFunctionNotPresent.RaiseException('EVP_CIPHER_nid');
end;

function ERROR_EVP_CIPHER_block_size(const cipher: PEVP_CIPHER): TOpenSSL_C_INT; cdecl;
begin
...
function ERROR_EVP_CIPHER_key_length(const cipher: PEVP_CIPHER): TOpenSSL_C_INT; cdecl;
begin
  EOpenSSLAPIFunctionNotPresent.RaiseException('EVP_CIPHER_key_length');
end;

function ERROR_EVP_CIPHER_iv_length(const cipher: PEVP_CIPHER): TOpenSSL_C_INT; cdecl;
begin
  EOpenSSLAPIFunctionNotPresent.RaiseException('EVP_CIPHER_iv_length');
end;

function ERROR_EVP_CIPHER_flags(const cipher: PEVP_CIPHER): TOpenSSL_C_ULONG; cdecl;
begin
...
function ERROR_EVP_CIPHER_CTX_encrypting(const ctx: PEVP_CIPHER_CTX): TOpenSSL_C_INT; cdecl;
begin
  EOpenSSLAPIFunctionNotPresent.RaiseException('EVP_CIPHER_CTX_encrypting');
end;

function ERROR_EVP_CIPHER_CTX_nid(const ctx: PEVP_CIPHER_CTX): TOpenSSL_C_INT; cdecl;
begin
  EOpenSSLAPIFunctionNotPresent.RaiseException('EVP_CIPHER_CTX_nid');
end;

function ERROR_EVP_CIPHER_CTX_block_size(const ctx: PEVP_CIPHER_CTX): TOpenSSL_C_INT; cdecl;
begin
  EOpenSSLAPIFunctionNotPresent.RaiseException('EVP_CIPHER_CTX_block_size');
end;

function ERROR_EVP_CIPHER_CTX_key_length(const ctx: PEVP_CIPHER_CTX): TOpenSSL_C_INT; cdecl;
begin
  EOpenSSLAPIFunctionNotPresent.RaiseException('EVP_CIPHER_CTX_key_length');
end;

function ERROR_EVP_CIPHER_CTX_iv_length(const ctx: PEVP_CIPHER_CTX): TOpenSSL_C_INT; cdecl;
begin
...
function ERROR_EVP_CIPHER_CTX_num(const ctx: PEVP_CIPHER_CTX): TOpenSSL_C_INT; cdecl;
begin
...
{$IFDEF OPENSSL_NO_LEGACY_SUPPORT}
procedure ERROR_BIO_set_md(v1: PBIO; const md: PEVP_MD); cdecl;
begin
  EOpenSSLAPIFunctionNotPresent.RaiseException('BIO_set_md');
end;
{$ENDIF} { End of OPENSSL_NO_LEGACY_SUPPORT}

procedure ERROR_EVP_MD_CTX_init(ctx : PEVP_MD_CTX); cdecl;
begin
  EOpenSSLAPIFunctionNotPresent.RaiseException('EVP_MD_CTX_init');
end;

function ERROR_EVP_MD_CTX_cleanup(ctx : PEVP_MD_CTX): TOpenSSL_C_INT; cdecl;
begin
...
function ERROR_EVP_PKEY_id(const pkey: PEVP_PKEY): TOpenSSL_C_INT; cdecl;
begin
  EOpenSSLAPIFunctionNotPresent.RaiseException('EVP_PKEY_id');
end;

function ERROR_EVP_PKEY_base_id(const pkey: PEVP_PKEY): TOpenSSL_C_INT; cdecl;
begin
...
function ERROR_EVP_PKEY_bits(const pkey: PEVP_PKEY): TOpenSSL_C_INT; cdecl;
begin
  EOpenSSLAPIFunctionNotPresent.RaiseException('EVP_PKEY_bits');
end;

{$IFDEF OPENSSL_NO_LEGACY_SUPPORT}
function ERROR_EVP_PKEY_security_bits(const pkey: PEVP_PKEY): TOpenSSL_C_INT; cdecl;
begin
...
{$IFDEF OPENSSL_NO_LEGACY_SUPPORT}
function ERROR_EVP_PKEY_size(const pkey: PEVP_PKEY): TOpenSSL_C_INT; cdecl;
begin
...
function ERROR_EVP_PKEY_set_alias_type(pkey: PEVP_PKEY; type_: TOpenSSL_C_INT): TOpenSSL_C_INT; cdecl;
begin
...
function ERROR_EVP_PKEY_set1_tls_encodedpoint(pkey: PEVP_PKEY; const pt: PByte; ptlen: TOpenSSL_C_SIZET): TOpenSSL_C_INT; cdecl;
begin
  EOpenSSLAPIFunctionNotPresent.RaiseException('EVP_PKEY_set1_tls_encodedpoint');
end;

function ERROR_EVP_PKEY_get1_tls_encodedpoint(pkey: PEVP_PKEY; ppt: PPByte): TOpenSSL_C_SIZET; cdecl;
begin
  EOpenSSLAPIFunctionNotPresent.RaiseException('EVP_PKEY_get1_tls_encodedpoint');
end;

function ERROR_EVP_CIPHER_type(const ctx: PEVP_CIPHER): TOpenSSL_C_INT; cdecl;
begin
...
{$IFDEF OPENSSL_NO_LEGACY_SUPPORT}
procedure ERROR_OpenSSL_add_all_ciphers; cdecl;
begin
...
{$IFDEF OPENSSL_NO_LEGACY_SUPPORT}
procedure ERROR_OpenSSL_add_all_digests; cdecl;
begin
...
{$IFDEF OPENSSL_NO_LEGACY_SUPPORT}
procedure ERROR_EVP_cleanup; cdecl;
begin
...
{$ENDIF} //of OPENSSL_NO_LEGACY_SUPPORT
  ...
  begin
    ...
    if LibVersion < EVP_PKEY_get_base_id_introduced then
      FuncLoadError := false;
    if FuncLoadError then
      AFailed.Add('EVP_PKEY_get_base_id');
  end;
...
{$ENDIF} //of OPENSSL_NO_LEGACY_SUPPORT
  ...
  begin
    ...
    if LibVersion < EVP_PKEY_get_security_bits_introduced then
      FuncLoadError := false;
    if FuncLoadError then
      AFailed.Add('EVP_PKEY_get_security_bits');
  end;
...
{$ENDIF} //of OPENSSL_NO_LEGACY_SUPPORT
  ...
  begin
    ...
    if LibVersion < EVP_PKEY_get_size_introduced then
      FuncLoadError := false;
    if FuncLoadError then
      AFailed.Add('EVP_PKEY_get_size');
  end;
