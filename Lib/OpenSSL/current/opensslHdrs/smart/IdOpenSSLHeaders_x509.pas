...
var
  ...
  X509_get_pathlen: function (x: PX509): TOpenSSL_C_LONG; cdecl = nil; {introduced 1.1.0 }
  ...
  X509_SIG_INFO_get: function (const siginf: PX509_SIG_INFO; mdnid: POpenSSL_C_INT; pknid: POpenSSL_C_INT; secbits: POpenSSL_C_INT; flags: POpenSSL_C_UINT32): TOpenSSL_C_INT; cdecl = nil; {introduced 1.1.0 }
  X509_SIG_INFO_set: procedure (siginf: PX509_SIG_INFO; mdnid: TOpenSSL_C_INT; pknid: TOpenSSL_C_INT; secbits: TOpenSSL_C_INT; flags: TOpenSSL_C_UINT32); cdecl = nil; {introduced 1.1.0 }
  X509_get_signature_info: function (x: PX509; mdnid: POpenSSL_C_INT; pknid: POpenSSL_C_INT; secbits: POpenSSL_C_INT; flags: POpenSSL_C_UINT32): TOpenSSL_C_INT; cdecl = nil; {introduced 1.1.0 }
  ...
  X509_trusted: function (const x: PX509): TOpenSSL_C_INT; cdecl = nil; {introduced 1.1.0 }
  ...
  X509_get_version: function (const x: PX509): TOpenSSL_C_LONG; cdecl = nil; {introduced 1.1.0 }
  ...
  X509_set1_notBefore: function (x: PX509; const tm: PASN1_TIME): TOpenSSL_C_INT; cdecl = nil; {introduced 1.1.0 }
  ...
  X509_set1_notAfter: function (x: PX509; const tm: PASN1_TIME): TOpenSSL_C_INT; cdecl = nil; {introduced 1.1.0 }
  X509_set_pubkey: function (x: PX509; pkey: PEVP_PKEY): TOpenSSL_C_INT; cdecl = nil;
  X509_up_ref: function (x: PX509): TOpenSSL_C_INT; cdecl = nil; {introduced 1.1.0 }
  X509_get_signature_type: function (const x: PX509): TOpenSSL_C_INT; cdecl = nil; {introduced 1.1.0 }
  ...
  X509_REQ_get_version: function (const req: PX509_REQ): TOpenSSL_C_LONG; cdecl = nil; {introduced 1.1.0 }
  ...
  X509_REQ_get_signature_nid: function (const req: PX509_REQ): TOpenSSL_C_INT; cdecl = nil; {introduced 1.1.0 }
  i2d_re_X509_REQ_tbs: function (req: PX509_REQ; pp: PPByte): TOpenSSL_C_INT; cdecl = nil; {introduced 1.1.0 }
  ...
  X509_CRL_set1_lastUpdate: function (x: PX509_CRL; const tm: PASN1_TIME): TOpenSSL_C_INT; cdecl = nil; {introduced 1.1.0 }
  X509_CRL_set1_nextUpdate: function (x: PX509_CRL; const tm: PASN1_TIME): TOpenSSL_C_INT; cdecl = nil; {introduced 1.1.0 }
  X509_CRL_sort: function (crl: PX509_CRL): TOpenSSL_C_INT; cdecl = nil;
  X509_CRL_up_ref: function (crl: PX509_CRL): TOpenSSL_C_INT; cdecl = nil; {introduced 1.1.0 }
  X509_CRL_get_version: function (const crl: PX509_CRL): TOpenSSL_C_LONG; cdecl = nil; {introduced 1.1.0 }
  ...
  X509_CRL_get_signature_nid: function (const crl: PX509_CRL): TOpenSSL_C_INT; cdecl = nil; {introduced 1.1.0 }
  i2d_re_X509_CRL_tbs: function (req: PX509_CRL; pp: PPByte): TOpenSSL_C_INT; cdecl = nil; {introduced 1.1.0 }
  ...
  X509_aux_print: function (out_: PBIO; x: PX509; indent: TOpenSSL_C_INT): TOpenSSL_C_INT; cdecl = nil; {introduced 1.1.0 }
  ...
  X509_CRL_print_ex: function (out_: PBIO; x: PX509_CRL; nmflag: TOpenSSL_C_ULONG): TOpenSSL_C_INT; cdecl = nil; {introduced 1.1.0 }
  ...
  X509_NAME_ENTRY_set: function (const ne: PX509_NAME_ENTRY): TOpenSSL_C_INT; cdecl = nil; {introduced 1.1.0 }
  X509_NAME_get0_der: function (nm: PX509_NAME; const pder: PPByte; pderlen: POpenSSL_C_SIZET): TOpenSSL_C_INT; cdecl = nil; {introduced 1.1.0 }
  ...
  PKCS5_pbe2_set_scrypt: function (const cipher: PEVP_CIPHER; const salt: PByte; saltlen: TOpenSSL_C_INT; aiv: PByte; N: TOpenSSL_C_UINT64; r: TOpenSSL_C_UINT64; p: TOpenSSL_C_UINT64): PX509_ALGOR; cdecl = nil; {introduced 1.1.0 }
  ...
  PKCS8_pkey_add1_attr_by_NID: function (p8: PPKCS8_PRIV_KEY_INFO; nid: TOpenSSL_C_INT; type_: TOpenSSL_C_INT; const bytes: PByte; len: TOpenSSL_C_INT): TOpenSSL_C_INT; cdecl = nil; {introduced 1.1.0 }
  ...
  X509_NAME_hash_ex: function (const x: PX509_NAME; libctx: POSSL_LIB_CTX; const propq: PAnsiChar; ok: POpenSSL_C_INT): TOpenSSL_C_ULONG; cdecl = nil; {introduced 3.0.0 }
...
function ERROR_X509_http_nbio(rctx: POCSP_REQ_CTX; pcert: PPX509): TOpenSSL_C_INT; cdecl;
begin
...
function ERROR_X509_CRL_http_nbio(rctx: POCSP_REQ_CTX; pcrl: PPX509_CRL): TOpenSSL_C_INT; cdecl;
begin
...
{$IFDEF OPENSSL_NO_LEGACY_SUPPORT}
function ERROR_X509_NAME_hash(x: PX509_NAME): TOpenSSL_C_ULONG; cdecl;
begin
