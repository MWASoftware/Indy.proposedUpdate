...
function X509_NAME_hash(x: PX509_NAME): TOpenSSL_C_ULONG; cdecl;
...
var
  ...
  X509_PUBKEY_get0: function (key: PX509_PUBKEY): PEVP_PKEY; cdecl = Load_X509_PUBKEY_get0; {introduced 1.1.0 }
  X509_PUBKEY_get: function (key: PX509_PUBKEY): PEVP_PKEY; cdecl = Load_X509_PUBKEY_get;
  X509_get_pathlen: function (x: PX509): TOpenSSL_C_LONG; cdecl = Load_X509_get_pathlen; {introduced 1.1.0 }
  ...
  X509_SIG_get0: procedure (const sig: PX509_SIG; const palg: PPX509_ALGOR; const pdigest: PPASN1_OCTET_STRING); cdecl = Load_X509_SIG_get0; {introduced 1.1.0 }
  X509_SIG_getm: procedure (sig: X509_SIG; palg: PPX509_ALGOR; pdigest: PPASN1_OCTET_STRING); cdecl = Load_X509_SIG_getm; {introduced 1.1.0 }
  ...
  X509_SIG_INFO_get: function (const siginf: PX509_SIG_INFO; mdnid: POpenSSL_C_INT; pknid: POpenSSL_C_INT; secbits: POpenSSL_C_INT; flags: POpenSSL_C_UINT32): TOpenSSL_C_INT; cdecl = Load_X509_SIG_INFO_get; {introduced 1.1.0 }
  X509_SIG_INFO_set: procedure (siginf: PX509_SIG_INFO; mdnid: TOpenSSL_C_INT; pknid: TOpenSSL_C_INT; secbits: TOpenSSL_C_INT; flags: TOpenSSL_C_UINT32); cdecl = Load_X509_SIG_INFO_set; {introduced 1.1.0 }
  X509_get_signature_info: function (x: PX509; mdnid: POpenSSL_C_INT; pknid: POpenSSL_C_INT; secbits: POpenSSL_C_INT; flags: POpenSSL_C_UINT32): TOpenSSL_C_INT; cdecl = Load_X509_get_signature_info; {introduced 1.1.0 }
  X509_get0_signature: procedure (var sig: PASN1_BIT_STRING; var alg: PX509_ALGOR; const x: PX509); cdecl = Load_X509_get0_signature; {introduced 1.1.0 }
  X509_get_signature_nid: function (const x: PX509): TOpenSSL_C_INT; cdecl = Load_X509_get_signature_nid;
  X509_trusted: function (const x: PX509): TOpenSSL_C_INT; cdecl = Load_X509_trusted; {introduced 1.1.0 }
  ...
  X509_get_version: function (const x: PX509): TOpenSSL_C_LONG; cdecl = Load_X509_get_version; {introduced 1.1.0 }
  ...
  X509_get0_serialNumber: function (const x: PX509): PASN1_INTEGER; cdecl = Load_X509_get0_serialNumber; {introduced 1.1.0 }
  ...
  X509_get0_notBefore: function (const x: PX509): PASN1_TIME; cdecl = Load_X509_get0_notBefore; {introduced 1.1.0 }
  X509_getm_notBefore: function (const x: PX509): PASN1_TIME; cdecl = Load_X509_getm_notBefore; {introduced 1.1.0 }
  X509_set1_notBefore: function (x: PX509; const tm: PASN1_TIME): TOpenSSL_C_INT; cdecl = Load_X509_set1_notBefore; {introduced 1.1.0 }
  X509_get0_notAfter: function (const x: PX509): PASN1_TIME; cdecl = Load_X509_get0_notAfter; {introduced 1.1.0 }
  X509_getm_notAfter: function (const x: PX509): PASN1_TIME; cdecl = Load_X509_getm_notAfter; {introduced 1.1.0 }
  X509_set1_notAfter: function (x: PX509; const tm: PASN1_TIME): TOpenSSL_C_INT; cdecl = Load_X509_set1_notAfter; {introduced 1.1.0 }
  X509_set_pubkey: function (x: PX509; pkey: PEVP_PKEY): TOpenSSL_C_INT; cdecl = Load_X509_set_pubkey;
  X509_up_ref: function (x: PX509): TOpenSSL_C_INT; cdecl = Load_X509_up_ref; {introduced 1.1.0 }
  X509_get_signature_type: function (const x: PX509): TOpenSSL_C_INT; cdecl = Load_X509_get_signature_type; {introduced 1.1.0 }
  X509_get_X509_PUBKEY: function (const x: PX509): PX509_PUBKEY; cdecl = Load_X509_get_X509_PUBKEY; {introduced 1.1.0 }
  X509_get0_uids: procedure (const x: PX509; const piuid: PPASN1_BIT_STRING; const psuid: PPASN1_BIT_STRING); cdecl = Load_X509_get0_uids; {introduced 1.1.0 }
  X509_get0_tbs_sigalg: function (const x: PX509): PX509_ALGOR; cdecl = Load_X509_get0_tbs_sigalg; {introduced 1.1.0 }
  X509_get0_pubkey: function (const x: PX509): PEVP_PKEY; cdecl = Load_X509_get0_pubkey; {introduced 1.1.0 }
  ...
  X509_REQ_get_version: function (const req: PX509_REQ): TOpenSSL_C_LONG; cdecl = Load_X509_REQ_get_version; {introduced 1.1.0 }
  X509_REQ_set_version: function (x: PX509_REQ; version: TOpenSSL_C_LONG): TOpenSSL_C_INT; cdecl = Load_X509_REQ_set_version;
  X509_REQ_get_subject_name: function (const req: PX509_REQ): PX509_NAME; cdecl = Load_X509_REQ_get_subject_name; {introduced 1.1.0 }
  X509_REQ_set_subject_name: function (req: PX509_REQ; name: PX509_NAME): TOpenSSL_C_INT; cdecl = Load_X509_REQ_set_subject_name;
  X509_REQ_get0_signature: procedure (const req: PX509_REQ; const psig: PPASN1_BIT_STRING; const palg: PPX509_ALGOR); cdecl = Load_X509_REQ_get0_signature; {introduced 1.1.0 }
  X509_REQ_get_signature_nid: function (const req: PX509_REQ): TOpenSSL_C_INT; cdecl = Load_X509_REQ_get_signature_nid; {introduced 1.1.0 }
  i2d_re_X509_REQ_tbs: function (req: PX509_REQ; pp: PPByte): TOpenSSL_C_INT; cdecl = Load_i2d_re_X509_REQ_tbs; {introduced 1.1.0 }
  ...
  X509_REQ_get0_pubkey: function (req: PX509_REQ): PEVP_PKEY; cdecl = Load_X509_REQ_get0_pubkey; {introduced 1.1.0 }
  X509_REQ_get_X509_PUBKEY: function (req: PX509_REQ): PX509_PUBKEY; cdecl = Load_X509_REQ_get_X509_PUBKEY; {introduced 1.1.0 }
  ...
  X509_CRL_set1_lastUpdate: function (x: PX509_CRL; const tm: PASN1_TIME): TOpenSSL_C_INT; cdecl = Load_X509_CRL_set1_lastUpdate; {introduced 1.1.0 }
  X509_CRL_set1_nextUpdate: function (x: PX509_CRL; const tm: PASN1_TIME): TOpenSSL_C_INT; cdecl = Load_X509_CRL_set1_nextUpdate; {introduced 1.1.0 }
  X509_CRL_sort: function (crl: PX509_CRL): TOpenSSL_C_INT; cdecl = Load_X509_CRL_sort;
  X509_CRL_up_ref: function (crl: PX509_CRL): TOpenSSL_C_INT; cdecl = Load_X509_CRL_up_ref; {introduced 1.1.0 }
  X509_CRL_get_version: function (const crl: PX509_CRL): TOpenSSL_C_LONG; cdecl = Load_X509_CRL_get_version; {introduced 1.1.0 }
  X509_CRL_get0_lastUpdate: function (const crl: PX509_CRL): PASN1_TIME; cdecl = Load_X509_CRL_get0_lastUpdate; {introduced 1.1.0 }
  X509_CRL_get0_nextUpdate: function (const crl: PX509_CRL): PASN1_TIME; cdecl = Load_X509_CRL_get0_nextUpdate; {introduced 1.1.0 }
  X509_CRL_get_issuer: function (const crl: PX509_CRL): PX509_NAME; cdecl = Load_X509_CRL_get_issuer; {introduced 1.1.0 }
  X509_CRL_get0_signature: procedure (const crl: PX509_CRL; const psig: PPASN1_BIT_STRING; const palg: PPX509_ALGOR); cdecl = Load_X509_CRL_get0_signature; {introduced 1.1.0 }
  X509_CRL_get_signature_nid: function (const crl: PX509_CRL): TOpenSSL_C_INT; cdecl = Load_X509_CRL_get_signature_nid; {introduced 1.1.0 }
  i2d_re_X509_CRL_tbs: function (req: PX509_CRL; pp: PPByte): TOpenSSL_C_INT; cdecl = Load_i2d_re_X509_CRL_tbs; {introduced 1.1.0 }
  X509_REVOKED_get0_serialNumber: function (const x: PX509_REVOKED): PASN1_INTEGER; cdecl = Load_X509_REVOKED_get0_serialNumber; {introduced 1.1.0 }
  ...
  X509_REVOKED_get0_revocationDate: function (const x: PX509_REVOKED): PASN1_TIME; cdecl = Load_X509_REVOKED_get0_revocationDate; {introduced 1.1.0 }
  ...
  X509_aux_print: function (out_: PBIO; x: PX509; indent: TOpenSSL_C_INT): TOpenSSL_C_INT; cdecl = Load_X509_aux_print; {introduced 1.1.0 }
  ...
  X509_CRL_print_ex: function (out_: PBIO; x: PX509_CRL; nmflag: TOpenSSL_C_ULONG): TOpenSSL_C_INT; cdecl = Load_X509_CRL_print_ex; {introduced 1.1.0 }
  ...
  X509_NAME_ENTRY_set: function (const ne: PX509_NAME_ENTRY): TOpenSSL_C_INT; cdecl = Load_X509_NAME_ENTRY_set; {introduced 1.1.0 }
  X509_NAME_get0_der: function (nm: PX509_NAME; const pder: PPByte; pderlen: POpenSSL_C_SIZET): TOpenSSL_C_INT; cdecl = Load_X509_NAME_get0_der; {introduced 1.1.0 }
  ...
  PKCS5_pbe2_set_scrypt: function (const cipher: PEVP_CIPHER; const salt: PByte; saltlen: TOpenSSL_C_INT; aiv: PByte; N: TOpenSSL_C_UINT64; r: TOpenSSL_C_UINT64; p: TOpenSSL_C_UINT64): PX509_ALGOR; cdecl = Load_PKCS5_pbe2_set_scrypt; {introduced 1.1.0 }
  ...
  PKCS8_pkey_add1_attr_by_NID: function (p8: PPKCS8_PRIV_KEY_INFO; nid: TOpenSSL_C_INT; type_: TOpenSSL_C_INT; const bytes: PByte; len: TOpenSSL_C_INT): TOpenSSL_C_INT; cdecl = Load_PKCS8_pkey_add1_attr_by_NID; {introduced 1.1.0 }
  ...
  X509_NAME_hash_ex: function (const x: PX509_NAME; libctx: POSSL_LIB_CTX; const propq: PAnsiChar; ok: POpenSSL_C_INT): TOpenSSL_C_ULONG; cdecl = Load_X509_NAME_hash_ex; {introduced 3.0.0 }
...
{$ENDIF}
const
  X509_http_nbio_removed = ((((((byte(3) shl 8) or byte(0)) shl 8) or byte(0)) shl 8) or byte(0)) shl 4;
  X509_CRL_http_nbio_removed = ((((((byte(3) shl 8) or byte(0)) shl 8) or byte(0)) shl 8) or byte(0)) shl 4;
  X509_PUBKEY_get0_introduced = ((((((byte(1) shl 8) or byte(1)) shl 8) or byte(0)) shl 8) or byte(0)) shl 4;
  X509_get_pathlen_introduced = ((((((byte(1) shl 8) or byte(1)) shl 8) or byte(0)) shl 8) or byte(0)) shl 4;
  X509_SIG_get0_introduced = ((((((byte(1) shl 8) or byte(1)) shl 8) or byte(0)) shl 8) or byte(0)) shl 4;
  X509_SIG_getm_introduced = ((((((byte(1) shl 8) or byte(1)) shl 8) or byte(0)) shl 8) or byte(0)) shl 4;
  X509_SIG_INFO_get_introduced = ((((((byte(1) shl 8) or byte(1)) shl 8) or byte(0)) shl 8) or byte(0)) shl 4;
  X509_SIG_INFO_set_introduced = ((((((byte(1) shl 8) or byte(1)) shl 8) or byte(0)) shl 8) or byte(0)) shl 4;
  X509_get_signature_info_introduced = ((((((byte(1) shl 8) or byte(1)) shl 8) or byte(0)) shl 8) or byte(0)) shl 4;
  X509_get0_signature_introduced = ((((((byte(1) shl 8) or byte(1)) shl 8) or byte(0)) shl 8) or byte(0)) shl 4;
  X509_trusted_introduced = ((((((byte(1) shl 8) or byte(1)) shl 8) or byte(0)) shl 8) or byte(0)) shl 4;
  X509_get_version_introduced = ((((((byte(1) shl 8) or byte(1)) shl 8) or byte(0)) shl 8) or byte(0)) shl 4;
  X509_get0_serialNumber_introduced = ((((((byte(1) shl 8) or byte(1)) shl 8) or byte(0)) shl 8) or byte(0)) shl 4;
  X509_get0_notBefore_introduced = ((((((byte(1) shl 8) or byte(1)) shl 8) or byte(0)) shl 8) or byte(0)) shl 4;
  X509_getm_notBefore_introduced = ((((((byte(1) shl 8) or byte(1)) shl 8) or byte(0)) shl 8) or byte(0)) shl 4;
  X509_set1_notBefore_introduced = ((((((byte(1) shl 8) or byte(1)) shl 8) or byte(0)) shl 8) or byte(0)) shl 4;
  X509_get0_notAfter_introduced = ((((((byte(1) shl 8) or byte(1)) shl 8) or byte(0)) shl 8) or byte(0)) shl 4;
  X509_getm_notAfter_introduced = ((((((byte(1) shl 8) or byte(1)) shl 8) or byte(0)) shl 8) or byte(0)) shl 4;
  X509_set1_notAfter_introduced = ((((((byte(1) shl 8) or byte(1)) shl 8) or byte(0)) shl 8) or byte(0)) shl 4;
  X509_up_ref_introduced = ((((((byte(1) shl 8) or byte(1)) shl 8) or byte(0)) shl 8) or byte(0)) shl 4;
  X509_get_signature_type_introduced = ((((((byte(1) shl 8) or byte(1)) shl 8) or byte(0)) shl 8) or byte(0)) shl 4;
  X509_get_X509_PUBKEY_introduced = ((((((byte(1) shl 8) or byte(1)) shl 8) or byte(0)) shl 8) or byte(0)) shl 4;
  X509_get0_uids_introduced = ((((((byte(1) shl 8) or byte(1)) shl 8) or byte(0)) shl 8) or byte(0)) shl 4;
  X509_get0_tbs_sigalg_introduced = ((((((byte(1) shl 8) or byte(1)) shl 8) or byte(0)) shl 8) or byte(0)) shl 4;
  X509_get0_pubkey_introduced = ((((((byte(1) shl 8) or byte(1)) shl 8) or byte(0)) shl 8) or byte(0)) shl 4;
  X509_REQ_get_version_introduced = ((((((byte(1) shl 8) or byte(1)) shl 8) or byte(0)) shl 8) or byte(0)) shl 4;
  X509_REQ_get_subject_name_introduced = ((((((byte(1) shl 8) or byte(1)) shl 8) or byte(0)) shl 8) or byte(0)) shl 4;
  X509_REQ_get0_signature_introduced = ((((((byte(1) shl 8) or byte(1)) shl 8) or byte(0)) shl 8) or byte(0)) shl 4;
  X509_REQ_get_signature_nid_introduced = ((((((byte(1) shl 8) or byte(1)) shl 8) or byte(0)) shl 8) or byte(0)) shl 4;
  i2d_re_X509_REQ_tbs_introduced = ((((((byte(1) shl 8) or byte(1)) shl 8) or byte(0)) shl 8) or byte(0)) shl 4;
  X509_REQ_get0_pubkey_introduced = ((((((byte(1) shl 8) or byte(1)) shl 8) or byte(0)) shl 8) or byte(0)) shl 4;
  X509_REQ_get_X509_PUBKEY_introduced = ((((((byte(1) shl 8) or byte(1)) shl 8) or byte(0)) shl 8) or byte(0)) shl 4;
  X509_CRL_set1_lastUpdate_introduced = ((((((byte(1) shl 8) or byte(1)) shl 8) or byte(0)) shl 8) or byte(0)) shl 4;
  X509_CRL_set1_nextUpdate_introduced = ((((((byte(1) shl 8) or byte(1)) shl 8) or byte(0)) shl 8) or byte(0)) shl 4;
  X509_CRL_up_ref_introduced = ((((((byte(1) shl 8) or byte(1)) shl 8) or byte(0)) shl 8) or byte(0)) shl 4;
  X509_CRL_get_version_introduced = ((((((byte(1) shl 8) or byte(1)) shl 8) or byte(0)) shl 8) or byte(0)) shl 4;
  X509_CRL_get0_lastUpdate_introduced = ((((((byte(1) shl 8) or byte(1)) shl 8) or byte(0)) shl 8) or byte(0)) shl 4;
  X509_CRL_get0_nextUpdate_introduced = ((((((byte(1) shl 8) or byte(1)) shl 8) or byte(0)) shl 8) or byte(0)) shl 4;
  X509_CRL_get_issuer_introduced = ((((((byte(1) shl 8) or byte(1)) shl 8) or byte(0)) shl 8) or byte(0)) shl 4;
  X509_CRL_get0_signature_introduced = ((((((byte(1) shl 8) or byte(1)) shl 8) or byte(0)) shl 8) or byte(0)) shl 4;
  X509_CRL_get_signature_nid_introduced = ((((((byte(1) shl 8) or byte(1)) shl 8) or byte(0)) shl 8) or byte(0)) shl 4;
  i2d_re_X509_CRL_tbs_introduced = ((((((byte(1) shl 8) or byte(1)) shl 8) or byte(0)) shl 8) or byte(0)) shl 4;
  X509_REVOKED_get0_serialNumber_introduced = ((((((byte(1) shl 8) or byte(1)) shl 8) or byte(0)) shl 8) or byte(0)) shl 4;
  X509_REVOKED_get0_revocationDate_introduced = ((((((byte(1) shl 8) or byte(1)) shl 8) or byte(0)) shl 8) or byte(0)) shl 4;
  X509_NAME_hash_removed = ((((((byte(3) shl 8) or byte(0)) shl 8) or byte(0)) shl 8) or byte(0)) shl 4;
  X509_aux_print_introduced = ((((((byte(1) shl 8) or byte(1)) shl 8) or byte(0)) shl 8) or byte(0)) shl 4;
  X509_CRL_print_ex_introduced = ((((((byte(1) shl 8) or byte(1)) shl 8) or byte(0)) shl 8) or byte(0)) shl 4;
  X509_NAME_ENTRY_set_introduced = ((((((byte(1) shl 8) or byte(1)) shl 8) or byte(0)) shl 8) or byte(0)) shl 4;
  X509_NAME_get0_der_introduced = ((((((byte(1) shl 8) or byte(1)) shl 8) or byte(0)) shl 8) or byte(0)) shl 4;
  PKCS5_pbe2_set_scrypt_introduced = ((((((byte(1) shl 8) or byte(1)) shl 8) or byte(0)) shl 8) or byte(0)) shl 4;
  PKCS8_pkey_add1_attr_by_NID_introduced = ((((((byte(1) shl 8) or byte(1)) shl 8) or byte(0)) shl 8) or byte(0)) shl 4;
  X509_NAME_hash_ex_introduced = ((((((byte(3) shl 8) or byte(0)) shl 8) or byte(0)) shl 8) or byte(0)) shl 4;
