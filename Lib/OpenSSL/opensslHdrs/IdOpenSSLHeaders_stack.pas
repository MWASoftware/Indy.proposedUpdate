...
const
  ...
  OPENSSL_sk_value_introduced = ((((((byte(1) shl 8) or byte(1)) shl 8) or byte(0)) shl 8) or byte(0)) shl 4;
  OPENSSL_sk_set_introduced = ((((((byte(1) shl 8) or byte(1)) shl 8) or byte(0)) shl 8) or byte(0)) shl 4;
  OPENSSL_sk_new_introduced = ((((((byte(1) shl 8) or byte(1)) shl 8) or byte(0)) shl 8) or byte(0)) shl 4;
  OPENSSL_sk_new_null_introduced = ((((((byte(1) shl 8) or byte(1)) shl 8) or byte(0)) shl 8) or byte(0)) shl 4;
  OPENSSL_sk_new_reserve_introduced = ((((((byte(1) shl 8) or byte(1)) shl 8) or byte(0)) shl 8) or byte(0)) shl 4;
  OPENSSL_sk_reserve_introduced = ((((((byte(1) shl 8) or byte(1)) shl 8) or byte(0)) shl 8) or byte(0)) shl 4;
  OPENSSL_sk_free_introduced = ((((((byte(1) shl 8) or byte(1)) shl 8) or byte(0)) shl 8) or byte(0)) shl 4;
  OPENSSL_sk_pop_free_introduced = ((((((byte(1) shl 8) or byte(1)) shl 8) or byte(0)) shl 8) or byte(0)) shl 4;
  OPENSSL_sk_deep_copy_introduced = ((((((byte(1) shl 8) or byte(1)) shl 8) or byte(0)) shl 8) or byte(0)) shl 4;
  OPENSSL_sk_insert_introduced = ((((((byte(1) shl 8) or byte(1)) shl 8) or byte(0)) shl 8) or byte(0)) shl 4;
  OPENSSL_sk_delete_introduced = ((((((byte(1) shl 8) or byte(1)) shl 8) or byte(0)) shl 8) or byte(0)) shl 4;
  OPENSSL_sk_delete_ptr_introduced = ((((((byte(1) shl 8) or byte(1)) shl 8) or byte(0)) shl 8) or byte(0)) shl 4;
  OPENSSL_sk_find_introduced = ((((((byte(1) shl 8) or byte(1)) shl 8) or byte(0)) shl 8) or byte(0)) shl 4;
  OPENSSL_sk_find_ex_introduced = ((((((byte(1) shl 8) or byte(1)) shl 8) or byte(0)) shl 8) or byte(0)) shl 4;
  OPENSSL_sk_push_introduced = ((((((byte(1) shl 8) or byte(1)) shl 8) or byte(0)) shl 8) or byte(0)) shl 4;
  OPENSSL_sk_unshift_introduced = ((((((byte(1) shl 8) or byte(1)) shl 8) or byte(0)) shl 8) or byte(0)) shl 4;
  OPENSSL_sk_shift_introduced = ((((((byte(1) shl 8) or byte(1)) shl 8) or byte(0)) shl 8) or byte(0)) shl 4;
  OPENSSL_sk_pop_introduced = ((((((byte(1) shl 8) or byte(1)) shl 8) or byte(0)) shl 8) or byte(0)) shl 4;
  OPENSSL_sk_zero_introduced = ((((((byte(1) shl 8) or byte(1)) shl 8) or byte(0)) shl 8) or byte(0)) shl 4;
  OPENSSL_sk_set_cmp_func_introduced = ((((((byte(1) shl 8) or byte(1)) shl 8) or byte(0)) shl 8) or byte(0)) shl 4;
  OPENSSL_sk_dup_introduced = ((((((byte(1) shl 8) or byte(1)) shl 8) or byte(0)) shl 8) or byte(0)) shl 4;
  OPENSSL_sk_sort_introduced = ((((((byte(1) shl 8) or byte(1)) shl 8) or byte(0)) shl 8) or byte(0)) shl 4;
  OPENSSL_sk_is_sorted_introduced = ((((((byte(1) shl 8) or byte(1)) shl 8) or byte(0)) shl 8) or byte(0)) shl 4;
  sk_num_removed = ((((((byte(1) shl 8) or byte(1)) shl 8) or byte(0)) shl 8) or byte(0)) shl 4;
  sk_value_removed = ((((((byte(1) shl 8) or byte(1)) shl 8) or byte(0)) shl 8) or byte(0)) shl 4;
  sk_set_removed = ((((((byte(1) shl 8) or byte(1)) shl 8) or byte(0)) shl 8) or byte(0)) shl 4;
  sk_new_removed = ((((((byte(1) shl 8) or byte(1)) shl 8) or byte(0)) shl 8) or byte(0)) shl 4;
  sk_new_null_removed = ((((((byte(1) shl 8) or byte(1)) shl 8) or byte(0)) shl 8) or byte(0)) shl 4;
  sk_new_reserve_removed = ((((((byte(1) shl 8) or byte(0)) shl 8) or byte(0)) shl 8) or byte(0)) shl 4;
  sk_reserve_removed = ((((((byte(1) shl 8) or byte(0)) shl 8) or byte(0)) shl 8) or byte(0)) shl 4;
  sk_free_removed = ((((((byte(1) shl 8) or byte(1)) shl 8) or byte(0)) shl 8) or byte(0)) shl 4;
  sk_pop_free_removed = ((((((byte(1) shl 8) or byte(1)) shl 8) or byte(0)) shl 8) or byte(0)) shl 4;
  sk_deep_copy_removed = ((((((byte(1) shl 8) or byte(1)) shl 8) or byte(0)) shl 8) or byte(0)) shl 4;
  sk_insert_removed = ((((((byte(1) shl 8) or byte(1)) shl 8) or byte(0)) shl 8) or byte(0)) shl 4;
  sk_delete_removed = ((((((byte(1) shl 8) or byte(1)) shl 8) or byte(0)) shl 8) or byte(0)) shl 4;
  sk_delete_ptr_removed = ((((((byte(1) shl 8) or byte(1)) shl 8) or byte(0)) shl 8) or byte(0)) shl 4;
  sk_find_removed = ((((((byte(1) shl 8) or byte(1)) shl 8) or byte(0)) shl 8) or byte(0)) shl 4;
  sk_find_ex_removed = ((((((byte(1) shl 8) or byte(1)) shl 8) or byte(0)) shl 8) or byte(0)) shl 4;
  sk_push_removed = ((((((byte(1) shl 8) or byte(1)) shl 8) or byte(0)) shl 8) or byte(0)) shl 4;
  sk_unshift_removed = ((((((byte(1) shl 8) or byte(1)) shl 8) or byte(0)) shl 8) or byte(0)) shl 4;
  sk_shift_removed = ((((((byte(1) shl 8) or byte(1)) shl 8) or byte(0)) shl 8) or byte(0)) shl 4;
  sk_pop_removed = ((((((byte(1) shl 8) or byte(1)) shl 8) or byte(0)) shl 8) or byte(0)) shl 4;
  sk_zero_removed = ((((((byte(1) shl 8) or byte(1)) shl 8) or byte(0)) shl 8) or byte(0)) shl 4;
  sk_set_cmp_func_removed = ((((((byte(1) shl 8) or byte(1)) shl 8) or byte(0)) shl 8) or byte(0)) shl 4;
  sk_dup_removed = ((((((byte(1) shl 8) or byte(1)) shl 8) or byte(0)) shl 8) or byte(0)) shl 4;
  sk_sort_removed = ((((((byte(1) shl 8) or byte(1)) shl 8) or byte(0)) shl 8) or byte(0)) shl 4;
  sk_is_sorted_removed = ((((((byte(1) shl 8) or byte(1)) shl 8) or byte(0)) shl 8) or byte(0)) shl 4;
...
{$IFNDEF OPENSSL_NO_LEGACY_SUPPORT}
var
  sk_num: function (_para1:POPENSSL_STACK): longint; cdecl = Load_sk_num; {removed 1.1.0} {removed 1.1.0}
  sk_value: function (_para1:POPENSSL_STACK; _para2:longint): pointer; cdecl = Load_sk_value; {removed 1.1.0} {removed 1.1.0}
  sk_set: function (st:POPENSSL_STACK; i:longint; data:pointer): pointer; cdecl = Load_sk_set; {removed 1.1.0} {removed 1.1.0}
  sk_new: function (cmp:TOPENSSL_sk_compfunc): POPENSSL_STACK; cdecl = Load_sk_new; {removed 1.1.0} {removed 1.1.0}
  sk_new_null: function : POPENSSL_STACK; cdecl = Load_sk_new_null; {removed 1.1.0} {removed 1.1.0}
  sk_new_reserve: function (c:TOPENSSL_sk_compfunc; n:longint): POPENSSL_STACK; cdecl = Load_sk_new_reserve; {removed 1.0.0} {removed 1.0.0}
  sk_reserve: function (st:POPENSSL_STACK; n:longint): longint; cdecl = Load_sk_reserve; {removed 1.0.0} {removed 1.0.0}
  sk_free: procedure (_para1:POPENSSL_STACK); cdecl = Load_sk_free; {removed 1.1.0} {removed 1.1.0}
  sk_pop_free: procedure (st:POPENSSL_STACK; func:TOPENSSL_sk_freefunc); cdecl = Load_sk_pop_free; {removed 1.1.0} {removed 1.1.0}
  sk_deep_copy: function (_para1:POPENSSL_STACK; c:TOPENSSL_sk_copyfunc; f:TOPENSSL_sk_freefunc): POPENSSL_STACK; cdecl = Load_sk_deep_copy; {removed 1.1.0} {removed 1.1.0}
  sk_insert: function (sk:POPENSSL_STACK; data:pointer; where:longint): longint; cdecl = Load_sk_insert; {removed 1.1.0} {removed 1.1.0}
  sk_delete: function (st:POPENSSL_STACK; loc:longint): pointer; cdecl = Load_sk_delete; {removed 1.1.0} {removed 1.1.0}
  sk_delete_ptr: function (st:POPENSSL_STACK; p:pointer): pointer; cdecl = Load_sk_delete_ptr; {removed 1.1.0} {removed 1.1.0}
  sk_find: function (st:POPENSSL_STACK; data:pointer): longint; cdecl = Load_sk_find; {removed 1.1.0} {removed 1.1.0}
  sk_find_ex: function (st:POPENSSL_STACK; data:pointer): longint; cdecl = Load_sk_find_ex; {removed 1.1.0} {removed 1.1.0}
  sk_push: function (st:POPENSSL_STACK; data:pointer): longint; cdecl = Load_sk_push; {removed 1.1.0} {removed 1.1.0}
  sk_unshift: function (st:POPENSSL_STACK; data:pointer): longint; cdecl = Load_sk_unshift; {removed 1.1.0} {removed 1.1.0}
  sk_shift: function (st:POPENSSL_STACK): pointer; cdecl = Load_sk_shift; {removed 1.1.0} {removed 1.1.0}
  sk_pop: function (st:POPENSSL_STACK): pointer; cdecl = Load_sk_pop; {removed 1.1.0} {removed 1.1.0}
  sk_zero: procedure (st:POPENSSL_STACK); cdecl = Load_sk_zero; {removed 1.1.0} {removed 1.1.0}
  sk_set_cmp_func: function (sk:POPENSSL_STACK; cmp:TOPENSSL_sk_compfunc): TOPENSSL_sk_compfunc; cdecl = Load_sk_set_cmp_func; {removed 1.1.0} {removed 1.1.0}
  sk_dup: function (st:POPENSSL_STACK): POPENSSL_STACK; cdecl = Load_sk_dup; {removed 1.1.0} {removed 1.1.0}
  sk_sort: procedure (st:POPENSSL_STACK); cdecl = Load_sk_sort; {removed 1.1.0} {removed 1.1.0}
  sk_is_sorted: function (st:POPENSSL_STACK): longint; cdecl = Load_sk_is_sorted; {removed 1.1.0} {removed 1.1.0}
