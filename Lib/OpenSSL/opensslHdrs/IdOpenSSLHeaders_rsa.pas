...
{$IFNDEF OPENSSL_NO_LEGACY_SUPPORT}
var
  RSA_padding_add_SSLv23: function (to_: PByte; tlen: TOpenSSL_C_INT; const f: PByte; fl: TOpenSSL_C_INT): TOpenSSL_C_INT; cdecl = Load_RSA_padding_add_SSLv23; {removed 3.0.0} {removed 3.0.0}
  RSA_padding_check_SSLv23: function (to_: PByte; tlen: TOpenSSL_C_INT; const f: PByte; fl: TOpenSSL_C_INT; rsa_len: TOpenSSL_C_INT): TOpenSSL_C_INT; cdecl = Load_RSA_padding_check_SSLv23; {removed 3.0.0} {removed 3.0.0}
