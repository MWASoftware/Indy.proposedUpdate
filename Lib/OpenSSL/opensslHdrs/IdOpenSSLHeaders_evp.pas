...
{$IFNDEF OPENSSL_NO_LEGACY_SUPPORT}
var
  EVP_PKEY_assign_RSA: function (pkey: PEVP_PKEY; rsa: Pointer): TOpenSSL_C_INT; cdecl = Load_EVP_PKEY_assign_RSA; {removed 1.0.0} {removed 1.0.0}
  EVP_PKEY_assign_DSA: function (pkey: PEVP_PKEY; dsa: Pointer): TOpenSSL_C_INT; cdecl = Load_EVP_PKEY_assign_DSA; {removed 1.0.0} {removed 1.0.0}
  EVP_PKEY_assign_DH: function (pkey: PEVP_PKEY; dh: Pointer): TOpenSSL_C_INT; cdecl = Load_EVP_PKEY_assign_DH; {removed 1.0.0} {removed 1.0.0}
  EVP_PKEY_assign_EC_KEY: function (pkey: PEVP_PKEY; eckey: Pointer): TOpenSSL_C_INT; cdecl = Load_EVP_PKEY_assign_EC_KEY; {removed 1.0.0} {removed 1.0.0}
  EVP_PKEY_assign_SIPHASH: function (pkey: PEVP_PKEY; shkey: Pointer): TOpenSSL_C_INT; cdecl = Load_EVP_PKEY_assign_SIPHASH; {removed 1.0.0} {removed 1.0.0}
  EVP_PKEY_assign_POLY1305: function (pkey: PEVP_PKEY; polykey: Pointer): TOpenSSL_C_INT; cdecl = Load_EVP_PKEY_assign_POLY1305; {removed 1.0.0} {removed 1.0.0}
  BIO_set_md: procedure (v1: PBIO; const md: PEVP_MD); cdecl = Load_BIO_set_md; {removed 1.0.0} {removed 1.0.0}
{$IFNDEF OPENSSL_NO_MD2}
  EVP_md2: function : PEVP_MD; cdecl = nil; {removed 1.1.0 allow_nil} {removed 1.1.0 allow_nil}
{$ENDIF}
{$IFNDEF OPENSSL_NO_MD4}
  EVP_md4: function : PEVP_MD; cdecl = nil; {removed 1.1.0 allow_nil} {removed 1.1.0 allow_nil}
{$ENDIF}
{$IFNDEF OPENSSL_NO_MD5}
  EVP_md5: function : PEVP_MD; cdecl = nil; {removed 1.1.0 allow_nil} {removed 1.1.0 allow_nil}
{$ENDIF}
  EVP_PKEY_security_bits: function (const pkey: PEVP_PKEY): TOpenSSL_C_INT; cdecl = Load_EVP_PKEY_security_bits; {removed 3.0.0} {removed 3.0.0}
  EVP_PKEY_size: function (const pkey: PEVP_PKEY): TOpenSSL_C_INT; cdecl = Load_EVP_PKEY_size; {removed 3.0.0} {removed 3.0.0}
  OpenSSL_add_all_ciphers: procedure ; cdecl = Load_OpenSSL_add_all_ciphers; {removed 1.1.0} {removed 1.1.0}
  OpenSSL_add_all_digests: procedure ; cdecl = Load_OpenSSL_add_all_digests; {removed 1.1.0} {removed 1.1.0}
  EVP_cleanup: procedure ; cdecl = Load_EVP_cleanup; {removed 1.1.0} {removed 1.1.0}
{$ENDIF} { End of OPENSSL_NO_LEGACY_SUPPORT}
{$ENDIF}
const
...
{$IFNDEF OPENSSL_NO_LEGACY_SUPPORT}
var
  EVP_MD_type: function (const md: PEVP_MD): TOpenSSL_C_INT; cdecl = Load_EVP_MD_type; {removed 3.0.0} {removed 3.0.0}
  EVP_MD_pkey_type: function (const md: PEVP_MD): TOpenSSL_C_INT; cdecl = Load_EVP_MD_pkey_type; {removed 3.0.0} {removed 3.0.0}
  EVP_MD_size: function (const md: PEVP_MD): TOpenSSL_C_INT; cdecl = Load_EVP_MD_size; {removed 3.0.0} {removed 3.0.0}
  EVP_MD_block_size: function (const md: PEVP_MD): TOpenSSL_C_INT; cdecl = Load_EVP_MD_block_size; {removed 3.0.0} {removed 3.0.0}
  EVP_MD_flags: function (const md: PEVP_MD): POpenSSL_C_ULONG; cdecl = Load_EVP_MD_flags; {removed 3.0.0} {removed 3.0.0}
  EVP_MD_CTX_pkey_ctx: function (const ctx: PEVP_MD_CTX): PEVP_PKEY_CTX; cdecl = Load_EVP_MD_CTX_pkey_ctx; {removed 3.0.0} {removed 3.0.0}
  EVP_MD_CTX_md_data: function (const ctx: PEVP_MD_CTX): Pointer; cdecl = Load_EVP_MD_CTX_md_data; {removed 3.0.0} {removed 3.0.0}
  EVP_CIPHER_nid: function (const ctx: PEVP_MD_CTX): TOpenSSL_C_INT; cdecl = Load_EVP_CIPHER_nid; {removed 3.0.0} {removed 3.0.0}
  EVP_CIPHER_block_size: function (const cipher: PEVP_CIPHER): TOpenSSL_C_INT; cdecl = Load_EVP_CIPHER_block_size; {removed 3.0.0} {removed 3.0.0}
  EVP_CIPHER_key_length: function (const cipher: PEVP_CIPHER): TOpenSSL_C_INT; cdecl = Load_EVP_CIPHER_key_length; {removed 3.0.0} {removed 3.0.0}
  EVP_CIPHER_iv_length: function (const cipher: PEVP_CIPHER): TOpenSSL_C_INT; cdecl = Load_EVP_CIPHER_iv_length; {removed 3.0.0} {removed 3.0.0}
  EVP_CIPHER_flags: function (const cipher: PEVP_CIPHER): TOpenSSL_C_ULONG; cdecl = Load_EVP_CIPHER_flags; {removed 3.0.0} {removed 3.0.0}
  EVP_CIPHER_CTX_encrypting: function (const ctx: PEVP_CIPHER_CTX): TOpenSSL_C_INT; cdecl = Load_EVP_CIPHER_CTX_encrypting; {removed 3.0.0} {removed 3.0.0}
  EVP_CIPHER_CTX_nid: function (const ctx: PEVP_CIPHER_CTX): TOpenSSL_C_INT; cdecl = Load_EVP_CIPHER_CTX_nid; {removed 3.0.0} {removed 3.0.0}
  EVP_CIPHER_CTX_block_size: function (const ctx: PEVP_CIPHER_CTX): TOpenSSL_C_INT; cdecl = Load_EVP_CIPHER_CTX_block_size; {removed 3.0.0} {removed 3.0.0}
  EVP_CIPHER_CTX_key_length: function (const ctx: PEVP_CIPHER_CTX): TOpenSSL_C_INT; cdecl = Load_EVP_CIPHER_CTX_key_length; {removed 3.0.0} {removed 3.0.0}
  EVP_CIPHER_CTX_iv_length: function (const ctx: PEVP_CIPHER_CTX): TOpenSSL_C_INT; cdecl = Load_EVP_CIPHER_CTX_iv_length; {removed 3.0.0} {removed 3.0.0}
  EVP_CIPHER_CTX_num: function (const ctx: PEVP_CIPHER_CTX): TOpenSSL_C_INT; cdecl = Load_EVP_CIPHER_CTX_num; {removed 3.0.0} {removed 3.0.0}
  EVP_MD_CTX_init: procedure (ctx : PEVP_MD_CTX); cdecl = Load_EVP_MD_CTX_init; {removed 1.1.0} {removed 1.1.0}
  EVP_MD_CTX_cleanup: function (ctx : PEVP_MD_CTX): TOpenSSL_C_INT; cdecl = Load_EVP_MD_CTX_cleanup; {removed 1.1.0} {removed 1.1.0}
{$IFNDEF OPENSSL_NO_MD2}
{$ENDIF}
{$IFNDEF OPENSSL_NO_MD4}
{$ENDIF}
{$IFNDEF OPENSSL_NO_MD5}
{$ENDIF}
  EVP_PKEY_id: function (const pkey: PEVP_PKEY): TOpenSSL_C_INT; cdecl = Load_EVP_PKEY_id; {removed 3.0.0} {removed 3.0.0}
  EVP_PKEY_base_id: function (const pkey: PEVP_PKEY): TOpenSSL_C_INT; cdecl = Load_EVP_PKEY_base_id; {removed 3.0.0} {removed 3.0.0}
  EVP_PKEY_bits: function (const pkey: PEVP_PKEY): TOpenSSL_C_INT; cdecl = Load_EVP_PKEY_bits; {removed 3.0.0} {removed 3.0.0}
  EVP_PKEY_set_alias_type: function (pkey: PEVP_PKEY; type_: TOpenSSL_C_INT): TOpenSSL_C_INT; cdecl = Load_EVP_PKEY_set_alias_type; {removed 3.0.0} {removed 3.0.0}
  EVP_PKEY_set1_tls_encodedpoint: function (pkey: PEVP_PKEY; const pt: PByte; ptlen: TOpenSSL_C_SIZET): TOpenSSL_C_INT; cdecl = Load_EVP_PKEY_set1_tls_encodedpoint; {removed 3.0.0} {removed 3.0.0}
  EVP_PKEY_get1_tls_encodedpoint: function (pkey: PEVP_PKEY; ppt: PPByte): TOpenSSL_C_SIZET; cdecl = Load_EVP_PKEY_get1_tls_encodedpoint; {removed 3.0.0} {removed 3.0.0}
  EVP_CIPHER_type: function (const ctx: PEVP_CIPHER): TOpenSSL_C_INT; cdecl = Load_EVP_CIPHER_type; {removed 3.0.0} {removed 3.0.0}
{$ENDIF} { End of OPENSSL_NO_LEGACY_SUPPORT}
{$ENDIF}
{$IFDEF OPENSSL_STATIC_LINK_MODEL}
