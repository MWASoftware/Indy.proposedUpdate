...
var
  ...
  X509_print: function (bp: PBIO; x: PX509): TOpenSSL_C_INT; cdecl = nil; { allow_nil}
...
{$IFNDEF OPENSSL_NO_LEGACY_SUPPORT}
var
  X509_NAME_hash: function (x: PX509_NAME): TOpenSSL_C_ULONG; cdecl = Load_X509_NAME_hash; {removed 3.0.0} {removed 3.0.0}
{$ENDIF} { End of OPENSSL_NO_LEGACY_SUPPORT}
{$ENDIF}
const
...
{$IFNDEF OPENSSL_NO_LEGACY_SUPPORT}
var
  X509_http_nbio: function (rctx: POCSP_REQ_CTX; pcert: PPX509): TOpenSSL_C_INT; cdecl = Load_X509_http_nbio; {removed 3.0.0} {removed 3.0.0}
  X509_CRL_http_nbio: function (rctx: POCSP_REQ_CTX; pcrl: PPX509_CRL): TOpenSSL_C_INT; cdecl = Load_X509_CRL_http_nbio; {removed 3.0.0} {removed 3.0.0}
{$ENDIF} { End of OPENSSL_NO_LEGACY_SUPPORT}
{$ENDIF}
const
